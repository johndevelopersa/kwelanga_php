  ...
  <tr>
     <td>
      <div id="noprint"><!-- HIDE THIS PRINT AREA : START /--->
        <div id="toolbar">
          <a href="javascript:;" onclick='pdfDoc();'><img src="../../images/print-icon.png" border="0" alt="" align="left" > Tax Invoice</a>
          <a href="javascript:;" onclick='emailDoc();'><img src="../../images/email-icon.png" border="0" alt="" align="left" > Email</a>
    ...
    <td class="dtitle">
      <h2>
        ...
        <?php echo ((!in_array($mfT[0]["principal_uid"],array($principalVergezocht,$principalGrowingManufacturers)))?"Copy ":""); ?>Invoice for:<br><?php echo $principalName; ?>, <?php echo $mfT[0]['depot_name']; ?></h2>

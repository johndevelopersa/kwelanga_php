...
?>
   <iframe id='if_frmDeliveryNoteInfo' name='if_frmDeliveryNoteInfo' style='border:0;width:100%;height:30px;' scrolling='no' ></iframe>       <form id='frmDeliveryNoteInfo' name='frmDeliveryNoteInfo' method='post' action='{$_SERVER["PHP_SELF"]}' target='if_frmDeliveryNoteInfo' enctype='multipart/form-data' >
      <table width='500'; style='border:solid'>
         <tr>
           <td width="50%"; style="border:none">
              <input type='hidden' id='DMUID' name='DMUID' value='{$postDMUID}'>
              <input type='text' id='f_dni_TRANSPORTERNAME' name='f_dni_TRANSPORTERNAME' value='{$transporterName}' size='60' maxlen='60' placeholder='Transporter Name' style='padding-left:10px;' >
           </td>
           <td width="50%"; style="border:none">
              <input type='text' id='f_dni_TRUCKREGISTRATION' name='f_dni_TRUCKREGISTRATION' value='{$truckRegistration}' size='20' maxlen='20' placeholder='Truck Registration' style='padding-left:10px;' >
           </td>
         </tr>
       </table>
        <input type='text' id='f_dni_CHEPPALLETNUMBER' name='f_dni_CHEPPALLETNUMBER' value='{$chepPalletNumber}' size='20' maxlen='20' placeholder='CHEP Pallet Number' style='padding-left:10px;' >
       </form>
       <br>

...
require_once "VoqadoHTTPResponseObj.php";
...
class VoqadoRestAPI
{
    ...
    public function Request($method, $action, $data = [], $timeout = 60, $downloadFile = ''): VoqadoHTTPResponseObj
    {
        ...
        return new VoqadoHTTPResponseObj($url, $method, $requestRaw, $rawResponse, $curlDebug);
    }

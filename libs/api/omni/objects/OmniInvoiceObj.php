...
class OmniInvoiceObj extends OmniBaseObj
{
    ...
    public function __construct($properties = [])
    {
        ...
        if (is_array($properties) && !empty($properties["invoice"]) && count($properties)) {
    ...
    public function getOrderLines()
    {
        ...
        foreach($this->invoice_lines as $line){
            $lines[] = new OmniInvoiceLineItemObj($line);
        }
        return $lines;
    }
     ...
     * @return OmniSalesOrderObj
     */
    public function addOrderLine(OmniInvoiceLineItemObj $line)
    {
        $this->invoice_lines[] = $line->getArray();
        return $this;
    }

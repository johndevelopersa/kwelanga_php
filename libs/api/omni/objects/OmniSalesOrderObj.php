...
class OmniSalesOrderObj extends OmniBaseObj
{
    ...
    public function __construct($properties = [])
    {
        ...
        if (is_array($properties) && !empty($properties["order"]) && count($properties)) {
            $this->arrayAssign($properties["order"]);
        }
    }
    ...
    public function getOrderLines()
    {
        ...
        foreach($this->order_lines as $line){
            $lines[] = new OmniSalesOrderLineItemObj($line);
        }
        return $lines;
    }
     ...
     * @return OmniSalesOrderObj
     */
    public function addOrderLine(OmniSalesOrderLineItemObj $line)
    {
        $this->order_lines[] = $line->getArray();
        return $this;
    }

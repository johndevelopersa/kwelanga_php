...
class DearBaseObj implements ArrayAccess
{

    /**
     * @var DearHTTPResponseObj
     */
     ...
     * @return DearBaseObj
     */
    public function setResponse(DearHTTPResponseObj $response)
    {
        $this->response = $response;
        return $this;
    }

    public function getResponse(): DearHTTPResponseObj
    {

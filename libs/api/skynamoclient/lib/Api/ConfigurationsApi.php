...
class ConfigurationsApi
{
     ...
     * @return \SkynamoClientAPI\Model\Configuration|\SkynamoClientAPI\Model\ErrorModel|\SkynamoClientAPI\Model\ErrorModel
     */
    public function configurationsGet($x_api_client, $flags = null)
    {
        list($response) = $this->configurationsGetWithHttpInfo($x_api_client, $flags);
        return $response;
    }

    /**
     * Operation configurationsGetWithHttpInfo
     *
     * Get all configuration information
     *
     * @param  string $x_api_client The name of the Skynamo Instance the request is sent to. This is typically the company name or the first part of the URL used to access the Skynamo Instance.&lt;br&gt;&lt;br&gt;Example: &lt;strong&gt;demo&lt;/strong&gt;.za.skynamo.me (required)
     ...
     * @throws \SkynamoClientAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SkynamoClientAPI\Model\Configuration|\SkynamoClientAPI\Model\ErrorModel|\SkynamoClientAPI\Model\ErrorModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function configurationsGetWithHttpInfo($x_api_client, $flags = null)
    {
        $request = $this->configurationsGetRequest($x_api_client, $flags);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SkynamoClientAPI\Model\Configuration' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SkynamoClientAPI\Model\Configuration', []),
            ...
            $returnType = '\SkynamoClientAPI\Model\Configuration';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SkynamoClientAPI\Model\Configuration',
    ...
    /**
     * Operation configurationsGetAsync
     *
     * Get all configuration information
     *
     * @param  string $x_api_client The name of the Skynamo Instance the request is sent to. This is typically the company name or the first part of the URL used to access the Skynamo Instance.&lt;br&gt;&lt;br&gt;Example: &lt;strong&gt;demo&lt;/strong&gt;.za.skynamo.me (required)
     ...
     */
    public function configurationsGetAsync($x_api_client, $flags = null)
    {
        return $this->configurationsGetAsyncWithHttpInfo($x_api_client, $flags)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation configurationsGetAsyncWithHttpInfo
     *
     * Get all configuration information
     *
     * @param  string $x_api_client The name of the Skynamo Instance the request is sent to. This is typically the company name or the first part of the URL used to access the Skynamo Instance.&lt;br&gt;&lt;br&gt;Example: &lt;strong&gt;demo&lt;/strong&gt;.za.skynamo.me (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function configurationsGetAsyncWithHttpInfo($x_api_client, $flags = null)
    {
        $returnType = '\SkynamoClientAPI\Model\Configuration';
        $request = $this->configurationsGetRequest($x_api_client, $flags);
    ...
    /**
     * Create request for operation 'configurationsGet'
     *
     * @param  string $x_api_client The name of the Skynamo Instance the request is sent to. This is typically the company name or the first part of the URL used to access the Skynamo Instance.&lt;br&gt;&lt;br&gt;Example: &lt;strong&gt;demo&lt;/strong&gt;.za.skynamo.me (required)
     * @param  string $flags Defines display configurations.&lt;br&gt;&lt;i&gt;Availiable values&lt;/i&gt; :&lt;br&gt; - show_nulls (optional)
     *
     ...
     */
    public function configurationsGetRequest($x_api_client, $flags = null)
    {
        // verify the required parameter 'x_api_client' is set
        if ($x_api_client === null || (is_array($x_api_client) && count($x_api_client) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_api_client when calling configurationsGet'
            );
        }

...
class PricesApi
{
     ...
     * @return \SkynamoClientAPI\Model\InlineResponse20019|\SkynamoClientAPI\Model\ErrorModel
     */
    public function pricesGet($x_api_client, $page_number = 1, $page_size = 50, $flags = null)
    {
        list($response) = $this->pricesGetWithHttpInfo($x_api_client, $page_number, $page_size, $flags);
        return $response;
    }
     ...
     * @throws \SkynamoClientAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SkynamoClientAPI\Model\InlineResponse20019|\SkynamoClientAPI\Model\ErrorModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function pricesGetWithHttpInfo($x_api_client, $page_number = 1, $page_size = 50, $flags = null)
    {
        $request = $this->pricesGetRequest($x_api_client, $page_number, $page_size, $flags);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SkynamoClientAPI\Model\InlineResponse20019' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SkynamoClientAPI\Model\InlineResponse20019', []),
            ...
            $returnType = '\SkynamoClientAPI\Model\InlineResponse20019';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SkynamoClientAPI\Model\InlineResponse20019',
     ...
     */
    public function pricesGetAsync($x_api_client, $page_number = 1, $page_size = 50, $flags = null)
    {
        return $this->pricesGetAsyncWithHttpInfo($x_api_client, $page_number, $page_size, $flags)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pricesGetAsyncWithHttpInfo($x_api_client, $page_number = 1, $page_size = 50, $flags = null)
    {
        $returnType = '\SkynamoClientAPI\Model\InlineResponse20019';
        $request = $this->pricesGetRequest($x_api_client, $page_number, $page_size, $flags);
     ...
     */
    public function pricesGetRequest($x_api_client, $page_number = 1, $page_size = 50, $flags = null)
    {
        // verify the required parameter 'x_api_client' is set
        if ($x_api_client === null || (is_array($x_api_client) && count($x_api_client) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_api_client when calling pricesGet'
            );
        }
    ...
    /**
     * Operation pricesPost
     *
     * Create/Update order unit price
     *
     * @param  string $x_api_client The name of the Skynamo Instance the request is sent to. This is typically the company name or the first part of the URL used to access the Skynamo Instance.&lt;br&gt;&lt;br&gt;Example: &lt;strong&gt;demo&lt;/strong&gt;.za.skynamo.me (required)
     * @param  \SkynamoClientAPI\Model\OrderUnitPricePost[] $prices A list of order unit price request data (optional)
     *
     * @throws \SkynamoClientAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SkynamoClientAPI\Model\InlineResponse2002|\SkynamoClientAPI\Model\ErrorModel
     */
    public function pricesPost($x_api_client, $prices = null)
    {
        list($response) = $this->pricesPostWithHttpInfo($x_api_client, $prices);
        return $response;
    }

    /**
     * Operation pricesPostWithHttpInfo
     *
     * Create/Update order unit price
     *
     * @param  string $x_api_client The name of the Skynamo Instance the request is sent to. This is typically the company name or the first part of the URL used to access the Skynamo Instance.&lt;br&gt;&lt;br&gt;Example: &lt;strong&gt;demo&lt;/strong&gt;.za.skynamo.me (required)
     ...
     */
    public function pricesPostWithHttpInfo($x_api_client, $prices = null)
    {
        $request = $this->pricesPostRequest($x_api_client, $prices);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pricesPostAsync($x_api_client, $prices = null)
    {
        return $this->pricesPostAsyncWithHttpInfo($x_api_client, $prices)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation pricesPostAsyncWithHttpInfo
     *
     * Create/Update order unit price
     *
     * @param  string $x_api_client The name of the Skynamo Instance the request is sent to. This is typically the company name or the first part of the URL used to access the Skynamo Instance.&lt;br&gt;&lt;br&gt;Example: &lt;strong&gt;demo&lt;/strong&gt;.za.skynamo.me (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pricesPostAsyncWithHttpInfo($x_api_client, $prices = null)
    {
        $returnType = '\SkynamoClientAPI\Model\InlineResponse2002';
        $request = $this->pricesPostRequest($x_api_client, $prices);
    ...
    /**
     * Create request for operation 'pricesPost'
     *
     * @param  string $x_api_client The name of the Skynamo Instance the request is sent to. This is typically the company name or the first part of the URL used to access the Skynamo Instance.&lt;br&gt;&lt;br&gt;Example: &lt;strong&gt;demo&lt;/strong&gt;.za.skynamo.me (required)
     * @param  \SkynamoClientAPI\Model\OrderUnitPricePost[] $prices A list of order unit price request data (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function pricesPostRequest($x_api_client, $prices = null)
    {
        // verify the required parameter 'x_api_client' is set
        if ($x_api_client === null || (is_array($x_api_client) && count($x_api_client) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_api_client when calling pricesPost'
            );
        }
        ...
        if (isset($prices)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($prices));
            } else {
                $httpBody = $prices;
            }

...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.za.skynamo.me/v1';
    ...
    {
        $report  = 'PHP SDK (SkynamoClientAPI) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.0.18' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://api.za.skynamo.me/v1",

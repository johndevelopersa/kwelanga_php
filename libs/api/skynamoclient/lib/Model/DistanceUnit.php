 ...
 */
class DistanceUnit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DistanceUnit';
     ...
     * Sets code
     *
     * @param string|null $code The distance unit code
     *
     * @return self
     */
     ...
     * Sets symbol
     *
     * @param string|null $symbol The distance unit symbol
     *
     * @return self
     */

 ...
 */
class FilePost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FilePost';
     ...
     * Sets content
     *
     * @param string|null $content The content of the file (base64string)
     *
     * @return self
     */
     ...
     * Sets transaction_id
     *
     * @param int|null $transaction_id The transition id of the file used for orders
     *
     * @return self
     */

...
/**
 * CustomerPatch Class Doc Comment
 *
 * @category Class
 * @description This is a customer in Skynamo, used for updating information about a customer (Only values specified will be updated)
 * @package  SkynamoClientAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CustomerPatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerPatch';
     ...
     * Sets id
     *
     * @param int $id The unique id of the customer
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string|null $code The unique code associated with this customer (required if you do not specify id)
     *
     * @return self
     */
     ...
     * Sets transaction_id
     *
     * @param int|null $transaction_id The transaction id associated with files in order to link files to a customer
     *
     * @return self
     */

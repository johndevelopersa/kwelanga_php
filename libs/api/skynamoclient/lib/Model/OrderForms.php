 ...
 */
class OrderForms implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderForms';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'custom_fields' => '\SkynamoClientAPI\Model\OrderFormCustomFields[]'
    ];
     ...
     * Sets id
     *
     * @param int|null $id The unique id of the form that has been included in the order
     *
     * @return self
     */
     ...
     * Gets custom_fields
     *
     * @return \SkynamoClientAPI\Model\OrderFormCustomFields[]|null
     */
     ...
     * Sets custom_fields
     *
     * @param \SkynamoClientAPI\Model\OrderFormCustomFields[]|null $custom_fields A list of customfields included in the form
     *
     * @return self
     */

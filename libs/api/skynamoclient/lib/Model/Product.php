 ...
 *
 * @category Class
 * @description This is a product in Skynamo, used for fetching information about products
 * @package  SkynamoClientAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Product implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets row_version
     *
     * @param float|null $row_version A sequence number for changes to the product (if the number changes then the product has changed)
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $last_modified_time The last time this product was modified
     *
     * @return self
     */

...
/**
 * IntegrationFormValues Class Doc Comment
 *
 * @category Class
 * @description This is the integration form values in Skynamo
 * @package  SkynamoClientAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class IntegrationFormValues implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IntegrationFormValues';
     ...
     * Sets id
     *
     * @param int|null $id The unique ID of the active integration
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the active integration
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $last_modified_time The last time the integration values was modified
     *
     * @return self
     */

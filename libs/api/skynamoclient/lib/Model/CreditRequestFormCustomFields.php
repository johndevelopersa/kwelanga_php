...
/**
 * CreditRequestFormCustomFields Class Doc Comment
 *
 * @category Class
 * @description This is a customfield in Skynamo, used for adding customfields on a form for a credit request (All values not specified will assume their default values)
 * @package  SkynamoClientAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreditRequestFormCustomFields implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreditRequestFormCustomFields';

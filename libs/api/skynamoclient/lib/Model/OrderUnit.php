...
class OrderUnit implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets id
     *
     * @param int|null $id The unique id of the order unit
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the order unit
     *
     * @return self
     */
     ...
     * Sets multiplier
     *
     * @param float|null $multiplier The multiplier of the order unit
     *
     * @return self
     */
     ...
     * Sets active
     *
     * @param bool|null $active Indicates whether the order unit is active or not
     *
     * @return self
     */

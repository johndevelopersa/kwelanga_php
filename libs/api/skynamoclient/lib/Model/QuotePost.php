...
/**
 * QuotePost Class Doc Comment
 *
 * @category Class
 * @description This is a quote in Skynamo, used for adding a quote (All values not specified will assume their default values)
 * @package  SkynamoClientAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class QuotePost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'QuotePost';
    ...
    protected static $openAPITypes = [
        ...
        'warehouse_id' => 'int',
        'transaction_id' => 'int',
        'items' => '\SkynamoClientAPI\Model\QuoteItemPost[]',
        'forms' => '\SkynamoClientAPI\Model\QuoteForms[]'
    ];
     ...
     * Sets date
     *
     * @param \DateTime $date The date when the quote was issued
     *
     * @return self
     */
     ...
     * Sets customer_id
     *
     * @param int $customer_id The unique id of the customer that placed the quote
     *
     * @return self
     */
     ...
     * Sets user_id
     *
     * @param int $user_id The unique id of the user that placed the quote
     *
     * @return self
     */
    ...
    public function setDiscount($discount)
    {
        ...
        if (!is_null($discount) && ($discount > 1E+2)) {
            throw new \InvalidArgumentException('invalid value for $discount when calling QuotePost., must be smaller than or equal to 1E+2.');
        }
        if (!is_null($discount) && ($discount < 0)) {
            throw new \InvalidArgumentException('invalid value for $discount when calling QuotePost., must be bigger than or equal to 0.');
        }
     ...
     * Gets items
     *
     * @return \SkynamoClientAPI\Model\QuoteItemPost[]
     */
     ...
     * Sets items
     *
     * @param \SkynamoClientAPI\Model\QuoteItemPost[] $items A list of items included in the quote
     *
     * @return self
     */
     ...
     * Gets forms
     *
     * @return \SkynamoClientAPI\Model\QuoteForms[]|null
     */
     ...
     * Sets forms
     *
     * @param \SkynamoClientAPI\Model\QuoteForms[]|null $forms Certain custom fields may be required depending on the custom fields that have been set up
     *
     * @return self
     */

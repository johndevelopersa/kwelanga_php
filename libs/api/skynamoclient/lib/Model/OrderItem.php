...
class OrderItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets list_price
     *
     * @param float|null $list_price The list price of the product included in the order
     *
     * @return self
     */
     ...
     * Sets product_name
     *
     * @param string|null $product_name The name of the product that has been included in the order
     *
     * @return self
     */
     ...
     * Sets tax_rate_value
     *
     * @param float|null $tax_rate_value The tax rate value used when the order item was created
     *
     * @return self
     */

 ...
 *
 * @category Class
 * @description This is a customfield in Skynamo, used for patching a customfield
 * @package  SkynamoClientAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CustomfieldPatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomfieldPatch';
     ...
     * Sets id
     *
     * @param int $id A unique ID of the customfield
     *
     * @return self
     */

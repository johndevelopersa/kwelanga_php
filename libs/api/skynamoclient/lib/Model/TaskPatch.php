 ...
 */
class TaskPatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaskPatch';
     ...
     * Sets due_date
     *
     * @param \DateTime|null $due_date The date when the task is due (the time will be ignored if anytime is set to true)
     *
     * @return self
     */

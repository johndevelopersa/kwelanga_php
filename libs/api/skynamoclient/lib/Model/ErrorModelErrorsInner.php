...
/**
 * ErrorModelErrorsInner Class Doc Comment
 *
 * @category Class
 * @package  SkynamoClientAPI
 * @author   OpenAPI Generator team
 ...
 */
class ErrorModelErrorsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ErrorModel_errors_inner';
    ...
    */
     ...
     * Sets index
     *
     * @param int|null $index The index of the item in the request where the error occured
     *
     * @return self
     */
     ...
     * Sets detail
     *
     * @param string[]|null $detail A list of messages describing each error on the specific index
     *
     * @return self
     */

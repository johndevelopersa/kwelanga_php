...
/**
 * TaskPut Class Doc Comment
 *
 * @category Class
 * @description This is a task in Skynamo, used for updating information about tasks.
 * @package  SkynamoClientAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TaskPut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaskPut';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['anytime'] === null) {
            $invalidProperties[] = "'anytime' can't be null";
        }
     ...
     * Sets description
     *
     * @param string $description The description of what the task entails
     *
     * @return self
     */
     ...
     * Sets due_date
     *
     * @param \DateTime $due_date The date when the task is due (the time will be ignored if anytime is set to true)
     *
     * @return self
     */
     ...
     *
     * @param int $assigned_user_id The unique identifier of the user that must complete this task (required if assigned_user_name is not provided)
     *
     * @return self
     */
     ...
     *
     * @param string $assigned_user_name The user name of the the user that must complete this task (required if assigned_user_id is not provided)
     *
     * @return self
     */
     ...
     * Sets anytime
     *
     * @param bool $anytime True if the task can be completed at any time on the due_date (ignore the time segment of due_date if true)
     *
     * @return self
     */

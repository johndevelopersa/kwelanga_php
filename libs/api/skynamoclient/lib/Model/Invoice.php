 ...
 *
 * @category Class
 * @description This is an invoice in Skynamo, used for fetching information about invoices
 * @package  SkynamoClientAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Invoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets id
     *
     * @param int|null $id The unique id of the invoice
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param \DateTime|null $date The date when the invoice was issued
     *
     * @return self
     */
     ...
     * Sets customer_id
     *
     * @param int|null $customer_id The unique id of the customer that was invoiced
     *
     * @return self
     */
     ...
     * Sets customer_code
     *
     * @param string|null $customer_code The unique code of the customer that was invoiced
     *
     * @return self
     */
     ...
     * Sets row_version
     *
     * @param float|null $row_version A sequence number for changes to the invoice (if the number changes then the invoice has changed)
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $last_modified_time The last time this invoice was modified
     *
     * @return self
     */

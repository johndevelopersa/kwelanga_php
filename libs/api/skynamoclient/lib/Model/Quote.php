 ...
 *
 * @category Class
 * @description This is a quote in Skynamo, used for fetching information about quotes
 * @package  SkynamoClientAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Quote implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\SkynamoClientAPI\Model\QuoteItem[]'
    ];
     ...
     * Sets id
     *
     * @param int|null $id The unique id of the quote
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param \DateTime|null $date The date when the quote was issued
     *
     * @return self
     */
     ...
     * Sets customer_id
     *
     * @param int|null $customer_id The unique id of the customer that placed the quote
     *
     * @return self
     */
     ...
     * Sets customer_code
     *
     * @param string|null $customer_code The unique code of the customer that placed the quote
     *
     * @return self
     */
     ...
     * Sets customer_name
     *
     * @param string|null $customer_name The name of the customer that placed the quote
     *
     * @return self
     */
     ...
     * Sets reference
     *
     * @param string|null $reference The reference used to identify the quote by a human or external system
     *
     * @return self
     */
     ...
     * Sets discount
     *
     * @param float|null $discount The discount percentage on the quote
     *
     * @return self
     */
     ...
     *
     * @param float|null $discount_amount The discount amount on the quote
     *
     * @return self
     */
     ...
     * Sets total_amount
     *
     * @param float|null $total_amount The total amount on the quote
     *
     * @return self
     */
     ...
     * Sets warehouse_id
     *
     * @param int|null $warehouse_id The unique identifier of the warehouse associated with the quote
     *
     * @return self
     */
     ...
     * Sets warehouse_name
     *
     * @param string|null $warehouse_name The name of the warehouse associated with the quote
     *
     * @return self
     */
     ...
     *
     * @param string|null $email_recipients The email recipients on the quote
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $last_modified_time The last time this quote was modified
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \SkynamoClientAPI\Model\QuoteItem[]|null
     */
     ...
     * Sets items
     *
     * @param \SkynamoClientAPI\Model\QuoteItem[]|null $items A list of items included in the quote
     *
     * @return self
     */

...
/**
 * ScheduledVisitPut Class Doc Comment
 *
 * @category Class
 ...
 */
class ScheduledVisitPut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScheduledVisitPut';
     ...
     * Sets due_date
     *
     * @param \DateTime $due_date The date when the scheduled visit is due (the time segment will be ignored if all_day is set to true)
     *
     * @return self
     */
     ...
     * Sets customer_id
     *
     * @param int $customer_id The unique identifier of the customer where the scheduled visit should be completed (required if customer_code is not provided)
     *
     * @return self
     */
     ...
     * Sets customer_code
     *
     * @param string $customer_code The unique code of the customer where the scheduled visit should be completed (required if customer_id is not provided)
     *
     * @return self
     */
     ...
     *
     * @param int $assigned_user_id The unique identifier of the user that must complete this scheduled visit (required if assigned_user_name is not provided)
     *
     * @return self
     */
     ...
     *
     * @param string $assigned_user_name The user name of the the user that must complete this scheduled visit (required if assigned_user_id is not provided)
     *
     * @return self
     */
     ...
     * Sets all_day
     *
     * @param bool|null $all_day True if the scheduled visit can be completed at any time on the due_date (automatically set to true if no end_time is provided; automatically set to false if an end_time is provided; will ignore the time segment of due_date if true)
     *
     * @return self
     */
     ...
     * Sets end_time
     *
     * @param \DateTime|null $end_time The end time of the scheduled visit (required if all_day is set to false; must be empty if all_day is set to true)
     *
     * @return self
     */

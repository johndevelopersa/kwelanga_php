 ...
 *
 * @category Class
 * @description This is a price list in Skynamo, used for fetching information about price lists
 * @package  SkynamoClientAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class PriceList implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param \DateTime|null $last_modified_time The last time the price list was modified
     *
     * @return self
     */

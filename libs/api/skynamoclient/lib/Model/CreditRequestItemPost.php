...
/**
 * CreditRequestItemPost Class Doc Comment
 *
 * @category Class
 * @package  SkynamoClientAPI
 * @author   OpenAPI Generator team
 ...
 */
class CreditRequestItemPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreditRequestItemPost';
     ...
     * Sets product_id
     *
     * @param int|null $product_id The unique id of the product that has been included in the credit request
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param float|null $price The total price of the product included in the credit request
     *
     * @return self
     */
     ...
     * Sets list_price
     *
     * @param float|null $list_price The price list price of the product included in the credit request
     *
     * @return self
     */

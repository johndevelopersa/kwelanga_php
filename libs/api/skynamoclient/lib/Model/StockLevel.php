 ...
 *
 * @category Class
 * @description This is a stock level in Skynamo, used for fetching stock level information about products
 * @package  SkynamoClientAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class StockLevel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StockLevel';
     ...
     * Sets product_id
     *
     * @param int|null $product_id The unique identifier of the product associated with the stock level
     *
     * @return self
     */
     ...
     * Sets product_name
     *
     * @param string|null $product_name The name of the product associated with the stock level
     *
     * @return self
     */
     ...
     * Sets order_unit_id
     *
     * @param int|null $order_unit_id The unique identifier of the order unit
     *
     * @return self
     */
     ...
     *
     * @param string|null $order_unit_name The name of the order unit
     *
     * @return self
     */
     ...
     * Sets level
     *
     * @param float|null $level The amount of stock in the warehouse
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The string categorizing the amount of stock in the warehouse
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $last_modified_time The last time this stock level was modified
     *
     * @return self
     */

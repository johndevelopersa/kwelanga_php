 ...
 */
class OrderPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderPost';
    ...
    protected static $openAPITypes = [
        ...
        'warehouse_id' => 'int',
        'transaction_id' => 'int',
        'items' => '\SkynamoClientAPI\Model\OrderItemPost[]',
        'forms' => '\SkynamoClientAPI\Model\OrderForms[]'
    ];
     ...
     * Sets date
     *
     * @param \DateTime $date The date when the order was issued
     *
     * @return self
     */
     ...
     * Sets customer_id
     *
     * @param int $customer_id The unique id of the customer that placed the order
     *
     * @return self
     */
     ...
     * Sets user_id
     *
     * @param int $user_id The unique id of the user that placed the order
     *
     * @return self
     */
    ...
    public function setDiscount($discount)
    {
        ...
        if (!is_null($discount) && ($discount > 1E+2)) {
            throw new \InvalidArgumentException('invalid value for $discount when calling OrderPost., must be smaller than or equal to 1E+2.');
        }
        if (!is_null($discount) && ($discount < 0)) {
            throw new \InvalidArgumentException('invalid value for $discount when calling OrderPost., must be bigger than or equal to 0.');
        }
     ...
     * Sets quote_id
     *
     * @param int|null $quote_id The unique id of the quote associated with the order
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \SkynamoClientAPI\Model\OrderItemPost[]
     */
     ...
     * Sets items
     *
     * @param \SkynamoClientAPI\Model\OrderItemPost[] $items A list of items included in the order
     *
     * @return self
     */
     ...
     * Gets forms
     *
     * @return \SkynamoClientAPI\Model\OrderForms[]|null
     */
     ...
     * Sets forms
     *
     * @param \SkynamoClientAPI\Model\OrderForms[]|null $forms Certain custom fields may be required depending on the custom fields that have been set up
     *
     * @return self
     */

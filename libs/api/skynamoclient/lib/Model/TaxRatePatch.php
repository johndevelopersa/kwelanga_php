...
/**
 * TaxRatePatch Class Doc Comment
 *
 * @category Class
 * @description This is a tax rate in Skynamo, used for updating information about tax rates.
 * @package  SkynamoClientAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TaxRatePatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaxRatePatch';
     ...
     * Sets id
     *
     * @param int|null $id The unique id of the tax rate
     *
     * @return self
     */
     ...
     * Sets rate
     *
     * @param float|null $rate The rate of the tax rate
     *
     * @return self
     */
     ...
     * Sets active
     *
     * @param bool|null $active Indicates whether the tax rate is active or not
     *
     * @return self
     */

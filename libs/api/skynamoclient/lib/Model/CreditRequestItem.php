...
/**
 * CreditRequestItem Class Doc Comment
 *
 * @category Class
 * @package  SkynamoClientAPI
 * @author   OpenAPI Generator team
 ...
 */
class CreditRequestItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreditRequestItem';
     ...
     * Sets quantity
     *
     * @param float|null $quantity The quantity of the product that has been included in the credit request
     *
     * @return self
     */
     ...
     * Sets unit_price
     *
     * @param float|null $unit_price The unit price of the product included in the credit request
     *
     * @return self
     */
     ...
     * Sets list_price
     *
     * @param float|null $list_price The list price of the product included in the credit request
     *
     * @return self
     */
     ...
     * Sets product_code
     *
     * @param string|null $product_code The unique code of the product that has been included in the credit request
     *
     * @return self
     */
     ...
     * Sets product_name
     *
     * @param string|null $product_name The name of the product that has been included in the credit request
     *
     * @return self
     */
     ...
     * Sets cost
     *
     * @param float|null $cost The total cost of the credit request item
     *
     * @return self
     */
     ...
     * Sets tax_rate_value
     *
     * @param float|null $tax_rate_value The tax rate value used when the credit request item was created
     *
     * @return self
     */
     ...
     * Sets tax_rate_id
     *
     * @param int|null $tax_rate_id The unique identifier of the tax rate associated with this credit request item
     *
     * @return self
     */

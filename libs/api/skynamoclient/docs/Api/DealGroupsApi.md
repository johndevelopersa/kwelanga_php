# SkynamoClientAPI\DealGroupsApi

All URIs are relative to https://api.za.skynamo.me/v1.

Method | HTTP request | Description
------------- | ------------- | -------------
[**dealgroupsGet()**](DealGroupsApi.md#dealgroupsGet) | **GET** /dealgroups | List deal groups
[**dealgroupsIdGet()**](DealGroupsApi.md#dealgroupsIdGet) | **GET** /dealgroups/{id} | Get a deal group


## `dealgroupsGet()`

```php
dealgroupsGet($x_api_client, $page_number, $page_size, $flags): \SkynamoClientAPI\Model\InlineResponse2004
```

List deal groups

Returns a list of deal groups
...
$apiInstance = new SkynamoClientAPI\Api\DealGroupsApi(
...
try {
    $result = $apiInstance->dealgroupsGet($x_api_client, $page_number, $page_size, $flags);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DealGroupsApi->dealgroupsGet: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\SkynamoClientAPI\Model\InlineResponse2004**](../Model/InlineResponse2004.md)
...
```php
dealgroupsIdGet($x_api_client, $id, $flags): \SkynamoClientAPI\Model\DealGroup
```

Get a deal group

Fetch information about a specfic deal group from the unique identifier
...
try {
    $result = $apiInstance->dealgroupsIdGet($x_api_client, $id, $flags);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DealGroupsApi->dealgroupsIdGet: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\SkynamoClientAPI\Model\DealGroup**](../Model/DealGroup.md)

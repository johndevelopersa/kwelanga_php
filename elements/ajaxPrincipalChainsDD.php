...
if (isset($_POST['PRINCIPALCHAINID'])) $postPRINCIPALCHAINID=mysqli_real_escape_string($dbConn->connection, htmlspecialchars($_POST['PRINCIPALCHAINID'])); else $postPRINCIPALCHAINID="";
...
BasicSelectElement::getUserPrincipalChainsDD($postTAGID,$postPRINCIPALCHAINID,"N","N",$postONCHANGE,null,null,$dbConn,$postUSERID,$postPRINCIPALID,"1");

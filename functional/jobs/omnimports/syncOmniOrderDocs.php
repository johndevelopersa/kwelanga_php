...
$seDocs = (new ExtractDAO($dbConn))->getDailyExtractInvoicedOrdersWithParms(RichesConstants::PrincipalID, $recipientUId, $importWarehouse, $altChainUIdIn);
...
foreach($grpDocs as $ord) :
    ...
    $omniOrder = (new OmniSalesOrderObj)
        ...
        ->setDeliveryDetails($invoiceNumber)
        //->setDeliveryRoute()

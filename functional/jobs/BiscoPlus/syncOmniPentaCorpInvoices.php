...
require_once __DIR__ . "/../../../properties/Omni_Constants_432.php";
...
$constantsClass = "Omni_Constants_432" ;
...
if (sizeof($storeIdArr) > 0) {
    $storeSpecialArr      = (new MiscellaneousDAO($dbConn))->getPrincipalSpecialFieldValuesMultEntities($constantsClass::PrincipalID, 631, implode(",", $storeIdArr), CT_STORE_SHORTCODE, $arrayIndex = "entity_uid");
    $omniBranchSpecialArr = (new MiscellaneousDAO($dbConn))->getPrincipalSpecialFieldValuesMultEntities($constantsClass::PrincipalID, 630, implode(",", $storeIdArr), CT_STORE_SHORTCODE, $arrayIndex = "entity_uid");
}
...
// ******************************************************************************************************************************
 function OmniErrorReporting($principalUId, $seType, $nType) {
     ...
     if (count($errLST) > 0) {
          ...
          $postDistributionDAO->body = $bodyString;
          $dResult = $postDistributionDAO->postQueueDistribution($postDistributionDAO);
     }
     $dbConn->dbinsQuery("commit;");

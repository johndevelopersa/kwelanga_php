...
$productCategories = json_encode($ProductDAO->getProductCategoryByPrincipalId($principalId));

?>
<HTML>
<HEAD>
<script type='text/javascript' language='javascript' src="<?php ECHO $DHTMLROOT ?>js/jquery.js"></script>
<script type='text/javascript' language='javascript' src="<?php ECHO $DHTMLROOT ?>js/dops_global_functions.js"></script>

<LINK href="<?php ECHO $DHTMLROOT ?>css/1_default.css" rel='stylesheet' type='text/css'>
...
<script type="text/javascript">
  ...
  function startStockTake(){
    ...
    if(!tc){
      ...
      AjaxRefreshWithResult('ACTION=MODE&SWITCH=1&PRINCIPALID=<?php echo $principalId ?>&DEPOTID=<?php echo $depotId ?>',
                            '<?php echo $ROOT ?>functional/stock/stockTakeSubmit.php',  //is validated again on submit level.
  ...
  function displayProductList(json){
    ...
    AjaxRefresh(
      ...
      '<?php echo $ROOT ?>functional/stock/stockTakeProductList.php', // URL to file

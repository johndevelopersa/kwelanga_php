     ...
     <table style="border-collapse:collapse; width:98%">
         <tr>
             ...
             <?php    $document_type = '12'; 
                         ...
                         ?>
                               <td width="40%;" rowspan="3" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
                                            <?php echo "<img src=".$logo." style=width:160px; height:120px; float:right; >" ?></td>
                         <?php } ?>
             <?php    $document_type = STR_PAD($mfT[0]['document_type_uid'],2,'0',STR_PAD_LEFT);
                   } elseif (in_array($mfT[0]['status_uid'],array(DST_PROCESSED, DST_UNACCEPTED,DST_ACCEPTED,14))) { 
                         if ($mfT[0]['document_type_uid'] == 2) { ?>
                                    <td class="dc" style="text-align:left;">UPLIFT ADVICE</td>
                         <?php } elseif ($mfT[0]['document_type_uid'] == 6) { ?>
                                    <td class="dc" style="text-align:left;">DELIVERY NOTE</td>
                         ...
                         <?php } elseif ($mfT[0]['document_type_uid'] == 13) { ?>
                                    <td class="dc" style="text-align:left;">ZERO PRICE INVOICE</td>
                         <?php } elseif ($mfT[0]['document_type_uid'] == 4) { ?>
                                    <td class="dc" style="text-align:left;">CREDIT NOTE</td>
                         <?php } elseif ($mfT[0]['document_type_uid'] == 31) { ?>
                                    <td class="dc" style="text-align:left;">MANUAL CREDIT NOTE</td>
                         <?php } elseif ($mfT[0]['document_type_uid'] == 25) { ?>
         ...
         <?php if($mfT[0]['i_dispatched'] == 'Y') { ?>
         <tr>
               <td class="dc" width="50%;" style="text-align:left;" >Document Already Dispatched - COPY</td>
         </tr>
       <?php } ?>
         <tr>
         ...
         <tr>
           <td class="dc3" width="50%;" style="text-align:left;"><?php echo $mfT[0]['prin_add3'] ?></td>
           <td class="dc3" width="50%;" style="text-align:right;" nowrap ><span style="font-weight:bold;">&nbsp;</td>
         </tr>
         <tr>
           <td class="dc3" width="50%;" style="text-align:left;"><?php echo $mfT[0]['prin_ph_add3'] ?></td>
           <td class="dc3" width="50%;" style="text-align:right;" nowrap ><span style="font-weight:bold;">&nbsp;</td>
         </tr>
         <tr>
         ...
         <tr>
           ...
           <?php   } else { ?>
                     <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Invoice Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo 'PPBKI' . ltrim($mfT[0]['invoice_number'],'0'); ?></span></td>
           <?php   }
                 } elseif (in_array($mfT[0]['status_uid'],array(DST_PROCESSED))) { 
                   if (trim($mfT[0]['alternate_document_number']) <> '' ){ ?>
                     <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Credit Note Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo 'PPBKC' . ltrim($mfT[0]['alternate_document_number'],'0'); ?></span></td>
           <?php   } else { ?>
         ...
         <tr>
           ...
           <td class="dc3" width="50%;" style="text-align:right;" nowrap ><span style="font-weight:bold ;">Account Number</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo $mfT[0]['SFAccount']; ?></span></td>
         </tr>
         <tr>
           <td width="50%;" >&nbsp;</td>
           <td width="50%;" >&nbsp;</td>
         ...
         <tr>
           <td class="dc3" width="50%;" style="text-align:left ;" nowrap><span style="font-weight:bold ;">PO Number </span>&nbsp;&nbsp;<span style="font-weight:bold ;"><?php echo $mfT[0]["customer_order_number"] ?></span></td>
           <?php if(in_array(trim($mfT[0]['document_type_uid']), array('4')) && (trim($mfT[0]['alternate_document_number']) <> '' )){ ?>
                      <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Source Document Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo 'PPBKI' . ltrim($mfT[0]['invoice_number'],'0'); ?></span></td>
           <?php } elseif (trim($mfT[0]['invoice_number']) <> '' ){ ?>
                      <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Sales Order Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo ltrim($mfT[0]['document_number'],'0'); ?></span></td>
           <?php } else { ?>
                      <td width="50%;" >&nbsp;</td>
                      <td width="50%;" >&nbsp;</td>
           <?php   } ?>
         ...
         <tr>
             ...
             <?php } else { ?>
                ...
                <td class="dc3" width="80%;" style="text-align:left;" nowrap ><span style="font-weight:bold ;">Special Instructions</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo str_replace("+","<br>",$mfT[0]['delivery_instructions']); ?></span></td>
           <?php } ?>         
         </tr>

         <?php
             if (in_array($mfT[0]['status_uid'],array(DST_DELIVERED_POD_OK,DST_DIRTY_POD, DST_PROCESSED))) { ?>
                  <tr>
                      <td width="50%;" >&nbsp;</td>
                      <td width="50%;" >&nbsp;</td>
                  </tr>
                  <tr>
                    <td class="dc3" width="50%;" style="text-align:left;" nowrap ><span style="font-weight:bold;">GRV Number</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo $mfT[0]['grv_number']; ?></span></td> 
                    <?php 
                    if(trim($mfT[0]['claim_number']) <> '' ) {  ?>
                          <td class="dc3" width="50%;" style="text-align:right;" nowrap ><span style="font-weight:bold ;">Claim Number</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo $mfT[0]['claim_number']; ?></span></td>
                    <?php                    	
                    } else { ?>
                          <td class="dc3" width="50%;" style="text-align:right;" nowrap >&nbsp</td>
                    <?php
                    }	?>
                  </tr>
            <?php
       ...
       foreach($mfT as $row) {
         ...
         <tr>
           ...
           <?php $totVAT+= $row["vat_amount"];
                 $totTot+= $row["total"] ;
                 $totNett+=$nettcp;
                 if($row["no_discount"] == 'N') {$discTot+=$totNett;} 
                 $cls = "dc4";
                 } ?>
          </tr>
          <tr>
...
<?php
    ...
    // Start of Customer off invoice discount exists 
         ...
         if($mfT[0]['Current_discount'] > 0 && ($mfT[0]['Stored_discount'] == '' || $mfT[0]['Stored_discount'] == '0.00' )) {
...
?>
       ...
       <table style="width:100%;">
        ...
        <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
         ...
         <tr>
         <?php  if (trim($mfT[0]['banking_details']) <> NULL && !in_array($mfT[0]['document_type_uid'],array('4','2')) && ($mfT[0]['bank_details_to_print'] == 1) )  { ?>
         ...
         <?php  } elseif (trim($mfT[0]['alt_banking_details']) <> NULL && !in_array($mfT[0]['document_type_uid'],array('4','2')) && ($mfT[0]['bank_details_to_print'] <> 1) )  { ?>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <img src="<?php echo $ROOT.$PHPFOLDER; ?>images/Kwelanga_Solutions_Logo_smaller.jpg" style="width:60px; height:40px; float:right;" >
           </td>
         </tr>
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo '450_document_invoice_version_bc'; ?>
           </td>
         </tr>
       </table> 
    </body>
...
<script type="text/javascript">
  function emailDoc1() {
      window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfSelf'.trim($document_type). substr($mfT[0]['document_number'],0,8);?>&PSMUID=<?php echo ('');?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo '450_document_invoice_version_bc.php';?>";
  }
  function emailDoc2() {
  	  window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfCust'.trim($document_type). substr($mfT[0]['document_number'],0,8);?>&PSMUID=<?php echo($mfT[0]['psm_uid']);?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo '450_document_invoice_version_bc.php';?>";
}  
</script>

    ...
    <body>
     ...
     <table style="border-collapse:collapse; width:98%">
         <tr>
             ...
             <?php 
                 $filename = "images/logos/{$principalId}.jpg";
                  ...
                  ?>
                  <td width="50%;" rowspan="2";  style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
                      <img src="<?php echo $logo ?>" style=width:140px; height:90px; float:right; >
                  </td>
           <?php } ?>
         </tr>
         <tr>
        ...
        <tr>
         ...
         <tr>
           <td class="dc3" width="50%;" style="text-align:left ;" nowrap><span style="font-weight:bold ;">Dispatched From&nbsp;:&nbsp;&nbsp;&nbsp; <?php echo $mfT[0]['depot_name']; ?></td>
           <td class="dc3" width="50%;" style="text-align:right ;" nowrap><span style="font-weight:bold ;">Customer Number&nbsp;:&nbsp;&nbsp;&nbsp; <?php echo $mfT[0]['SFAccount']; ?></td>
         </tr> 
         <tr>
...
<!-- total line -->
       ...
       <table style="width:100%;">
        ...
        <?php  if (trim($mfT[0]['statementmessage']) <> NULL) { ?>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;"><?php echo 'document_invoice_version_351'; ?>
           </td>
         </tr>
      </table>      

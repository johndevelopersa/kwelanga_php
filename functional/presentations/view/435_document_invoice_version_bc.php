      ...
      <!-- detail -->
       ...
       <table style= "border-collapse:collapse; width:100%; ">
         <tr>
           ...
           <th class="th1" style="text-align:right; width: 9% ;" nowrap >Quantity</th>
           <th class="th1" style="text-align:right; width: 9% ;" nowrap >Price&nbsp;</th>
           <th class="th1" style="text-align:right; width:15% ;" nowrap >Exclusive Total&nbsp;</th>
           <th class="th1" style="text-align:right; width: 9% ;" nowrap >VAT&nbsp;</th>
           <th class="th1" style="text-align:right; width:15% ;" nowrap >Inclusive Total&nbsp;</th>
         </tr>
...
<!--       <td class="dc6" >&nbsp;&nbsp;</td>  -->         
       ...
       <table style="width:100%;">
        ...
        <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo '435_document_invoice_version_bc'; ?>
           </td>
         </tr>
       </table>      

...
<TABLE style='border-style:none; width:100%'>         	
  <TR>
          ...
          <?php if ($mfT[0]['status_uid'] >= 76 AND trim($mfT[0]['invoice_number']) <> '') { ?>
          			<TD colspan="4" style=''><SPAN style='font-weight:normal; color:#999999; text-align:right;' nowrap>Invoice&nbsp;Number&nbsp;</SPAN><SPAN style='font-size:1.2em;'><?php echo substr($mfT[0]['invoice_number'],2,6); ?></SPAN></TD>

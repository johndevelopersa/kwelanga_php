  ...
  <tr>
    ...
    <td>
      ...
      <div  align="center" style="margin:30px 0px;">
        ...
        <div style="margin:60px 0px 20px 0px;"><strong>Line Item Details</strong></div>
        <table border="0" cellpadding="6" cellspacing="0" width="100%" class="grid">
          <tr>
            <th  width="100" align="left">Product Code:</td>
            <th  width="220" align="left"><strong>Description</strong></th>
            <th  width="90" align="left">Order Qty</th>
          </tr>
          <?php

         ...
         <tr>
           ...
           ?>
                  <td width="40%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
                      <?php echo "<img src=".$logo." style=width:130px; height:100px; float:right; >" ?>
                  </td>
           <?php } ?>
         </tr>
         <tr>
        ...
        <tr>
         ...
         <tr>
           ...
           <?php } elseif (trim($mfT[0]['invoice_number']) <> '' ){ ?>
                      <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Sales Order Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo $mfT[0]['client_document_number']; ?></span></td>
           <?php } else { ?>
                      <td width="50%;" >&nbsp;</td>
                      <td width="50%;" >&nbsp;</td>
           <?php   } ?>
         ...
         <tr>
           ...
           <?php } 
               if (in_array($mfT[0]['document_type_uid'],array('2')) && $mfT[0]['priced_uplift'] == 'N') { $cls = "dc4";  ?>
                 ...
                 <td class="<?php echo $cls;  ?>" style="text-align:right"; nowrap>&nbsp;</td>                 
           <?php } else { ?> 	
                 <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap><?php echo number_format($row["selling_price"],2, "."," ")?>&nbsp;</td>
                 <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap><?php echo $row["discount_reference"]?>&nbsp;</td>
                 <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap><?php echo number_format($row["net_price"],2, "."," ")?>&nbsp;</td>
           <?php $totCP+= $row["net_price"];
                 if (in_array($mfT[0]['status_uid'],array(DST_UNACCEPTED,DST_ACCEPTED,DST_INPICK,14))) {            
...
<?php    
    // Start If Customer off invoice discount exists 
       ...
       <table style="width:100%;">           
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;"><?php echo '425_document_invoice_version_dt_bc'; ?>
           </td>
         </tr>
      </table>      

     ...
     <table style="border-collapse:collapse; width:98%">
             ...
             <?php    $document_type = '12'; 
                         ...
                         ?>
                               <td width="40%;" rowspan="3" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
                                            <?php echo "<img src=".$logo." style=width:150px; height:130px; float:right; >" ?></td>
                         <?php } ?>
       ...
       <?php } ?>
         ...
         <tr>
           ...
           <?php   }
                 elseif (in_array($mfT[0]['status_uid'],array(DST_IN_PROGRESS))) { ?>
                     <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Quote Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo ltrim($mfT[0]['document_number'],'0'); ?></span></td>
           <?php } ?>
         </tr>
         <tr>
           <td colspan=2>&nbsp;</td>
         ...
         <tr>
           ...
           <?php 
           if(in_array(trim($mfT[0]['document_type_uid']), array('4')) && (trim($mfT[0]['alternate_document_number']) <> '' )){ ?>
           ...
           <?php 
               ...
               if(trim($mfT[0]['buyer_account_reference']) <> '') {	?>
                   <td class="dc3" width="50%;" style="text-align:right ;" nowrap><span style="font-weight:bold ;">Vendor Number </span>&nbsp;&nbsp;<span style="font-weight:bold ;"><?php echo $mfT[0]["buyer_account_reference"] ?></span></td>
               <?php  
               } else { ?>
                   <td width="50%;" >&nbsp;</td>
               <?php     
...
<!--       <td class="dc6" >&nbsp;&nbsp;</td>  -->         
       ...
       <table style="width:100%;">
        ...
        <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo '458_document_invoice_version_bc'; ?>
           </td>
         </tr>
       </table>      

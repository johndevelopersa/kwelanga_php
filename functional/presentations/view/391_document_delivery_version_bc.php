     ...
     <table style="border-collapse:collapse; width:98%">
       ...
       <?php } ?>
         ...
         <tr>
           ...
           <?php   } else { ?>
                     <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Invoice Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo ltrim($mfT[0]['invoice_number'],'0'); ?></span></td>
           <?php   }
         ...
         <tr>
           ...
           <?php } elseif (trim($mfT[0]['client_document_number']) <> '' ){ ?>
                      <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Sales Order Num</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo $mfT[0]["client_document_number"] ?></span></td>
           <?php } else { ?>
                      <td width="50%;" >&nbsp;</td>
                      <td width="50%;" >&nbsp;</td>
           <?php   } ?>
       ...
       <table style="width:100%;">
        ...
        <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
         ...
         <?php } else { ?>
          ...
          <tr>
           <td class="dc3"><img alt="<?php echo $mfT[0]['principal_uid']  . ' - ' .  ltrim($mfT[0]['document_number'],'0'); ?>" src="<?php echo $ROOT.$PHPFOLDER; ?>barcode/barcode.php?text=<?php echo $mfT[0]['principal_uid'] . ' - ' . ltrim($mfT[0]['document_number'],'0'); ?>&print=true" /></td>
         </tr>
         <tr>
           <td class="dc3" >&nbsp;</td>
         </tr>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo '391_document_delivery_version_bc'; ?>
           </td>
         </tr>
       </table>      
...
<script type="text/javascript">
  function emailDoc1() {
      window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfSelf'.trim($document_type). ltrim($mfT[0]['document_number'],'0');?>&PSMUID=<?php echo ('');?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo 'document_invoice_version1.php';?>";
  }
  function emailDoc2() {
  	  window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfCust'.trim($document_type). ltrim($mfT[0]['document_number'],'0');?>&PSMUID=<?php echo($mfT[0]['psm_uid']);?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo 'document_invoice_version1.php';?>";
}  
</script> 
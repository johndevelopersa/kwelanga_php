   ...
   <title>&nbsp;</title>
    ...
    <body>
     ...
     <table style="border-collapse:collapse; width:98%">
         <tr>
            <td class="dc" style="text-align:left;">Delivery Note - Stock Transfer </td>
         ...
         <tr>
            <td class="dc2" width="50%;" style="text-align:left;" >Dispatch to</td>            
            <td width="50%;" >&nbsp;</td>            
         </tr>         
         <tr>
            <td width="50%;" >&nbsp;</td>
         ...
         <tr>
            <td class="dc2" width="50%;" style="text-align:left;" ><?php echo $mfT[0]['store_name'];?></td>            
            <td width="50%;" >&nbsp;</td>            
         </tr>         
         <tr>
            <td width="50%;" >&nbsp;</td>
         ...
         <tr>
            <td class="dc3" width="60%;" style="text-align:left;"><span style="font-weight:bold;">Dispatch Date   </span><span style="font-weight:normal;"><?php echo $mfT[0]["order_date"]; ?></span></td>
         </tr>
          <tr>
            <td width="50%;" >&nbsp;</td>
         </tr>
         ...
         <tr>
           <td class="dc3" width="50%;" style="text-align:left ;" nowrap><span style="font-weight:bold ;">Reference </span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo $mfT[0]["customer_order_number"] ?></span></td>
...
<!-- total line -->
       ...
       <table style="width:88%;" >
        ...
        <table style="width:100%;"> 
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo 'document_goods_in_transit'; ?>
           </td>
         </tr>
       </table> 
    </body>

...
$mfT = $transactionDAO->getDocumentWithDetailIgnorePermissionsItem($prO->postFindnumber);
      ...
      <style type="text/css">
         ...
         /* print styles */
          ...
          .bordUnderline{border-bottom:1px solid #333;height:30px;}
           ...
           font-size:13px;
           border-collapse:collapse;
           border-left-style:solid;  border-left-color:Gainsboro;  border-left-width:0.1px;
           border-right-style:solid; border-right-color:Gainsboro; border-right-width:0.1px;  }
           ...
           font-weight:normal; 
           font-size:14px;
           border-style:solid solid solid solid; border-color:Gainsboro; border-width:0.1px; } 
           ...
           border-collapse:collapse; 
           border-left-style:solid; border-left-width:0.1px; border-left-color:Gainsboro;
           border-right-style:solid; border-right-width:0.1px; border-right-color:Gainsboro;
           border-top-style:solid; border-top-width:0.1px; border-top-color:Gainsboro;
           border-bottom-style:solid; border-bottom-width:0.1px; border-bottom-color:Gainsboro;}
...
<?php 
         ...
         <tr>
         	  <td>&nbsp;</td> 
            <td class="dc" colspan="6"; width="34%;" style="text-align:left;">Cash Payment</td>
       	 </tr>
     	   <tr>
            <td>&nbsp;</td>         	
            <td colspan="6"; style="text-align:left;">&nbsp;</td>
         ...
         <tr>
         	  <td>&nbsp;</td> 
            <td class="dc3" colspan="6"; width="34%;" style="text-align:left;">Paid To </td>
       	 </tr> 
     	   <tr>
            <td>&nbsp;</td>         	
            <td colspan="6"; style="text-align:left;">&nbsp;</td>
        ...
        <tr>
             <td>&nbsp;</td>
             <td class="dc3" colspan="5"; style="text-align:left;" nowrap ><span style="font-weight:normal;"><?php echo $mfT[0]['store_name']; ?></span></td>
         ...
         <tr>
          ...
          <tr>
         	  <td>&nbsp;</td> 
            <td class="dc3" colspan="2"; width="34%;" style="text-align:left;">Payment Reference </td>
            <td class="dc3" colspan="2"; width="34%;" style="text-align:left;"><?php echo substr($mfT[0]['document_number'],2,6); ?></td>
            <td class="dc3" colspan="2"; width="34%;" style="text-align:left;">&nbsp</td>
            <td class="dc3" colspan="3"; width="34%;" style="text-align:left;">&nbsp</td>
          </tr> 
         	  <td>&nbsp;</td> 
            <td class="dc3" colspan="2"; width="34%;" style="text-align:left;">Payment For</td>
            <td class="dc3" colspan="2"; width="34%;" style="text-align:left;"><?php echo $mfT[0]['delivery_instructions']; ?></td>
       	 </tr>
     	   <tr>
         	  <td>&nbsp;</td> 
            <td class="dc3" colspan="2"; width="34%;" style="text-align:left;">Comments</td>
            <td class="dc3" colspan="3"; width="34%;" style="text-align:left;"><?php echo $mfT[0]['customer_order_number']; ?></td>
       	 </tr> 
     	   <tr>
            <td>&nbsp;</td>         	
            <td colspan="6"; style="text-align:left;">&nbsp;</td>
     ...
     <table style="border-collapse:collapse; width:60%;">
         <tr>
             <th width="16%";>&nbsp;</th>         	
             <th class="th1" width="34%";>&nbsp;&nbsp;Type</th>
             <th class="th1" width="50%";>&nbsp;&nbsp;Payment Amont</th>
         </tr>        
        <?php 
            $paymentTotal = 0;   
            foreach($mfT as $drow) {
               	$paymentTotal = $paymentTotal + $drow['total'];          	
           ?>	
                <tr>
         	         <td>&nbsp;</td> 
                   <td class="dc5" width="50%;" style="text-align:left;">&nbsp;&nbsp;<?php echo $drow['product_description']; ?></td>
                   <td class="dc5" width="50%;" style="text-align:right;"><?php echo number_format($drow['total'],2,'.',' '); ?>&nbsp;&nbsp;</td>
                 
       	        </tr>                     	
                <tr>
         	         <td>&nbsp;</td> 
                   <td class="dc5" width="50%;" style="text-align:left;">&nbsp;&nbsp;</td>
                   <td class="dc5" width="50%;" style="text-align:right;">&nbsp;&nbsp;</td>
           ...
           <?php
            ...
            <tr>
               <td>&nbsp;</td> 
               <td class="dc8" width="50%;" style="text-align:left;">&nbsp;&nbsp;Total</td>
               <td class="dc8" width="50%;" style="text-align:right;"><?php echo number_format($mfT[0]['total'],2,'.',' '); ?>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>         	
     ...
     <table style="border-collapse:collapse; width:90%; ">
     	   <tr>
     	   	    <td width="11%;" >&nbsp;</td>
     	   	    <td class="dc8" width="55%;" style="text-align:center; color:Gainsboro;">Please Sign Here</td> 

...
<table id="wrapper" cellspacing="0" cellpadding="0">
  <tr>
     <td>
      <div id="noprint"><!-- HIDE THIS PRINT AREA : START /--->
        ...
        <div id="toolbar">
          <a href="javascript:;" onclick='printHandler();'><img src="<?php echo $ROOT.$PHPFOLDER ?>images/print-icon.png" border="0" alt="" align="left" > Credit Note</a>
    ...
    <td class="dtitle">
      <h2>
        <?php echo (($mfT[0]["principal_uid"]!="49")?"Copy ":""); ?>Tax Credit Note<br><?php echo $principalName; ?>,<br><?php echo $mfT[0]['depot_name']; ?></h2>
  ...
  <TR>
          ...
          <TD colspan="1" style=''><SPAN style='font-weight:normal; font-size:0.5em; color:#999999;'>Credit Note Number:</SPAN><BR><SPAN style='font-size:1em;'><?php echo ltrim($mfT[0]['alternate_document_number'],'0'); ?></SPAN></TD>
  </TR>
...
function emailDoc() {
	var params="?USERID=<?php echo $userId; ?>&OBJECTID=<?php echo EO_DOC_CARD_NCRD; ?>&SUBJECT=Order Details as per Request: <?php echo $postDOCMASTID; ?>&DOCMASTID=<?php echo $postDOCMASTID; ?>";
...
function printHandler() {
	...
	var params="?USERID=<?php echo $userId; ?>&OBJECTID=<?php echo EO_DOC_CARD_NCRD; ?>&DOCMASTID=<?php echo $postDOCMASTID; ?>&KEYFROMLINK=<?php echo $postKEYFROMLINK; ?>";

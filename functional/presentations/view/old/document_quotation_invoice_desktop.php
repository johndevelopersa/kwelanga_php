   ...
   <title>&nbsp;</title>
    ...
    <body>
       ...
       <table style="border-style:bold; width:95%">
         <tr>
           <td class="dc" colspan="3" style="text-align:left;">Proforma Invoice</td>
         </tr>
         <tr>
           <td>&nbsp;</td>
         </tr>
         <tr>
           <td class="dc2" style="text-align:left;"><?php echo $mfT[0]["principal_name"]; ?></td>
         </tr>
         <tr>
           <td class="dc3" style="text-align:left ;"><?php echo $mfT[0]["prin_add1"] ?></td>
           <td class="dc3" colspan="2" style="text-align:right ;" nowrap><span style="font-weight:bold ;">Email Address </span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo $mfT[0]["p_email"] ?></span></td>
         </tr>       
         <tr>
           <td class="dc3" style="text-align:left ;"><?php echo $mfT[0]["prin_add2"] ?></td>
           <td class="dc3" colspan="2" style="text-align:right ;" nowrap><span style="font-weight:bold ;">Office Tel </span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo substr($mfT[0]['office_tel'],0,3).' '. substr($mfT[0]['office_tel'],3,3) .' '. substr($mfT[0]['office_tel'],6,4)?></span></td>
         </tr>
         <tr>
          <?php if (trim($mfT[0]['office_tel2']) <> NULL) { ?>
            <td class="dc3" style="text-align:left ;" nowrap><span style="font-weight:bold ;">VAT No </span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo $mfT[0]["prin_vat"] ?></span></td>
            <td class="dc3" colspan="2" style="text-align:right ;" nowrap><span style="font-weight:bold ;">or         </span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo substr($mfT[0]['office_tel2'],0,3).' '. substr($mfT[0]['office_tel2'],3,3) .' '. substr($mfT[0]['office_tel2'],6,4)?></span></td>
          <?php } ?>
         </tr>
         <tr>
         <?php if (trim($mfT[0]['company_reg']) <> NULL) { ?>
           <td class="dc3" style="text-align:left ;" nowrap><span style="font-weight:bold ;">Company Reg No </span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo $mfT[0]["company_reg"] ?></span></td>
         <?php } ?>
         </tr>
         <tr>
           <td class="dc3" style="text-align:left ;" nowrap><span style="font-weight:bold ;">Date </span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo $mfT[0]["order_date"]; ?></span></td>
           <td class="dc3" colspan="2" style="text-align:right ;" nowrap><span style="font-weight:bold ;">Quote Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo substr($mfT[0]['document_number'],3,6); ?></span></td>
         </tr>
         <tr>
           <td colspan=2>&nbsp;</td>
         </tr>
         <tr>
           <td class="dc3" style="text-align:left ;" nowrap><span style="font-weight:bold ;">Customer </span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo $mfT[0]["store_name"] ?></span></td>
         </tr>
         <tr>
           <td colspan=2>&nbsp;</td>
         </tr>
...
<!-- total line -->
         <tr>
           ...
           <td class="dc6" >&nbsp;&nbsp;</td>
           <td class="dc8" style="text-align:right"; nowrap ><?php echo $totNett; ?>&nbsp;</td>
           <td class="dc8" style="text-align:right"; nowrap ><?php echo $totVAT; ?>&nbsp;</td>
           <td class="dc8" style="text-align:right"; nowrap ><?php echo $totTot; ?>&nbsp;</td>
         </tr>         
       </table>  
       <!-- footer -->
...
<script type="text/javascript">
  function emailDoc1() {
    window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo (str_pad('pdfSelfProformaInvoice',27,' ')).'E';?>&PSMUID=<?php echo('');?>&PRINNAM=<?php echo($mfT[0]['principal_name']);?>"
  }
  function emailDoc2() {
    window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo (str_pad('pdfCustProformaInvoice',27,' ')).'E';?>&PSMUID=<?php echo($mfT[0]['psm_uid']);?>&PRINNAM=<?php echo($mfT[0]['principal_name']);?>"
  }
</script> 

...
$hasRoleED   = $adminDAO->hasRole(mysql_real_escape_string($userId), mysql_real_escape_string($principalId),ROLE_EMAIL_DOCUMENT);
    ...
    <body>
            ...
            <td>
             <div id="noprint"><!-- HIDE THIS PRINT AREA : START /--->
               <div id="toolbar">
                 ...
                 <?php if ($userCategory == "P" || $hasRoleED) { ?>
     ...
     <table style="border-collapse:collapse; width:100%;">
         <tr>
             <td width="3%;" >&nbsp;</td>         	
               <?php if(in_array($mfT[0]['status_uid'],array(DST_INVOICED, DST_DELIVERED_POD_OK,DST_DIRTY_POD))) { ?>
                   <td class="dc"  width="34%;" style="text-align:left;">DELIVERY NOTE</td>
         ...
         <tr>
             ...
             <td class="dc3" width="30%;"style="text-align:right;">&nbsp;</td> 
             <td width="3%;">&nbsp;</td>
         </tr>
         <tr>
             <td>&nbsp;</td>
             <td class="dc3" style="text-align:left;"><?php echo $mfT[0]["prin_add2"]; ?></td>
             <td class="dc3" style="text-align:right;">&nbsp;</td> 
             <td>&nbsp;</td>
         </tr>
         <tr>
             <td>&nbsp;</td>
         ...
         <tr>
             ...
             <td>&nbsp;</td>
             <?php if (trim($mfT[0]['office_tel']) <> NULL) { ?>

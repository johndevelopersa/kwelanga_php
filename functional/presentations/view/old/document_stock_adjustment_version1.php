   ...
   <title>&nbsp;</title>
    ...
    <body>
     ...
     <table style="border-collapse:collapse; width:100%">
         ...
         <tr>
            <td class="dc3" width="60%;" style="text-align:left;"><span style="font-weight:bold;">Date   </span><span style="font-weight:normal;"><?php echo $mfT[0]["order_date"]; ?></span></td>
         </tr>
          <tr>
            <td width="50%;" >&nbsp;</td>
         </tr>
         <tr>
           <td class="dc3" width="50%;" style="text-align:left;" nowrap><span style="font-weight:bold;">Document Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo substr($mfT[0]['document_number'],2,6); ?></span></td>
         </tr>
         <tr>
       ...
       <table style="width:88%;" >
        ...
        <table style="width:100%;"> 
         <tr>
           ...
           <td class="dc3" style="width:25%;">&nbsp;</td>
           <td class="dc3" style="width:25%;">&nbsp;</td>
           <td width="25%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <img src="<?php echo HOST_SURESERVER_AS_USER.$PHPFOLDER; ?>images/kwelanga1.gif" style="width:75px; height:30px; float:right;" ></td>
         </tr>
         <tr>
           <td class="dc3" style="width:25%;">&nbsp;</td>
           <td class="dc3" style="width:25%;">&nbsp;</td>

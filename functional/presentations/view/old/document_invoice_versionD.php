...
<!-- total line -->
       ...
       <table style="width:100%;">
        ...
        <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
         ...
         <tr>
         <?php  if (trim($mfT[0]['banking_details']) <> NULL && !in_array($mfT[0]['document_type_uid'],array('4','2')) && ($mfT[0]['q_r_code_to_print'] == 1) )  { ?>
         ...
         <?php  } elseif (trim($mfT[0]['alt_banking_details']) <> NULL && !in_array($mfT[0]['document_type_uid'],array('4','2')) && ($mfT[0]['q_r_code_to_print'] <> 1) )  { ?>

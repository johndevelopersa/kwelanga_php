   ...
   <title>&nbsp;</title>
    ...
    <body>
     ...
     <table style="border-collapse:collapse; width:100%;">
         <tr>
             <td width="3%;" >&nbsp;</td>         	
               <?php if(in_array($mfT[0]['status_uid'],array(DST_INVOICED, DST_DELIVERED_POD_OK,DST_DIRTY_POD))) { ?>
                   <td class="dc"  width="34%;" style="text-align:left;">INVOICE</td>
               <?php $document_type = '42'; 
                ...
                <?php $document_type = '4'; 
                   ...
                   <td class="dc"  width="34%;" style="text-align:left;">ORDER</td>
         ...
         <tr>
             ...
             ?>
                  <td rowspan="5" width="26%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
                      <?php echo "<img src=".$logo." style=width:50px; height:30px; float:left; >" ?></td>
             <?php } ?>
             <td width="32%;">&nbsp;</td>
         </tr>
         <tr>
             <td width="3%;">&nbsp;</td>
             <td class="dc3" width="38%;" style="text-align:left;"><?php echo $mfT[0]["prin_add1"]; ?></td>
             <td class="dc3" width="30%;"style="text-align:right;"><?php echo $mfT[0]["prin_ph_add1"]; ?></td> 
             <td width="3%;">&nbsp;</td>
         </tr>
         <tr>
             <td>&nbsp;</td>
             <td class="dc3" style="text-align:left;"><?php echo $mfT[0]["prin_add2"]; ?></td>
             <td class="dc3" style="text-align:right;"><?php echo $mfT[0]["prin_ph_add2"]; ?></td> 
             <td>&nbsp;</td>
         </tr>
         <tr>
             <td>&nbsp;</td>
             <td class="dc3" style="text-align:left;"><?php echo $mfT[0]["prin_add3"]; ?></td>
             <td class="dc3" style="text-align:right;"><?php echo $mfT[0]["prin_ph_add3"]; ?></td> 
             <td>&nbsp;</td>
         </tr>
         <tr>
             <td>&nbsp;</td>
         ...
         <tr>
             <td>&nbsp;</td>
             <td class="dc3" style="text-align:left ;" nowrap ><span style="font-weight:bold;">Email Address </span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo $mfT[0]["p_email"]; ?></span></td>
             <td>&nbsp;</td>
             <td class="dc3" style="text-align:right;" nowrap ><span style="font-weight:bold;">Office Tel </span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo substr($mfT[0]['office_tel'],0,3).' '. substr($mfT[0]['office_tel'],3,3) .' '. substr($mfT[0]['office_tel'],6,4)?></span></td>
             <td>&nbsp;</td>
         </tr> 
         <tr>
           <td>&nbsp;</td>
           <td class="dc3" width="50%;" style="text-align:left;" nowrap >&nbsp</td>
           <td>&nbsp;</td>
           <?php 
         ...
         <tr>
             ...
             <td>&nbsp;</td>
               ...
               <?php if(in_array($mfT[0]['status_uid'],array(DST_INVOICED, DST_DELIVERED_POD_OK,DST_DIRTY_POD))) { ?>
             <td class="dc3" style="text-align:right;" nowrap ><span style="font-weight:bold;">Invoice Number</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo substr($mfT[0]['document_number'],2,6); ?></span></td>
               <?php
               } elseif(in_array($mfT[0]['status_uid'],array(DST_PROCESSED))) { ?>
             ...
             <td class="dc3" style="text-align:right;" nowrap ><span style="font-weight:bold;">Order Number</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo substr($mfT[0]['document_number'],2,6); ?></span></td>
               <?php } ?>
             <td>&nbsp;</td>
         </tr> 
         <tr>
         ...
         <tr> 
             <td>&nbsp;</td>
             <td class="dc3" style="text-align:left;" nowrap ><span style="font-weight:bold;">Customer</span>&nbsp;&nbsp;</td>
             <td>&nbsp;</td>
         ...
         <tr>
             <td>&nbsp;</td>
             <td class="dc3" style="text-align:left;" nowrap ><span style="font-weight:normal;"><?php echo $mfT[0]['bill_name']; ?></span></td>
             <td>&nbsp;</td>
         ...
         <tr>
             <td>&nbsp;</td>
             <td class="dc3" style="text-align:left;" nowrap ><span style="font-weight:normal;"><?php echo $mfT[0]['bill_add1']; ?></span></td>
             <td>&nbsp;</td>
         ...
         <tr>
             <td>&nbsp;</td>
             <td class="dc3" style="text-align:left;" nowrap ><span style="font-weight:normal;"><?php echo $mfT[0]['bill_add2']; ?></span></td>
             <td>&nbsp;</td>
         ...
         <tr>
             <td>&nbsp;</td>
             <td class="dc3" style="text-align:left;" nowrap ><span style="font-weight:normal;"><?php echo $mfT[0]['bill_add3']; ?></span></td>
             <td>&nbsp;</td>
         ...
         <tr>
            <td>&nbsp;</td>
             <td class="dc3" style="text-align:left;" nowrap ><span style="font-weight:bold ;">Customer Reference </span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo $mfT[0]["customer_order_number"] ?></span></td>
             <td>&nbsp;</td>
         </tr>
         <tr>
             <td>&nbsp;</td>
         ...
         if($mfT[0]['delivery_instructions'] <> NULL) { ?>
           <tr>
              <td>&nbsp;</td>
              <td class="dc3" width="45%;" style="text-align:left;" nowrap ><span style="font-weight:bold ;">Tracking No</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo $mfT[0]['delivery_instructions']; ?></span></td>
       ...
       <table style= "border-collapse:collapse; width:100%; ">
         <tr>
           ...
           <th class="th1" style="width:34% ;" nowrap >&nbsp;&nbsp;Description</th>
           <th class="th1" style="width:13% ;" nowrap >&nbsp;&nbsp;Quantity</th>
           <th class="th1" style="width:13% ;" nowrap >&nbsp;&nbsp;Price</th>
           <th class="th1" style="width:16% ;" nowrap >&nbsp;&nbsp;Total</th>
           <th style="width:2%;">&nbsp;</th>
...
<!-- total line -->
      ...
      <?php  if (trim($mfT[0]['banking_details']) <> NULL && !in_array($mfT[0]['document_type_uid'],array('4','2')))  { ?>
           <table style="border-collapse:collapse; width:100%;">      
              ...
              <tr>
               <td width="3%;">&nbsp;</td>
                <td class="dc3" style="width:96%"; "text-align:left"; nowrap ><?php echo (str_replace(chr(43),"<br>", $mfT[0]["banking_details"]))?></td>
               <td width="3%;">&nbsp;</td>
              </tr>   
           </table>  
       <?php } ?>
       <table style="border-collapse:collapse; width:100%;"> 
         ...
         <tr>
             <td width="3%;">&nbsp;</td>	
             <td width="94%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <img src="<?php echo HOST_SURESERVER_AS_USER.$PHPFOLDER; ?>images/kwelanga1.gif" style="width:100px; height:45px; float:right;" ></td>
             <td width="3%;">&nbsp;</td>	
         </tr>
         <tr>
             <td width="3%;">&nbsp;</td>	
             <td width="94%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;"><?php echo date('Y-m-d H:i:s'); ?></td>
             <td width="3%;">&nbsp;</td>
         </tr>
       </table> 
    </body>

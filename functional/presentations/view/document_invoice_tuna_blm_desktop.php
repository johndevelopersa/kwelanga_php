  ...
  <!-- <?php print_r($mfT); ?> -->
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" >
          ...
          <TD colspan="1">&nbsp;</TD>
           ...
           <td nowrap valign="bottom"><strong><?php echo $mfT[0]['principal_name']; ?></td><td  >&nbsp;</td>
           <td nowrap valign="bottom"><strong></td>&nbsp;<td  >&nbsp;</td>
          </tr><tr>
           <td nowrap valign="bottom" ><strong><?php echo $mfT[0]['physical_add1']?>&nbsp;&nbsp;<?php echo $mfT[0]['physical_add2']; ?></td><td width="250" >&nbsp;</td>
           <td nowrap valign="bottom" ><strong>&nbsp;</td><td width="250" >&nbsp;</td>
          </tr><tr>
           <td nowrap valign="bottom" ><strong>&nbsp</td>
           <td nowrap valign="bottom" ><strong>&nbsp;</td><td width="250" >&nbsp;</td>
          </tr><tr>
           <td nowrap valign="bottom" ><strong>VAT no:&nbsp;&nbsp;<?php echo $mfT[0]['vat_num'];?></td><td width="250" >&nbsp;</td>
          </tr><tr>
        </table>

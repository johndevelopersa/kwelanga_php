           ...
           <?php $totCP+= $row["net_price"];
                 if (in_array($mfT[0]['status_uid'],array(DST_UNACCEPTED,DST_INPICK,DST_ACCEPTED,14))) {            
                   ...
                   $weightTot+=($row['ordered_qty']*$row['weight']); 
                    ...
                    $nettcpex = $nettcp * 100 /115;
                    $vatEX    = $row["total"] - $nettcpex;
                    $weightTot+=($row['document_qty']*$row['weight']); 
                 } 
                 
                 
                 ?>
                 <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap><?php echo number_format($nettcpex,2,"."," ")?>&nbsp;</td>
                 <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap><?php echo number_format(15,2, "."," ")?>&nbsp;</td>
                 <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap><?php echo number_format($vatEX,2, "."," ")?>&nbsp;</td>
...
<!--       <td class="dc6" >&nbsp;&nbsp;</td>  -->         
       ...
       <table style="width:100%;">
        ...
        <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo '394_document_invoice_version1'; ?>
           </td>
         </tr>
       </table>      

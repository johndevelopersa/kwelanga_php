     ...
     <table style="border-collapse:collapse; width:100%">
       ...
       <tr>
        ...
        <tr>
           ...
           <?php } else { ?> 
                <td class="dc3" width="50%;" style="text-align:right;" nowrap ><span style="font-weight:bold;">Purchase Order Number &nbsp;</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo substr($mfT[0]['document_number'],3,6); ?></span></td>
           <?php } ?>
        </tr>
       <tr>
           <td width="50%;" >&nbsp;</td>
       ...
       <tr>
           <td class="dc3" width="50%;" style="text-align:left;" nowrap ><span style="font-weight:normal;">Quote Details</span>&nbsp;&nbsp;<span style="font-weight:normal;">&nbsp;</span></td>
       </tr>
     </table>
     <style>
        <?php if (substr($outputTyp,0,3) == "pdf") { ?>
           ...
           foreach($mfT as $row) { 
                ...
                <tr>
                   ...
                   <?php } else { ?> 	
                      ...
                      <?php $totCP+= $row["net_price"]; $nettcp=$row["ordered_qty"]*$row["net_price"]; ?>
       ...
       <?php  } ?>	   	         
         ...
         <tr>
         <?php if ($hasRoleSign and substr($outputTyp,0,3) <> "pdf"){
                  echo SignatureArea::outputCanvas($docmastId, $mfT[0]['document_number'], $transactionDAO); 
               } else { ?>  	
                  <td width="50%;" >&nbsp;</td>
                  <td width="50%;" >&nbsp;</td>
               <?php } ?>
...
<script type="text/javascript">
  function emailDoc1() {
        window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfSelf'.(trim($mfT[0]['document_type_uid'])) . substr($mfT[0]['document_number'],2,6);?>&PSMUID=<?php echo ('');?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo 'document_quote_desktop_new.php';?>";
 }
  function emailDoc2() {
    window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfCustQuotation';?>&PSMUID=<?php echo($mfT[0]['psm_uid']);?>&PRINNAM=<?php echo($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo 'document_quote_desktop_new.php';?>"
  }
</script>
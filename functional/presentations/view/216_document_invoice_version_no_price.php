     ...
     <table style="border-collapse:collapse; width:98%">
         <tr>
             ...
             <?php    $document_type = '12'; 
                         ...
                         <?php } elseif ($mfT[0]['document_type_uid'] == 3) { ?>
                                    <td class="dc" style="text-align:left;">STOCK TRANSFER</td>
             ...
             <?php    $document_type = STR_PAD($mfT[0]['document_type_uid'],2,'0',STR_PAD_LEFT);
                 ...
                 if($mfT[0]['captured_by_name'] == 'Shopify') {
           	           $coName = 'Italian Deli Online';
                 } else {
           	           $coName = $mfT[0]["principal_name"];
                 } ?>
         </tr>
         <tr>
           <td class="dc2" width="60%;" style="text-align:left;"><?php echo $coName;  ?></td>
           <?php 
               if($mfT[0]['captured_by_name'] == 'Shopify') {
               	    $filename = "images/logos/{$principalId}b.jpg";               	
               } else {
           ...
           ?>
                  <td width="40%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
                      <?php echo "<img src=".$logo." style=width:140px; height:90px; float:right; >" ?>
                  </td>
           <?php } ?>
         </tr>
         <tr>
        ...
        <tr>
         ...
         <tr>
           ...
           <?php   } else { ?>
                     <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Invoice Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo substr(trim($mfT[0]['invoice_number']),0,12); ?></span></td>
           <?php   }
         ...
         <tr>
           ...
           <?php if(in_array(trim($mfT[0]['document_type_uid']), array('4')) && (trim($mfT[0]['alternate_document_number']) <> '' )){ ?>
                      <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Source Document Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo substr($mfT[0]['source_document_number'],2,6); ?></span></td>
           <?php } elseif (trim($mfT[0]['invoice_number']) <> '' ){ ?>
                      <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Sales Order Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo substr($mfT[0]['document_number'],2,6); ?></span></td>
           <?php } else { ?>
                      <td width="50%;" >&nbsp;</td>
                      <td width="50%;" >&nbsp;</td>
           <?php   } ?>
         ...
         if($mfT[0]['delivery_instructions'] <> NULL) { ?>
           <tr>
              <td class="dc3" width="50%;" style="text-align:left;" nowrap ><span style="font-weight:bold ;">Special Instructions</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo substr($mfT[0]['delivery_instructions'],0,99); ?></span></td>
              <td class="dc3" width="50%;" style="text-align:right;" nowrap ><span style="font-weight:normal;">&nbsp;</span></td>
           </tr>         
         <?php } ?>         
      ...
      <!-- detail -->
       ...
       <table style= "border-collapse:collapse; width:100%; ">
         <tr>
           <th class="th1" style="width:14% ;" nowrap >Code</th>
           <th class="th1" style="width:22% ;" nowrap >Description</th>
           <th class="th1" style="width: 2% ;" nowrap ><?php echo "<img src=".$ROOT.$PHPFOLDER."images/logos/small_tick.jpg style=width:10px; height:10px; float:right; >" ?></th>
           <th class="th1" style="width: 8% ;" nowrap >Qty</th>
           <th class="th1" style="width: 7% ;" nowrap >List Price</th>
           <th class="th1" style="width: 7% ;" nowrap >Disc.</th>
           <th class="th1" style="width: 7% ;" nowrap >Net Price</th>
           <th class="th1" style="width:12% ;" nowrap >Exclusive Total</th>
           <th class="th1" style="width: 8% ;" nowrap >Vat</th>
           <th class="th1" style="width:14% ;" nowrap >Inclusive Total</th>
         </tr>
         <?php $totQ=0; $totLP=0; $totDV=0; $totCP=0; $totNett=0; $totVAT=0; $totTot = 0; $weightTot=0; $discTot=0;
         $cls = "dc5";
       foreach($mfT as $row) {
         $nettCP=0;
         ?>
         <tr>
           ...
           <td class="<?php echo $cls; ?>" style= text-align:left; nowrap>&nbsp;</td>
           <?php if (in_array($mfT[0]['status_uid'],array(DST_UNACCEPTED,DST_ACCEPTED, DST_INPICK,14))) {  
                      if($row['allow_decimal'] == 'Y') { 
                      	  $totQ+= $row["ordered_qty"] / 100 ;?>
                          <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap><?php echo $row["ordered_qty"] / 100 ?>&nbsp;</td>
                      <?php 
                      } else { 
           ...
           <?php } else { 
                      ...
                      if($row['allow_decimal'] == 'Y') { 
                      	  $totQ+= $row["document_qty"] / 100 ;?>
                          <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap><?php echo $row["document_qty"] / 100 ?>&nbsp;</td>
                      <?php 
                      } else { 
           ...
           <?php } 
               if (in_array($mfT[0]['document_type_uid'],array('2')) && $mfT[0]['priced_uplift'] == 'N') { $cls = "dc4";  ?>
                 ...
                 <td class="<?php echo $cls;  ?>" style="text-align:right"; nowrap>&nbsp;</td>                 
           <?php } else { 
                 if($row['no_prices_on_invoice'] == 'Y') { ?> 
                      <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap>&nbsp;</td>
                      <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap>&nbsp;</td>
                      <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap>&nbsp;</td>                 	
                 <?php 
                 } else {?>
                      <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap><?php echo number_format($row["discount_value"]+$row["net_price"],2, "."," ")?>&nbsp;</td>
                      <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap><?php echo number_format($row["discount_value"],2, "."," ")?>&nbsp;</td>
                      <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap><?php echo number_format($row["net_price"],2, "."," ")?>&nbsp;</td>                 	
                 	
                 <?php	
                 }
                 $totCP+= $row["net_price"];
                 if (in_array($mfT[0]['status_uid'],array(DST_UNACCEPTED,DST_INPICK,DST_ACCEPTED,14))) {
                      if($row['allow_decimal'] == 'Y') {           
                          $nettcp=$row["ordered_qty"]*$row["net_price"]/100;
                          $weightTot+=($row['ordered_qty']*$row['weight']);
                          $vat_amount = $row["vat_amount"] / 100;
                          $rtotal = $row["total"] / 100;
                      } else {
                      ...
                      if($row['allow_decimal'] == 'Y') {           
                          $nettcp=$row["document_qty"]*$row["net_price"]/100;
                          $weightTot+=($row['ordered_qty']*$row['weight']);
                          $vat_amount = $row["vat_amount"]/100;
                          $rtotal = $row["total"]/100;
                      } else {
                 ...
                 <?php 
                       ...
                       <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap><?php echo number_format($vat_amount,2, "."," ")?>&nbsp;</td>
                       <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap><?php echo number_format($rtotal,2, "."," ")?>&nbsp;</td>                 
                 <?php 
                 }
                 ...
                 $totTot+= $rtotal ;
                 $totNett+=$nettcp;
                 if($row["no_discount"] == 'N') {$discTot+=$rtotal;} 
                 $cls = "dc4";
                 } ?>
          </tr>
          <tr>
...
<!-- total line -->
         ...
         <tr>
           <td class="dc6" colspan="3" >&nbsp;&nbsp;&nbsp;&nbsp;</td>
           <td class="dc8" style="text-align:right"; nowrap ><?php echo $totQ; ?>&nbsp;</td>
           <td class="dc6" >&nbsp;&nbsp;</td>           
           <td class="dc6a" >&nbsp;&nbsp;</td>
           <?php
           if($row['no_prices_on_invoice'] == 'Y') { ?> 
               <td class="dc6a" style="text-align:right"; nowrap >&nbsp;</td>
               <td class="dc8" style="text-align:right"; nowrap >&nbsp;</td>
               <td class="dc8" style="text-align:right"; nowrap >&nbsp;</td>
               <td class="dc8" style="text-align:right"; nowrap >&nbsp;</td>
           <?php
           } else { ?>
               <td class="dc6a" style="text-align:right"; nowrap >ZAR</td>
...
<?php    
    // Start of Customer off invoice discount exists 
         $showDiscount = $dAmount = $dVat = $dTot = 0;
         if($mfT[0]['no_prices_on_invoice'] == 'N') {
              if($mfT[0]['Current_discount'] > 0 && $mfT[0]['Stored_discount'] == '') {
         	
         	             if($mfT[0]['Stored_discount_type'] == 'A') {
         	                    $dType   = $mfT[0]['Stored_discount'];
                              $dAmount = round($mfT[0]['Current_discount'] * 100 / 115,2) ;
                              $dTot    = $mfT[0]['Current_discount']  ;
                              $dVat    = $dTot - $dAmount ;
           	                  ...
           	                  $dType   = $mfT[0]['Current_discount'] . "%";
           	                  $dTot    = $discTot  * $mfT[0]['Current_discount'] / 100 ;
           	                  $dAmount = round($dTot * 100 / 115,2) ;
                              $dVat    = $dTot - $dAmount ; 
                              
           	           
                              $showDiscount = 1;

                              // Update invoice discount field
           	           }
           	           
           	           include_once($ROOT.$PHPFOLDER."DAO/InvoiceDiscountDAO.php");
           	           
                       $InvoiceDiscountDAO = new InvoiceDiscountDAO($dbConn);
                       $iDisc = $InvoiceDiscountDAO->storeInvoiceDiscountUid($mfT[0]['dm_uid'], $mfT[0]['Current_discount']);
 
              } elseif($mfT[0]['Stored_discount'] > 0 ) {
         	
                       if($mfT[0]['Stored_discount_type'] == 'A') {

        	                    $dType   = $mfT[0]['Stored_discount'];
                              $dAmount = round($mfT[0]['Stored_discount'] * 100 / 115,2) ;
                              $dTot    = $mfT[0]['Stored_discount']  ;
                              $dVat    = $dTot - $dAmount ;
           	                  ...
           	                  $showDiscount = 1;
           	           	      ...
           	           	      $dType   = $mfT[0]['Stored_discount']  . "%";
                              $dTot    = $discTot  * $mfT[0]['Stored_discount'] / 100 ;
           	                  $dAmount = round($dTot * 100 / 115,2) ;
                              $dVat    = $dTot - $dAmount ; 
           	                  $showDiscount = 1;         	
           	           }   
              }
              $tDamount = $totNett - $dAmount;
              $tDvat    = $totVAT  - $dVat;
              $tDtot    = $totTot  - $dTot;
              ...
              if($showDiscount == 1) {  ?>    
                 <tr>
                     <td colspan="5" >&nbsp;&nbsp;&nbsp;&nbsp;</td>
                     <td class="dc8" style="border-style:none; text-align:right"; nowrap >&nbsp;Discount</td>
                     <td class="dc6" style="border-style:none; text-align:right"; nowrap ><?php echo $dType; ?>&nbsp;&nbsp;&nbsp;</td>
                     <td class="dc8" style="text-align:right"; nowrap ><?php echo number_format($dAmount,2,'.',' '); ?>&nbsp;</td>
                     <td class="dc8" style="text-align:right"; nowrap ><?php echo number_format($dVat,2,'.',' '); ?>&nbsp;</td>
                     <td class="dc8" style="text-align:right"; nowrap ><?php echo number_format($dTot,2,'.',' '); ?>&nbsp;</td>
                </tr>             
                <tr>
                     <td colspan="6" >&nbsp;&nbsp;&nbsp;&nbsp;</td>
                     <td class="dc8" style="border-style:none; text-align:right"; nowrap >Total&nbsp;&nbsp;</td>
                     <td class="dc8" style="text-align:right"; nowrap ><?php echo number_format($tDamount,2,'.',' '); ?>&nbsp;</td>
                     <td class="dc8" style="text-align:right"; nowrap ><?php echo number_format($tDvat,2,'.',' '); ?>&nbsp;</td>
                     <td class="dc8" style="text-align:right"; nowrap ><?php echo number_format($tDtot,2,'.',' '); ?>&nbsp;</td>
                </tr>         
                <?php
              } 
         }       
       // End If Customer off invoice discount exists 
       ?>
       </table>
       <!-- footer -->
       <table style="width: 700px;">
        <tr>
             <td colspan="1" style="width:17%; border-style:none;" >&nbsp;</td>
             <td colspan="1" style="width:17%; border-style:none;" >&nbsp;</td>
             <td colspan="1" style="width:11%; border-style:none;" >&nbsp;</td>
             <td colspan="1" style="width:55%; border-style:none;" >&nbsp;</td>
        </tr>	
          <?php  if (trim($mfT[0]['q_r_code_to_print']) <> NULL && strlen(trim($mfT[0]['q_r_code_to_print'])) > 6 )  { ?>
        <tr>   
           <td colspan="2" class="dc3a" style="text-align:left"; nowrap >Paying by Snapscan, add 3% to the invoice value    Please pay &nbsp;<?php echo number_format($totTot + ($totTot*3/100),2)?></td>
           <td colspan="1" class="dc3a" rowspan="2" style="text-align:left"; nowrap ><img src="<?php echo HOST_SURESERVER_AS_NEWUSER.$PHPFOLDER; ?>images/<?php echo (trim($mfT[0]['q_r_code_to_print']));?>.png" style="width:80px; height:80px; float:left;" ></td>
           <td colspan="1" class="dc3">&nbsp;</td>
        </tr>
           <?php } ?>


        <tr>
           <?php  if (trim($mfT[0]['tcs']) <> NULL && $mfT[0]['captured_by_name'] <> 'Shopify') { ?>
              <td colspan="1" class="dc2" style="text-align:left;" nowrap >Terms and Conditions </td>
           <?php } else { ?>
              <td colspan="3" class="dc3" >&nbsp;</td>
           <?php } ?>
        </tr>
        ...
        <?php  if (trim($mfT[0]['tcs']) <> NULL  && $mfT[0]['captured_by_name'] <> 'Shopify') { ?>
           <tr>
              <td colspan="4" class="dc3" style="text-align:left"; nowrap ><?php echo (str_replace(chr(43),"<br>", $mfT[0]['tcs'])); ?></td>

           </tr>


           <tr>
              <td colspan="4" class="dc3" style="text-align:left"; nowrap ><?php echo (str_replace(chr(43),"<br>", $mfT[0]['btcs'])); ?></td>
           </tr>


        <?php  if (trim($mfT[0]['statementmessage']) <> NULL  && $mfT[0]['captured_by_name'] <> 'Shopify') { ?>
           <tr>
              <td colspan="4" class="dc3" style="text-align:left"; nowrap><?php echo (str_replace(chr(43),"<br>", $mfT[0]['statementmessage'])); ?> &nbsp;&nbsp;&nbsp;<?php echo ltrim($mfT[0]['document_number'], '0'); ?></td>
           </tr>
         <?php } 
           } else { ?>
           ...
           <tr>
              <td class="dc3"  colspan="4" class="dc3" style="text-align:left";>&nbsp;</td>
           </tr>
           <?php } ?>
         ...
         <?php  
           if($mfT[0]['captured_by_name'] <> 'Shopify') {
                if (trim($mfT[0]['banking_details']) <> NULL && !in_array($mfT[0]['document_type_uid'],array('4','2')) && ($mfT[0]['bank_details_to_print'] == 1) )  { ?>
                   <td class="dc3" style="width:50%"; "text-align:left"; nowrap >Banking Details&nbsp;&nbsp;<?php echo (str_replace(chr(43),"<br>", $mfT[0]["banking_details"]))?></td>
                <?php  
                } elseif (trim($mfT[0]['alt_banking_details']) <> NULL && !in_array($mfT[0]['document_type_uid'],array('4','2')) && ($mfT[0]['bank_details_to_print'] <> 1) )  { ?>
                   <td class="dc3" style="width:50%"; "text-align:left"; nowrap >Banking Details&nbsp;&nbsp;<?php echo (str_replace(chr(43),"<br>", $mfT[0]["alt_banking_details"]))?></td>
                <?php 
                } else { ?>
                       <td class="dc3" >&nbsp;</td>
                <?php 
                       ...
                       <td class="dc3" >&nbsp;</td>
           <?php } ?>
           <td class="dc3" ><img alt="<?php echo $mfT[0]['principal_uid']  . ' - ' .  ltrim(substr($mfT[0]['document_number'],0,8),'0'); ?>" src="<?php echo $ROOT.$PHPFOLDER; ?>barcode/barcode.php?text=<?php echo $mfT[0]['principal_uid'] . ' - ' . ltrim(substr($mfT[0]['document_number'],0,8),'0'); ?>&print=true" /></td>        
         </tr>	
         <?php  if (trim($mfT[0]['statementmessage']) <> NULL &&  $mfT[0]['captured_by_name'] <> 'Shopify') { ?>
           <tr>
              <td class="dc3a" style="width:80%"; "text-align:left"; nowrap ><?php echo (str_replace(chr(10),"<br>", $mfT[0]['statementmessage'])); ?> &nbsp;&nbsp;&nbsp;<?php echo ltrim($mfT[0]['document_number'], '0'); ?></td>
           </tr>
         <?php } ?>
         <tr>
           <td class="dc3" >&nbsp;</td>
          ...
          <tr>
           <td class="dc3" style="width:100%"; "text-align:left"; nowrap >Received in good order, all items on invoiced confirmed received.
...
&nbsp;&nbsp;</td>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;"><?php echo '216_document_invoice_version_no_price'; ?>
           </td>
         </tr>
      </table>      
...
if($mfT[0]['auto_mail_invoice'] == 'Y' && $mfT[0]['invoice_mailed'] == 'N') {
	
	    $PostTransactionDAO = new PostTransactionDAO($dbConn);
      $errorTO = $PostTransactionDAO->updateInvoiceMailedFlag(mysqli_real_escape_string($dbConn->connection, $docmastId));
	    ?>
      <script type="text/javascript">
        	  window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfCust'.trim($document_type). substr($mfT[0]['document_number'],2,6);?>&PSMUID=<?php echo($mfT[0]['psm_uid']);?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo '216_document_invoice_version_email.php';?>";
      </script>
<?php
...
<script type="text/javascript">
  function emailDoc1() {
      window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfSelf'.trim($document_type). substr($mfT[0]['document_number'],2,6);?>&PSMUID=<?php echo ('');?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo '216_document_invoice_version_email.php';?>";
  }
  function emailDoc2() {
  	  window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfCust'.trim($document_type). substr($mfT[0]['document_number'],2,6);?>&PSMUID=<?php echo($mfT[0]['psm_uid']);?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo '216_document_invoice_version_email.php';?>";
}  

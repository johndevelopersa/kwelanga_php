    ...
    <body>
     ...
     <table style="border-collapse:collapse; width:98%">
         ...
         <?php
           ...
           <?php } ?>
                <tr>
                  <td class="dc3" width="50%;" style="text-align:left;" nowrap ><span style="font-weight:bold;">Warehouse </span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo $mfT[0]['depot_name']; ?></span></td>
                  <td class="dc3" width="50%;" style="text-align:right;" nowrap ><span style="font-weight:bold ;">Debtor Code</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo $mfT[0]['SFAccount']; ?></span></td> 
               </tr>           
...
<!--       <td class="dc6" >&nbsp;&nbsp;</td>  -->         
       ...
       <table style="width:100%;">
        ...
        <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo 'document_invoice_version_304'; ?>
           </td>
         </tr>
       </table>      

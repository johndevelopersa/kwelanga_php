     ...
     <table style="border-collapse:collapse; width:98%">
         <tr>
             ...
             <?php    $document_type = STR_PAD($mfT[0]['document_type_uid'],2,'0',STR_PAD_LEFT);
                   } elseif (in_array($mfT[0]['status_uid'],array(DST_WAITING_DISPATCH))) { ?> 
                            <td colspan = "2" class="dc" style="text-align:left;">PICKING DOCUMENT - NOT FOR DELIVERY</td>
                  <?php 
                   } elseif (in_array($mfT[0]['status_uid'],array(DST_RE_DELIVERY))) { ?> 
                            <td colspan = "2" class="dc" style="text-align:left;">RE DEILIVERY DOCUMENT - PICK FROM RETURNS</td>
                  <?php
       ...
       <?php } ?>
         ...
         <tr>
           ...
           <td class="dc3" width="50%;" style="text-align:right;" nowrap ><span style="font-weight:bold;">Delivered by Nellwyn CC on behalf of Shoprite Checkers (Pty) Ltd</td>
         </tr>
         <tr>
         <tr>
           <td class="dc3" width="50%;" style="text-align:left;"><?php echo $mfT[0]['prin_add2'] ?></td>
           <td class="dc2" width="50%;" style="text-align:right;" nowrap ><span style="font-weight:normal;">Nellwyn CC.</td>
         </tr>
 
         <tr>
              <td class="dc3" width="50%;" style="text-align:left;"><?php echo $mfT[0]['prin_add3'] ?></td>
              <td width="50%"; style="text-align:right ;" >21 Brons Cres</td>
         </tr>
         <tr>
              <td width="50%;" >&nbsp;</td>
              <td width="50%"; style="text-align:right ;" >Gauteng Office Park</td>
              
         </tr>         
         <tr>
              <td width="50%;" >&nbsp;</td>
              <td width="50%"; style="text-align:right ;" >Clayville</td>
         ...
         <tr>
           ...
           <?php   } else { ?>
                     <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Document Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo substr(trim($mfT[0]['invoice_number']),0,8); ?></span></td>
           <?php   }
...
<!--       <td class="dc6" >&nbsp;&nbsp;</td>  -->         
       ...
       <table style="width:100%;">
        ...
        <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo '401_document_invoice_version_bc'; ?>
           </td>
         </tr>
       </table>      

    ...
    <body>
     ...
     <table style="border-collapse:collapse; width:98%">
         <tr>
            ...
            <td width="50%;" rowspan="3" ><img alt="<?php echo $mfT[0]['principal_uid']  . ' - ' .  ltrim(substr($mfT[0]['document_number'],0,8),'0'); ?>" src="<?php echo $ROOT.$PHPFOLDER; ?>barcode/barcode.php?text=<?php echo $mfT[0]['principal_uid'] . ' - ' . ltrim(substr($mfT[0]['document_number'],0,8),'0'); ?>&print=true" /></td>
...
<!-- total line -->
       ...
       <table style="width:88%;" >
        ...
        <tr>
           ...
           <td class="dc3" style="width:22%;">&nbsp;</td>
           <td class="dc3" style="width:22%;">&nbsp;</td>
           <td class="dc3" colspan="1" ><img alt="<?php echo 'End'; ?>" src="<?php echo $ROOT.$PHPFOLDER; ?>barcode/barcode.php?text=<?php echo 'End'; ?>&print=true" /></td>
          <          
        </tr>	           
        </table>

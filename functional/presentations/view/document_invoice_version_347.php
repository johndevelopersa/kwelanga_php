     ...
     <table style="border-collapse:collapse; width:98%">
        ...
        <tr>
         ...
         <tr>
           ...
           <?php if (in_array($mfT[0]['status_uid'],array(DST_INVOICED, DST_DELIVERED_POD_OK,DST_DIRTY_POD))) { 
                   if (trim($mfT[0]['invoice_number']) == '' ){ ?>
                     <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Invoice Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo trim(substr($mfT[0]['client_document_number'],0,10)); ?></span></td>
           <?php   } else { ?>
                     <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Invoice Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo trim(substr($mfT[0]['client_document_number'],0,10)); ?></span></td>
           <?php   }
           ...
           <?php   }
                     ...
                     <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Document Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo trim(substr($mfT[0]['client_document_number'],0,9)); ?></span></td>
           <?php   }
         ...
         <tr>
          ...
          <tr>
           ...
           <td class="dc3" width="50%;" style="text-align:right;" nowrap ><span style="font-weight:bold;">Customer Delivered To</span></td>
         </tr>
         <tr>
         ...
         <tr>
           <td class="dc3" width="50%;" style="text-align:left ;" nowrap><span style="font-weight:bold ;">Customer Order No </span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo $mfT[0]["customer_order_number"] ?></span></td>
           ...
           <?php } elseif (trim($mfT[0]['invoice_number']) <> '' ){ ?>
                      <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Sales Order Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo substr($mfT[0]['document_number'],0,9); ?></span></td>
           <?php } else { ?>
                      <td width="50%;" >&nbsp;</td>
                      <td width="50%;" >&nbsp;</td>
           <?php   } ?>
      ...
      <!-- detail -->
       ...
       foreach($mfT as $row) {
         $nettCP=0; ?>
         <tr>
         	 <?php if(in_array($row['depot_uid'], array(202,7,431)) && trim($row["alt_code"]) <> '') { ?> 
               <td class="<?php echo $cls; ?>" nowrap><?php echo $row["alt_code"]?>&nbsp;</td>
           <?php } else { ?>
...
<!--       <td class="dc6" >&nbsp;&nbsp;</td>  -->         
       ...
       <table style="width:100%;">
          <?php  if (trim($mfT[0]['q_r_code_to_print']) <> NULL && strlen(trim($mfT[0]['q_r_code_to_print'])) > 6 )  { ?>
           ...
           <tr>   
           <td class="dc3a" style="width:100%"; "text-align:right"; nowrap >Paying by Snapscan, add 3% to the invoice value    Please pay &nbsp;<?php echo number_format($totTot + ($totTot*3/100),2)?></td>
           </tr>
           <?php } ?>
         <tr>
           <td class="dc3" >&nbsp;</td>
        ...
        <tr>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;"><?php echo 'document_invoice_version_347'; ?>
           	</td>
         </tr>
      </table>      
...
<script type="text/javascript">
  function emailDoc1() {
      window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfSelf'.trim($document_type). substr($mfT[0]['document_number'],2,6);?>&PSMUID=<?php echo ('');?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo 'document_invoice_version_347.php';?>";
  }
  function emailDoc2() {
  	  window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfCust'.trim($document_type). substr($mfT[0]['document_number'],2,6);?>&PSMUID=<?php echo($mfT[0]['psm_uid']);?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo 'document_invoice_version_347.php';?>";
}  
</script> 
     ...
     <table style="border-collapse:collapse; width:98%">
       ...
       <?php } ?>
         ...
         <tr>
           ...
           <?php         
              if($mfT[0]['export_number_enabled'] == "Y") { ?>
              <td class="dc3" width="50%;" style="text-align:right;" nowrap ><span style="font-weight:bold ;">Export No:&nbsp;&nbsp;<SPAN style='font-size:1.2em;'><?php echo $mfT[0]['export_number'];?></SPAN></td>
           <?php } else { ?>
         ...
         <tr>
           <td class="dc3" width="50%;" style="text-align:left ;" nowrap><span style="font-weight:bold ;">UCR Number </span>&nbsp;&nbsp;<span style="font-weight:bold ;"><?php echo $mfT[0]["customer_order_number"] ?></span></td>
...
<!--       <td class="dc6" >&nbsp;&nbsp;</td>  -->         
       ...
       <table style="width:100%;">
        ...
        <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo '452_document_invoice_version_bc'; ?>
           </td>
         </tr>
       </table>      
...
<script type="text/javascript">
  function emailDoc1() {
      window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfSelf'.trim($document_type). substr($mfT[0]['document_number'],0,8);?>&PSMUID=<?php echo ('');?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo '452_document_invoice_version_bc.php';?>";
  }
  function emailDoc2() {
  	  window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfCust'.trim($document_type). substr($mfT[0]['document_number'],0,8);?>&PSMUID=<?php echo($mfT[0]['psm_uid']);?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo '452_document_invoice_version_bc.php';?>";
}  
</script> 
...
<TABLE style='border-style:none; width:49%; float: left;'>
     <tr>
         ...
         <?php } ?>         	
          <?php if (trim($mfT[0]['company_reg']) == "") { ?>
             <TD colspan="4" style=''><SPAN style='font-weight:bold; color:black;'></SPAN>Company Reg:&nbsp;&nbsp;<SPAN style='font-size:1.2em;'><?php echo $mfT[0]['company_reg'];?></SPAN></TD>
         <?php } ?>         	
     </tr>
    </TABLE>
...
<TABLE style='border-style:none; width:100%'>         	
  <TR>
          <TD colspan="4" style=''><SPAN style='font-weight:normal; color:#999999;'>Customer</SPAN><BR><SPAN style='font-size:1.2em;'><?php echo $mfT[0]['store_name']; ?></SPAN></TD>
          <?php if ($mfT[0]['status_uid'] >= 76 AND trim($mfT[0]['invoice_number']) <> '') { ?>
          			<TD colspan="4" style=''><SPAN style='font-weight:normal; color:#999999; text-align:right;' nowrap>Invoice&nbsp;Number</SPAN><BR><SPAN style='font-size:1.2em;'><?php echo substr($mfT[0]['invoice_number'],2,6); ?></SPAN></TD>
          <?php } elseif ($mfT[0]['status_uid'] >= 76) { ?>
          			<TD colspan="4" style=''><SPAN style='font-weight:normal; color:#999999; text-align:right;' nowrap>Invoice&nbsp;Number</SPAN><BR><SPAN style='font-size:1.2em;'><?php echo substr($mfT[0]['document_number'],2,6); ?></SPAN></TD>
          <?php } else { ?>
         			<TD colspan="4" style=''><SPAN style='font-weight:normal; color:#999999; text-align:right;' nowrap>Document&nbsp;Number</SPAN><BR><SPAN style='font-size:1.2em;'><?php echo substr($mfT[0]['document_number'],2,6); ?></SPAN></TD>
          <?php }?>
   </TR>
  <TR>

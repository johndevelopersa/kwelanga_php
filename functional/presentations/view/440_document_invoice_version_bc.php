     ...
     <table style="border-collapse:collapse; width:98%">
       ...
       <?php } ?>
         ...
         <tr>
           ...
           <?php   } else { ?>
                     <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Invoice Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo "HEA" . str_pad(substr(trim($mfT[0]['invoice_number']),0,6),7,"0", STR_PAD_LEFT); ?></span></td>
           <?php   }
...
<!--       <td class="dc6" >&nbsp;&nbsp;</td>  -->         
       ...
       <table style="width:100%;">
        ...
        <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo '403_document_invoice_version_bc'; ?>
           </td>
         </tr>
       </table>      

     ...
     <table style="border-collapse:collapse; width:98%">
         ...
         <tr>
           ...
           ?>
                  <td width="40%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
                      <?php echo "<img src=".$logo." style=width:240px; height:120px; float:left; >" ?>
                  </td>
           <?php } ?>
         </tr>
         <tr>
           ...
           <?php if (trim($mfT[0]['p_email']) <> NULL) { ?>
             <td class="dc3" width="50%;" style="text-align:left;" nowrap ><span style="font-weight:bold;">Email Address </span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo $mfT[0]["p_email"]; ?></span></td>
             <?php } ?>
         </tr>
         <tr>
           <td class="dc3" width="50%;" style="text-align:left;"><?php echo $mfT[0]['prin_add2'] ?></td>
           <td class="dc3" width="50%;" style="text-align:left;" nowrap ><span style="font-weight:bold;">Office Tel </span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo substr($mfT[0]['office_tel'],0,3).' '. substr($mfT[0]['office_tel'],3,3) .' '. substr($mfT[0]['office_tel'],6,4)?></span></td>
         </tr>
         <tr>
           ...
           <?php 
             if (trim($mfT[0]['office_tel2']) <> NULL) { ?>
               <td class="dc3" width="50%;" style="text-align:left;" nowrap ><span style="font-weight:bold;">/</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo substr($mfT[0]['office_tel2'],0,3).' '. substr($mfT[0]['office_tel2'],3,3) .' '. substr($mfT[0]['office_tel2'],6,4)?></span></td>
           <?php } ?>
         </tr>   
         <tr>
         ...
         <tr>
           ...
           <?php if (in_array($mfT[0]['status_uid'],array(DST_INVOICED, DST_DELIVERED_POD_OK,DST_DIRTY_POD))) { 
                   if (trim($mfT[0]['invoice_number']) == '' ){ ?>
                     <td class="dc3" width="50%;" style="text-align:left;" nowrap><span style="font-weight:bold;">Invoice Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo substr($mfT[0]['document_number'],0,8); ?></span></td>
           <?php   } else { ?>
                     <td class="dc3" width="50%;" style="text-align:left;" nowrap><span style="font-weight:bold;">Invoice Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo substr(trim($mfT[0]['invoice_number']),0,15); ?></span></td>
           <?php   }
                 } elseif (in_array($mfT[0]['status_uid'],array(DST_PROCESSED))) { 
                   if (trim($mfT[0]['alternate_document_number']) <> '' ){ ?>
                     <td class="dc3" width="50%;" style="text-align:left;" nowrap><span style="font-weight:bold;">Credit Note Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo substr($mfT[0]['alternate_document_number'],0,8); ?></span></td>
           <?php   } else { ?>
                     <td class="dc3" width="50%;" style="text-align:left;" nowrap><span style="font-weight:bold;">Document Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo substr($mfT[0]['document_number'],0,8); ?></span></td>
           <?php   }
                }elseif (in_array($mfT[0]['status_uid'],array(DST_UNACCEPTED,DST_ACCEPTED,14))) { ?>
                     <td class="dc3" width="50%;" style="text-align:left;" nowrap><span style="font-weight:bold;">Document Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo substr($mfT[0]['document_number'],0,8); ?></span></td>
           <?php   }
         ...
         <tr>
          ...
          <tr>
           ...
           <td class="dc3" width="50%;" style="text-align:left;" nowrap ><span style="font-weight:bold;">Customer Invoice to</span>&nbsp;&nbsp;</td>
         </tr>
         <tr>
         ...
         <tr>
           ...
           <?php         
              ...
              <td class="dc3" width="50%;" style="text-align:left;" nowrap ><span style="font-weight:bold ;">Company Registration</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo $mfT[0]['vat_number_2']; ?></span></td>
           <?php } else { ?>
         ...
         <tr>
           ...
           <?php if(in_array(trim($mfT[0]['document_type_uid']), array('4')) && (trim($mfT[0]['alternate_document_number']) <> '' )){ ?>
                      <td class="dc3" width="50%;" style="text-align:left;" nowrap><span style="font-weight:bold;">Source Document Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo substr($mfT[0]['source_document_number'],0,8); ?></span></td>
           <?php } elseif (trim($mfT[0]['invoice_number']) <> '' ){ ?>
                      <td class="dc3" width="50%;" style="text-align:left;" nowrap><span style="font-weight:bold;">Sales Order Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo substr($mfT[0]['document_number'],0,8); ?></span></td>
           <?php } else { ?>
                      <td width="50%;" >&nbsp;</td>
                      <td width="50%;" >&nbsp;</td>
           <?php   } ?>
             ...
             if($mfT[0]['areauid'] <> NULL || $mfT[0]['overrep_code'] <> NULL) {
                if($mfT[0]['overrep_code'] <> 000) {   ?>
                  <tr>
                    ...
                    <td class="dc3" width="50%;" style="text-align:left;" nowrap ><span style="font-weight:bold ;">Override Rep</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo $mfT[0]['overrep_name']; ?></span></td>
                  </tr>
            <?php
                }
             } 
      ...
      <!-- detail -->
       ...
       <table style= "border-collapse:collapse; width:100%; ">
         <tr>
           ...
           <th class="th1" style="width: 9% ;" nowrap >Vat Rate</th>
       ...
       foreach($mfT as $row) {
         ...
         <tr>
           ...
           <?php $totCP+= $row["net_price"];
                 ...
                 <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap><?php echo number_format($row["vat_rate"],2, "."," ")?>&nbsp;</td>
       ...
       <table style="width:100%;">
        ...
        <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
         ...
         <?php  if (trim($mfT[0]['banking_details']) <> NULL && !in_array($mfT[0]['document_type_uid'],array('4','2')) && ($mfT[0]['bank_details_to_print'] == 1) )  { ?>
           <td class="dc3" style="width:50%"; "text-align:left"; nowrap ><?php echo (str_replace(chr(43),"<br>", $mfT[0]["banking_details"]))?></td>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo 'document_invoice_version365'; ?>
           </td>
         </tr>
       </table>      

    ...
    <body>
     ...
     <table style="border-collapse:collapse; width:98%">
             ...
             <?php    $document_type = '12'; 
                         ...
                         ?>
                               <td width="40%;" rowspan="3" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
                                            <?php echo "<img src=".$logo." style=width:200px; height:140px; float:right; >" ?></td>
                         <?php } ?>
       ...
       <?php } ?>
         ...
         <tr>
         	<?php if($mfT[0]["IHeading"] == 'TRIGZ') { ?>
         	    <td class="dc2" width="60%;" style="text-align:left;"><?php echo "TRIGZ (PTY) LTD"; ?></td>	
         	<?php } else { ?>
      ...
      <!-- detail -->
       ...
       foreach($mfT as $row) {
         ...
         // Get the packaging Boxes
         $transactionDAO = new TransactionDAO($dbConn);
         $trigBox = $transactionDAO->getPackagingBoxes($mfT[0]["dm_uid"]);
         foreach($trigBox as $row) { ?>
         	   <tr>
                <td class="<?php echo $cls; ?>" nowrap><?php echo $row["old_code"]?>&nbsp;</td>
                <td class="<?php echo $cls; ?>" style= text-align:left; nowrap>Boxes&nbsp;</td>
                <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap><?php echo $row["BoxQty"]?>&nbsp;</td>
                <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap>&nbsp;</td>
                <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap>&nbsp;</td>
                <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap>&nbsp;</td>
                <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap>&nbsp;</td>
             ...
             <tr>
                ...
                <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap>&nbsp;</td>
                <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap>&nbsp;</td>
                <td class="dc4" style="text-align:right"; nowrap>&nbsp;</td>
             </tr>
          <?php
          } ?>
<!-- total line -->
...
<!--       <td class="dc6" >&nbsp;&nbsp;</td>  -->         
       ...
       <table style="width:100%;">
        ...
        <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo '439_document_invoice_version_bc'; ?>
           </td>
         </tr>
       </table>      

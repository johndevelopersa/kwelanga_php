     ...
     <table style="border-collapse:collapse; width:98%">
             ...
             <?php    $document_type = '12'; 
                         ...
                         ?>
                               <td width="40%;" rowspan="3" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
                                            <?php echo "<img src=".$logo." style=width:160px; height:140px; float:right; >" ?></td>
                         <?php } ?>
       ...
       <?php } ?>
         ...
         <tr>
           ...
           <?php   } else { ?>
                     <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Invoice Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo "B27" . str_pad(substr(trim($mfT[0]['invoice_number']),0,6),7,"0", STR_PAD_LEFT); ?></span></td>
           <?php   }
      ...
      <!-- detail -->
          <tr>
           <td width="75%;" >&nbsp;</td>
           <td width="25%;" class="dc3"><img alt="<?php echo $mfT[0]['principal_uid']  . ' - ' .  ltrim(substr($mfT[0]['document_number'],0,8),'0'); ?>" style="float:right" src="<?php echo $ROOT.$PHPFOLDER; ?>barcode/barcode.php?text=<?php echo $mfT[0]['principal_uid'] . ' - ' . ltrim(substr($mfT[0]['document_number'],0,8),'0'); ?>&print=true" /></td>
         </tr>
         <tr>
...
<!--       <td class="dc6" >&nbsp;&nbsp;</td>  -->         
       ...
       <table style="width:100%;">
        ...
        <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo '457_document_invoice_version_bc'; ?>
           </td>
         </tr>
       </table>      

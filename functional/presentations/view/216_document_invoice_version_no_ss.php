      ...
      <!-- detail -->
       ...
       <table style= "border-collapse:collapse; width:100%; ">
         <tr>
           ...
           <th class="th1" style="width:13% ;" nowrap >Exclusive Total</th>
...
<?php    
    // Start If Customer off invoice discount exists 
         $showDiscount = $dAmount = $dVat = $dTot = 0;
         
         if($mfT[0]['Current_discount'] > 0 && $mfT[0]['Stored_discount'] == '' ) {
          
           	           $dType   = $mfT[0]['Current_discount'] . "%";
           	           $dAmount = $totNett * $mfT[0]['Current_discount'] / 100 ;
           	           $dVat    = $totVAT  * $mfT[0]['Current_discount'] / 100 ; 
           	           $dTot    = $totTot  * $mfT[0]['Current_discount'] / 100 ;
                       ...
                       $iDisc = $InvoiceDiscountDAO->storeInvoiceDiscountUid($mfT[0]['dm_uid'], $mfT[0]['Current_discount']);
           	           ...
           	           $dAmount = $totNett * $mfT[0]['Stored_discount'] / 100 ;
           	           $dVat    = $totVAT  * $mfT[0]['Stored_discount'] / 100 ; 
           	           $dTot    = $totTot  * $mfT[0]['Stored_discount'] / 100 ;
           	           $showDiscount = 1;         	
         ...
         <?php  
           if($mfT[0]['captured_by_name'] <> 'Shopify') {
                ...
                <?php 
                       ...
                       <td class="dc3" >&nbsp;</td>
           <?php } ?>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">&nbsp; </td>        
         </tr>	
         <?php  if (trim($mfT[0]['statementmessage']) <> NULL &&  $mfT[0]['captured_by_name'] <> 'Shopify') { ?>
           <tr>

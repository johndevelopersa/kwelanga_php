...
<TITLE>Trip Sheet - Print</TITLE>
    ...
    <table style="border-collapse:collapse; width:70%">
         ...
         <tr>
            ...
            <td class="th1" colspan="1" style="text-align:centre; padding:3px;">Weight</td>
            <td class="th1" colspan="2" style="text-align:left;  padding:3px;">Comment</td>
            <td colspan="1" style="text-align:left;">&nbsp;</td>         
         </tr>
         <?php
         $totQ=0; $totwt=0;
         foreach($tsDT as $row) { ?>
             <tr>
                <td colspan="1" style="text-align:left;">&nbsp;</td>
                <td class='dc5' colspan="1" nowrap><?php echo $row['Principal']?></td>
                <td class='dc5' colspan="1" nowrap><?php echo $row['Docno']?></td>
                ...
                <td class='dc5' colspan="1" style='text-align:center;' nowrap><?php echo round($row['Weight'],2); ?></td>
                <td class='dc5' colspan="2" style='text-align:center;' nowrap>&nbsp;</td>
                <td colspan="1" style="text-align:left;">&nbsp;</td>
             </tr>
             <tr>
                <td colspan="1" style="text-align:left;">&nbsp;</td>
        ...
        <?php
         ...
         <tr>          	
             ...
             <td class='dc8' colspan="1" style='text-align:center;' nowrap><?php echo round($totwt,2);?></td>
         ...
         <tr>
            <td colspan="1" >&nbsp;</td>
            <td class="dc3" colspan="5" style="text-align:left;" >&nbsp;</td>
            <td  colspan="4" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;"><?php echo 'trip_sheet_document'; ?>
           </td>
           <td colspan="1" >&nbsp;</td>    	
         </tr> 
         <tr>              

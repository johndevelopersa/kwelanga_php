    ...
    <body>
     ...
     <table style="border-collapse:collapse; width:98%">
         ...
         <tr>
            ...
            <td class="dc3" width="60%;" style="text-align:right;"><span style="font-weight:bold;">Picking Date   </span><span style="font-weight:normal;"><?php echo date("Y-m-d") ; ?></span></td>
         </tr>
          <tr>
         ...
         <tr>
           ...
           <?php if ($mfT[0]["principal_uid"] == 342) { ?>
               <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Document Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo "ITE" . substr($mfT[0]['document_number'],2,6); ?></span></td>
           <?php } else { ?>
         ...
         <tr>
           ...
           <td class="dc3" width="50%;" style="text-align:right ;" nowrap><span style="font-weight:bold ;">Customer Reference </span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo $mfT[0]["customer_order_number"] ?></span></td>
         </tr>         
         <tr>
           <td class="dc3" width="50%;" style="text-align:left;" nowrap ><span style="font-weight:normal;"><?php echo $mfT[0]['deliver_add3']; ?></span></td>
         <?php if ($mfT[0]["delivery_date"] <> "0000-00-00") { ?> 
           <td class="dc3" width="50%;" style="text-align:right ;" nowrap><span style="font-weight:bold ;">Delivery Date </span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo $mfT[0]["delivery_date"] ?></span></td>
         <?php } ?>
         </tr> 
         <tr>
           ...
           <td class="dc3" width="50%;" style="text-align:right;" nowrap ><span style="font-weight:bold ;">Area</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo $mfT[0]['area']; ?></span></td>
         </tr>        
          <tr>
           ...
           <td class="dc3" width="50%;" style="text-align:right;" nowrap ><span style="font-weight:bold ;">Rep Name</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo $mfT[0]["rep_name"]; ?></span></td>
         </tr>
       ...
       <table style= "border-collapse:collapse; width:100%; ">
         <tr>
           ...
           <th class="th1" style="width:10% ;" nowrap >Order Quantity</th>
           <th class="th1" style="width:10% ;" nowrap >Picked Quantity</th>
         </tr>
           <?php $totQ=0;
               $cls = "dc5";
               foreach($mfT as $row) { ?>

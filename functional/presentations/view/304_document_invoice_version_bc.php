       ...
       <table style="width:100%;">
        ...
        <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
           ...
           <?php  if (trim($mfT[0]['q_r_code_to_print']) <> NULL && strlen(trim($mfT[0]['q_r_code_to_print'])) > 6 )  { ?>
             <tr>   
               <td colspan="2" class="dc3a" style="text-align:left"; nowrap >Pay by Shop Code </td>
               <td colspan="1" class="dc3a" rowspan="2" style="text-align:left"; nowrap ><img src="<?php echo HOST_SURESERVER_AS_NEWUSER.$PHPFOLDER; ?>images/logos/304-QR.jpg" style="width:80px; height:80px; float:left;" ></td>

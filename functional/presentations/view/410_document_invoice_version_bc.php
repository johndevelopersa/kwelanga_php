     ...
     <table style="border-collapse:collapse; width:98%">
       ...
       <?php } ?>
         ...
         <tr>
           ...
           <td class="dc3" width="50%;" style="text-align:right;" nowrap ><span style="font-weight:normal;">Nellwyn CC.</td>
         </tr>
         ...
         <tr>
           ...
           <?php } else { ?>
              <td width="50%;" >&nbsp;</td>
              <td width="50%"; style="text-align:right ;" >7 Koppel Street</td>
           <?php } ?>
         </tr>
         <tr>
              <td width="50%;" >&nbsp;</td>
              <td width="50%"; style="text-align:right ;" >Olifantsfontien</td>
         </tr>         
         <tr>
...
<!--       <td class="dc6" >&nbsp;&nbsp;</td>  -->         
       ...
       <table style="width:100%;">
        ...
        <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo '390_document_invoice_version_bc'; ?>
           </td>
         </tr>
       </table>      

    ...
    <body>
     ...
     <table style="border-collapse:collapse; width:98%">
         ...
         <tr>
           ...
           ?>
                  <td width="40%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
                      <?php echo "<img src=".$logo." style=width:200px; height:120px; float:right; >" ?>
                  </td>
           <?php } ?>
         </tr>
         <tr>
         ...
         <tr>
           ...
           <?php if (in_array($mfT[0]['status_uid'],array(DST_INVOICED, DST_DELIVERED_POD_OK,DST_DIRTY_POD, DST_INPICK))) { 
...
<!--       <td class="dc6" >&nbsp;&nbsp;</td>  -->         
       ...
       <table style="width:100%;">
        ...
        <tr>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo 'document_invoice_version370'; ?>
           </td>
         </tr>
       </table>      

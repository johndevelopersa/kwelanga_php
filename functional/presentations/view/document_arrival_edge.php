      ...
      <div  align="center" style="margin:30px 0px;">
        ...
        <table border="0" cellpadding="6" cellspacing="0" width="100%" class="grid">
          ...
          <tr>
            ...
            <td width="230"><strong><?php echo CommonUtils::convertUserTime($mfT[0]['processed_time']) ?></strong></td>
          </tr>
          <tr>
            <td>Captured By: </td>
          ...
          <tr>
            <td>Received From :</td>
            <td><strong><?php echo $mfT[0]['delivery_instructions'] ?></strong></td>
            <td>Goods Received Note :</td>
            <td><strong><?php echo $mfT[0]['customer_order_number'] ?></strong></td>
          </tr>
        </table>
        ...
        <table border="0" cellpadding="6" cellspacing="0" width="100%" class="grid">
          <tr>
            ...
            <th  width="310"><strong>Description</strong></th>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" >
          <tr>
            <td width="150" valign="bottom"><strong>Receiving Manager:</td><td  class="bordUnderline">&nbsp;</td>
          </tr><tr>
            <td valign="bottom" ><strong>Picker Packer :</td><td width="250" class="bordUnderline">&nbsp;</td>
          </tr><tr>
           <td valign="bottom"><strong> Ops Manager :</td><td  class="bordUnderline">&nbsp;</td>

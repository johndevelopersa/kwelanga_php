   ...
   <title>&nbsp;</title>
      ...
      <style type="text/css">
         ...
         /* print styles */
          ...
          <?php if (substr($outputTyp,0,3) == "pdf") { ?>
                   ...
                   td.dc2a {background-color:white; 
                   color:black; 
                   font-weight:normal; 
                   font-size:44px;}
    ...
    <body>
     ...
     <table style="border-collapse:collapse; width:100%">
         ...
         <tr>
            <td class="dc" width="15%;" style="text-align:left;"><?php echo $mfT[0]['document_type_description'] ?></td>
            <?php    $document_type = STR_PAD($mfT[0]['document_type_uid'],2,'0',STR_PAD_LEFT);?>
            <td class="dc2" width="85%;" style="text-align:left;"><?php echo "Recieved by Nellwyn CC on behalf of Shoprite Checkers (Pty) Ltd" ?></td>
         </tr>
         <tr>
            <td width="50%;" >&nbsp;</td>
            <td width="50%;" >&nbsp;</td>            
         ...
         <tr>
            ...
            <td class="dc2" width="50%;" style="text-align:right;" ><span style="font-weight:bold;">Principal   </span><span style="font-weight:bold;"><?php echo $mfT[0]["principal_name"]; ?></span></td>            
         </tr>         
         <tr>
            <td class="dc2" width="50%;" style="text-align:left; font-weight:normal;" ><?php echo "21 Brons Cres"; ?></td>
            <td class="dc2" width="50%;" style="text-align:right; font-weight:normal;" ><?php echo "2020 Nichol Way"; ?></td>            
         </tr>         
         <tr>
            <td class="dc2" width="50%;" style="text-align:left; font-weight:normal;" ><?php echo "Gauteng Office"; ?></td>
            <td class="dc2" width="50%;" style="text-align:right; font-weight:normal;" ><?php echo "Bryanston"; ?></td>            
         </tr>          
         <tr>
            <td class="dc2" width="50%;" style="text-align:left; font-weight:normal;" ><?php echo "Clayville"; ?></td>
            <td class="dc2" width="50%;" style="text-align:right; font-weight:normal;" ><?php echo " "; ?></td>            
         </tr>          
         <tr>
            <td width="50%;" >&nbsp;</td>
         </tr>
       ...
       <table style= "border-collapse:collapse; width:80%; ">
         <tr>
           ...
           <th class="th1" style="width:20% ;" nowrap >Received Quantity</th>
         </tr>
           <?php $totQ=0;
               $cls = "dc5";
               foreach($mfT as $row) { ?>
...
<!-- total line -->
       ...
       <table style="width:88%;" >
        ...
        <?php  if (trim($mfT[0]['delivery_instructions']) <> NULL ) { ?>	
         <tr>
           <td class="dc2" style="text-align:left; font-weight:bold; " nowrap >Comments</td>
         </tr>
         <tr>
           <td class="dc2a" style="text-align:left; "><?php echo (str_replace(chr(10),"<BR>", $mfT[0]['delivery_instructions'])); ?></td>
         </tr>
        <?php } ?>
         <tr>
           <td class="dc3" style="width:22%;">&nbsp;</td>
        ...
        <table style="width:100%;"> 
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo 'document_stock_movement_version_kc'; ?>
           </td>
         </tr>
       </table>             
...
<script type="text/javascript">
  function emailDoc1() {
      window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfSelf'.trim($document_type). substr($mfT[0]['document_number'],2,6);?>&PSMUID=<?php echo ('');?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo 'document_stock_movement_version1.php';?>";
  }
  function emailDoc2() {
  	  window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfCust'.trim($document_type). substr($mfT[0]['document_number'],2,6);?>&PSMUID=<?php echo($mfT[0]['psm_uid']);?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo 'document_stock_movement_version1.php';?>";
}  
</script> 
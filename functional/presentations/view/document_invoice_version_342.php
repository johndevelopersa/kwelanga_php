...
$mCopy = $postTransactionDAO->UpdateDocumentCopies(mysqli_real_escape_string($dbConn->connection, $docmastId));
   ...
   <title>&nbsp;</title>
    ...
    <body>
     ...
     <table style="border-collapse:collapse; width:98%">
         <tr>
             ...
             <?php    $document_type = '12'; 
                         ...
                         <?php } elseif ($mfT[0]['document_type_uid'] == 6) { 
                                    if($mfT[0]['copies'] <> 0) { ?>
                                        <td class="dc" style="text-align:left;">COPY DELIVERY NOTE</td>
                                    <?php } else { ?>
         ...
         <tr>
         <?php 
         $cfa = array(891274172, 891274172);
         if (in_array(trim($mfT[0]['psm_uid']), $cfa)) { ?>
            <td class="dc2" width="60%;" style="text-align:left;"><?php echo 'CFA SALES (PTY) Ltd' ; ?></td>
         <?php } else { ?>
         ...
         <tr>
           ...
           $cfa = array(891274172, 891274172);
           if (in_array(trim($mfT[0]['psm_uid']), $cfa)) { ?>
                <td class="dc3" width="50%;" style="text-align:left;" nowrap ><span style="font-weight:bold;">VAT No </span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo '4200279893'; ?></span></td>
           <?php } else { ?>
         ...
         <tr>
           ...
           <?php if (in_array($mfT[0]['status_uid'],array(DST_INVOICED, DST_DELIVERED_POD_OK,DST_DIRTY_POD))) { 
                   if (trim($mfT[0]['invoice_number']) == '' ){ ?>
                     <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Document Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo "ITE" . substr($mfT[0]['document_number'],0,8); ?></span></td>
           <?php   } else { ?>
                     <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Document Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo "ITE" . substr(trim($mfT[0]['invoice_number']),0,8); ?></span></td>
           <?php   }
         ...
         <tr>
           ...
           <td class="dc3" width="50%;" style="text-align:right;" nowrap ><span style="font-weight:bold;">Customer</span>&nbsp;&nbsp;</td>
         </tr>
         <?php if(trim($mfT[0]['delivery_instructions'])<> "" && strtoupper(substr($mfT[0]['delivery_instructions'],0,4)) <> 'NOTE') { 
             $delAdd1 = str_replace(",","<br>",$mfT[0]['delivery_instructions']);
             $delAdd = str_replace(".","<br>",$delAdd1)?>
              <tr>
                 <td class="dc3" width="50%;" rowspan="4" style="text-align:left;"><span style="font-weight:normal;"><?php echo trim($delAdd) ; ?></span></td>
         ...
         <tr>
            <td class="dc3" width="30%;" style="text-align:left;" nowrap ><span style="font-weight:bold;">Warehouse</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo $mfT[0]['depot_name']; ?></span></td>
         	  <?php
             if($mfT[0]['due_delivery_date'] <> '0000-00-00') { ?>
         	      <td class="dc3" width="30%;" style="text-align:right;" nowrap ><span style="font-weight:bold;">Expiry Date</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo $mfT[0]['due_delivery_date']; ?></span></td>
             <?php
             } elseif ($mfT[0]['delivery_date'] <> '0000-00-00') { ?>
                <td class="dc3" width="30%;" style="text-align:right;" nowrap ><span style="font-weight:bold;">Delivery Date</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo $mfT[0]['delivery_date']; ?></span></td>
             <?php } else { ?>
                <td class="dc3" width="30%;" style="text-align:right;" nowrap ><span style="font-weight:bold;">&nbsp;&nbsp;</span></td>
           	 <?php } ?> 
         </tr>
         <tr>
             <?php
                 if($mfT[0]['delivery_instructions'] <> NULL && strtoupper(substr($mfT[0]['delivery_instructions'],0,4)) == 'NOTE') { ?>
         ...
         <?php
             if($mfT[0]['areauid'] <> NULL || $mfT[0]['overrep_code'] <> NULL) {
                if($mfT[0]['overrep_code'] <> 000) {   ?>
                  <tr>
                    <td class="dc3" width="50%;" style="text-align:left;" nowrap ><span style="font-weight:bold;">Area</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo $mfT[0]['area']; ?></span></td>
                    <td class="dc3" width="50%;" style="text-align:right;" nowrap ><span style="font-weight:bold ;">Override Rep</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo $mfT[0]['overrep_name']; ?></span></td>
                  </tr>
            <?php
                }
             } 
      ...
      <!-- detail -->
       ...
       <table style= "border-collapse:collapse; width:100%; ">
         <tr>
           ...
           <th class="th1" style="width:15% ; text-align:right ;">Weight&nbsp;</th>
           <th class="th1" style="width:15% ; text-align:right ;" >Quantity&nbsp;</th>
         </tr>
       ...
       foreach($mfT as $row) {
         ...
         <tr>
           ...
           <?php if (in_array($mfT[0]['status_uid'],array(DST_UNACCEPTED,DST_ACCEPTED,DST_INPICK,14))) {  
               ...
               <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap><?php echo $row["ordered_qty"] * $row['weight'] . " KG" ?>&nbsp;</td>
           ...
           <?php } else { 
               ...
               <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap><?php echo $row["document_qty"] * $row['weight'] . " KG" ?>&nbsp;</td>
...
<!-- total line -->
         <tr>
           ...
           <td class="dc8" style="text-align:right"; nowrap ><?php echo number_format($weightTot,2) . " KG" ?>&nbsp;</td>
       ...
       <table style="width:100%;">
        ...
        <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
         ...
         <tr>
          ...
          <tr>
           <td class="dc3" style="width:100%"; "text-align:left"; nowrap >Vehicle Registration Number________________________________________</td>
         </tr>
         <tr>
           <td class="dc3" >&nbsp;</td>
         </tr>
         ...
         <tr>
          ...
          <tr>
           <td class="dc3"><img alt="<?php echo ltrim(substr($mfT[0]['document_number'],0,8),'0'); ?>" src="<?php echo $ROOT.$PHPFOLDER; ?>barcode/barcode.php?text=<?php echo ltrim(substr($mfT[0]['document_number'],0,8),'0'); ?>&print=true" ></td>
         </tr>
         <tr>
           <td class="dc3" >&nbsp;</td>
         </tr>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo 'document_invoice_version_342.php'; ?>
           </td>
         </tr>
       </table>      
...
<script type="text/javascript">
  function emailDoc1() {
      window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfSelf'.trim($document_type). substr($mfT[0]['document_number'],0,8);?>&PSMUID=<?php echo ('');?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo 'document_invoice_version_342_mail.php';?>";
  }
  function emailDoc2() {
  	  window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfCust'.trim($document_type). substr($mfT[0]['document_number'],0,8);?>&PSMUID=<?php echo($mfT[0]['psm_uid']);?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo 'document_invoice_version_342_mail.php';?>";
}  
</script> 
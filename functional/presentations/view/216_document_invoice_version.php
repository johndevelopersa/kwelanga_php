     ...
     <table style="border-collapse:collapse; width:98%">
        ...
        <tr>
         ...
         if($mfT[0]['delivery_instructions'] <> NULL) { ?>
           <tr>
              <td class="dc3" colspan="2"; style="text-align:left;" nowrap ><span style="font-weight:bold ;">Special Instructions</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo substr($mfT[0]['delivery_instructions'],0,99); ?></span></td>
           </tr>         
         <?php } ?>         
...
&nbsp;&nbsp;</td>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;"><?php echo '216_document_invoice_version'; ?>
           </td>
         </tr>
      </table>      

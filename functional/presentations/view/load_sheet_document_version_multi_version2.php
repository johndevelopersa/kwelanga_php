    ...
    <body>
       ...
       foreach($loadd as $row) {
       	   if ($newDocument <> $row['document_number']) {
               ...
               $LoadSheetDocsTO->prShortN = $row['prinShotName'];
      ...
      //          print_r($LoadSheet);
                ...
                foreach($LoadSheet['Documents'] as $to) {                	
                     if($sstore <>  $to['docno'] . $to['store']) 	{ 	
                     	   ...
                     	   if(trim($loadd[0]['PSN']) <> '') {$prinSn = trim($loadd[0]['PSN']);} else { $prinSn = trim($loadd[0]['Principal']); }
                     	?>
                         <tr>
                              <td colspan="1" style="text-align:left;">&nbsp;</td>
                              <td class="dc13" colspan="1" style="text-align:left; border-left-style:solid; border-left-width:1px; border-left-color:black; padding-left: 10px;"><?php echo $prinSn . ' - ' . substr($to['docno'],-6);?></td>
                              <td class="dc13" colspan="1" style="text-align:left; border-left-style:solid; border-left-width:1px; border-left-color:black; padding-left: 10px;">&nbsp;</td>

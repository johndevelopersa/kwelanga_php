   ...
   <title>&nbsp;</title>
    ...
    <body>
     ...
     <table style="border-collapse:collapse; width:100%">
         ...
         <tr>
           <td class="dc3" width="50%;" style="text-align:left;" nowrap><span style="font-weight:bold;">Nellwyn GRV Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo ltrim($mfT[0]['document_number'],'0'); ?></span></td>
         </tr>
          <tr>
            <td width="50%;" >&nbsp;</td>
         </tr>
         <tr>
           <td class="dc3" width="50%;" style="text-align:left ;" nowrap><span style="font-weight:bold ;">Supplier Delivery Note</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo $mfT[0]["customer_order_number"] ?></span></td>
...
<!-- total line -->
       ...
       <table style="width:88%;" >
        ...
        <table style="width:100%;"> 
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo 'document_stock_movement_version1'; ?>
           </td>
         </tr>
       </table>             

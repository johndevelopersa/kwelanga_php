      ...
      <!-- detail -->
       ...
       <table style= "border-collapse:collapse; width:100%; ">
         <tr>
           ...
           <th class="th1" style="width: 10%;" nowrap >Excl. Total</th>
           <th class="th1" style="width: 8% ;" nowrap >Rate</th>
           <th class="th1" style="width: 10% ;" nowrap >Vat</th>
       ...
       foreach($mfT as $row) {
         ...
         <tr>
           ...
           <?php $totCP+= $row["net_price"];
                 ...
                 <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap><?php echo trim(number_format($row["vat_rate"],2, "."," "))?>&nbsp;</td>
       ...
       <table style="width:100%;">
        ...
        <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
         ...
         <?php } else { ?>
          ...
          <?php  if (trim($mfT[0]['q_r_code_to_print']) <> NULL && (trim($mfT[0]['q_r_code_to_print'])) <> "NULL" )  { ?>
           <img src="<?php echo HOST_SURESERVER_AS_NEWUSER.$PHPFOLDER; ?>images/<?php echo (trim($mfT[0]['q_r_code_to_print']));?>.png" style="width:100px; height:100px; float:left;" >
           <?php } ?>
           </td>        
         </tr>	
         <tr>
...
<script type="text/javascript">
  function emailDoc1() {
      window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfSelf'.trim($document_type). substr($mfT[0]['document_number'],2,6);?>&PSMUID=<?php echo ('');?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo 'document_invoice_versionDTV.php';?>";
  }
  function emailDoc2() {
  	  window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfCust'.trim($document_type). substr($mfT[0]['document_number'],2,6);?>&PSMUID=<?php echo($mfT[0]['psm_uid']);?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo 'document_invoice_versionDTV.php';?>";
}  
</script> 
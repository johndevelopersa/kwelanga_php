...
<!-- total line -->
         <tr>
           ...
           <?php
           if($row['allow_decimal'] == 'Y') { ?>
               <td class="dc8" style="text-align:right"; nowrap ><?php echo $totQ / 100; ?>&nbsp;</td>
           <?php
           } else { ?>
...
<!--       <td class="dc6" >&nbsp;&nbsp;</td>  -->         
           ...
           if($row['allow_decimal'] == 'Y') { ?>
                ...
                <td class="dc8" style="text-align:right"; nowrap ><?php echo number_format($totVAT/100,2,'.',' '); ?>&nbsp;</td>
                <td class="dc8" style="text-align:right"; nowrap ><?php echo number_format($totTot/100,2,'.',' '); ?>&nbsp;</td>           	
           <?php
           } else { ?>
                <td class="dc8" style="text-align:right"; nowrap ><?php echo number_format($totNett,2,'.',' '); ?>&nbsp;</td>
                <td class="dc8" style="text-align:right"; nowrap >&nbsp;</td>

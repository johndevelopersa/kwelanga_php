   ...
   <title>&nbsp;</title>
    ...
    <body>
     ...
     <table style="border-collapse:collapse; width:98%">
         ...
         <tr>
             <?php 
            if($mfT[0]['principal_store_uid'] == '891298727') { ?>
                 <td class="dc2" width="60%;" style="text-align:left;">LP Gas Online.co.za</td>	
                 <?php
                 $filename = "images/logos/{$principalId}lp.png";
      ...
      <!-- detail -->
       ...
       <table style= "border-collapse:collapse; width:100%; ">
         <tr>
           ...
           <th class="th1" style="width:30% ;" nowrap >Description</th>
           <th class="th1" style="width:10% ;" nowrap >Quantity</th>
           <th class="th1" style="width:10% ;" nowrap >Price</th>
           <th class="th1" style="width:13% ;" nowrap >Exclusive Total</th>
           <th class="th1" style="width: 9% ;" nowrap >Vat</th>
           <th class="th1" style="width:13% ;" nowrap >Inclusive Total</th>
         </tr>
         <?php $totQ=0; $totLP=0; $totDV=0; $totCP=0; $totNett=0; $totVAT=0; $totTot = 0; $weightTot=0;
         $cls = "dc5";
       foreach($mfT as $row) {
         $nettCP=0;
         $deciQtyArray = array('GAS');
         ?>
         <tr>
           ...
           <?php } else {
           	   if(in_array($row["product_code"], $deciQtyArray)) {
                  $docQty = $row["document_qty"] / 100;
                  $totQ+= $docQty; ?>
                  <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap><?php echo $docQty ?>&nbsp;</td>
                  <?php
           	   } else {
                  $docQty = $row["document_qty"];
           ...
           <?php $totCP+= $row["net_price"];
                 if (in_array($mfT[0]['status_uid'],array(DST_UNACCEPTED,DST_ACCEPTED,DST_INPICK,14))) {            
                   ...
                   $vatAmt = $row['ordered_qty']*$row["net_price"]*$row["vat_rate"]/100 ;
                 } else {
                    $nettcp=$docQty*$row["net_price"];
                    $weightTot+=($docQty*$row['weight']); 
                    
                    $vatAmt = $docQty*$row["net_price"]*$row["vat_rate"]/100;
                    $inTot = $nettcp + $vatAmt;
                 ...
                 <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap><?php echo number_format($vatAmt,2, "."," ")?>&nbsp;</td>
                 <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap><?php echo number_format($inTot,2, "."," ")?>&nbsp;</td>
           <?php $totVAT+= $vatAmt;
                 $totTot+= $inTot ;
                 $totNett+=$nettcp;
                 $cls = "dc4";
...
<!-- total line -->
         <tr>
           ...
           <td class="dc4" style="text-align:right"; nowrap ><?php echo $totQ; ?>&nbsp;</td>
       ...
       <table style="width:100%;">           
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;"><?php echo 'document_invoice_versionLP'; ?>
           </td>
         </tr>
      </table>      
...
<script type="text/javascript">
  function emailDoc1() {
      window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfSelf'.trim($document_type). substr($mfT[0]['document_number'],2,6);?>&PSMUID=<?php echo ('');?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo 'document_invoice_versionLP.php';?>";
  }
  function emailDoc2() {
  	  window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfCust'.trim($document_type). substr($mfT[0]['document_number'],2,6);?>&PSMUID=<?php echo($mfT[0]['psm_uid']);?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo 'document_invoice_versionLP.php';?>";
 }  
</script> 
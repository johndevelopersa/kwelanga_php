     ...
     <table style="border-collapse:collapse; width:98%">
      ...
      <!-- detail -->
       ...
       <table style= "border-collapse:collapse; width:100%; ">
         <tr>
           <th class="th1" style="width:25% ;" nowrap >Code</th>
           <th class="th1" style="width:50% ;" nowrap >Description</th>
           <th class="th1" style="width:25% ;" nowrap >Quantity</th>
         </tr>
...
<!-- total line -->
       ...
       <table style="width:100%;">
        ...
        <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
         ...
         echo "KK";
          echo $ROOT.$PHPFOLDER . "barcode/barcode.php?text=" . ltrim(substr($mfT[0]['document_number'],0,8),'0'), . "&filepath=" . $ROOT . "archives/image/, &print=false" ;

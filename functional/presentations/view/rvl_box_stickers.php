<?php
// https://kwelangaonlinesolutions.co.za/systems/kwelanga_system/kwelanga_php/functional/presentations/view/rvl_box_stickers.php?BOXNO=10000
             ...
             <td style="width: 46%:">
                <table style="border:1px none black; border-collapse:collapse; width: 96%">  <! –– Top Left ––>
                   ...
                   <tr>
                       ...
                       <td rowspan ='5' style="width: 38%;"><img src="<?php echo $ROOT.$PHPFOLDER ; ?>images/logos/iRam.jpg" style="width:120px; height:120px; float:right;"></td>
                       <td style="width: 6%;" >&nbsp;</td>
                   </tr>
                   <tr>
                       <td style="">&nbsp;</td>

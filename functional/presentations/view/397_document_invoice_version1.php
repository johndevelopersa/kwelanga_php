    ...
    <body>
     ...
     <table style="border-collapse:collapse; width:98%">
         ...
         <tr>
           ...
           <?php
              if(in_array($mfT[0]['psm_uid'], $sparArray)) { ?>
              <td class="dc3" width="50%;" style="text-align:right;" nowrap ><span style="font-weight:bold ;">Spar Vendor</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo '0261820'; ?></span></td>
           <?php } else { ?>
      ...
      <!-- detail -->
       ...
       <table style= "border-collapse:collapse; width:100%; "> 
           ...
           if(in_array($mfT[0]['psm_uid'], $sparArray)) { ?>
               <tr>
                  ...
                  <th class="th1" style="width: 7% ;" nowrap >Shrinks</th>
                  <th class="th1" style="width: 9% ;" nowrap >Cases</th>
           ...
           <?php 
               ...
               <tr>
                  <th class="th1" style="width:10% ;" nowrap >Code</th>
                  <th class="th1" style="width:30% ;" nowrap >Description</th>
                  <th class="th1" style="width:10% ;" nowrap >Shrinks</th>
                  <th class="th1" style="width:10% ;" nowrap >Exclusive Total</th>
                  <th class="th1" style="width:9 % ;" nowrap >Vat Rate</th>
                  <th class="th1" style="width:9 % ;" nowrap >Vat</th>
                  <th class="th1" style="width:13% ;" nowrap >Inclusive Total</th>
               </tr>
       ...
       foreach($mfT as $row) {
         $nettCP=0;
         if(in_array($row["psm_uid"], $sparArray)) {$apc = trim($row["alt_code"]) ;} else {$apc = '' ;}
         ?>
         <tr>
           <td class="<?php echo $cls; ?>" nowrap><?php echo $row["product_code"]?>&nbsp;</td>
           <td class="<?php echo $cls; ?>" style= text-align:left; nowrap><?php echo trim($row["product_description"]) . '  ' . $apc ?>&nbsp;</td>
           ...
           if(in_array($row["psm_uid"], $sparArray)) {
                 if (in_array($mfT[0]['status_uid'],array(DST_UNACCEPTED,DST_ACCEPTED,DST_INPICK,14))) {  
                         $caseTotQ+= $row["ordered_qty"] / $row["items_per_case"] ?>
                         <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap><?php echo $row["ordered_qty"] / $row["items_per_case"]?>&nbsp;</td>
                 <?php } else { 
//                         $totQ+= $row["document_qty"]?>
                         <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap><?php echo $row["document_qty"] / $row["items_per_case"]?>&nbsp;</td>
                 <?php }
           } 
           $totCP+= $row["net_price"];
...
<!-- total line -->
         <tr>
           ...
           <?php
           if(in_array($row["psm_uid"], $sparArray)) { ?>
                 <td class="dc8" style="text-align:right"; nowrap ><?php echo  $caseTotQ; ?></td>
           <?php 
           } ?>     
       ...
       <table style="width:100%;">
        ...
        <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo 'document_invoice_version1'; ?>
           </td>
         </tr>
       </table>      

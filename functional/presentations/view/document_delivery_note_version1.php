...
<!-- total line -->
       ...
       <?php if ($mfT[0]['status_uid'] >= 76 and $weightTot>0) { ?>
           <table style="border-collapse:collapse; width:100%;">
             <tr>
              ...
              <tr>
                 <td width="3%;">&nbsp;</td>
                 <td class="dc3" style="width:94%"; "text-align:left"; nowrap >Calculated Weight&nbsp;&nbsp;<?php echo number_format($weightTot,0,',',' ')?></td>
                 <td width="3%;">&nbsp;</td>
              </tr>
              <tr>
                 <td colspan="3">&nbsp;</td>
      ...
      <?php  if (trim($mfT[0]['banking_details']) <> NULL && !in_array($mfT[0]['document_type_uid'],array('4','2')))  { ?>
       ...
       <table style="border-collapse:collapse; width:100%;"> 
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo 'document_delivery_note_version1.php'; ?>
           </td>
         </tr>
       </table> 
    </body>

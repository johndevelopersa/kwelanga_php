     ...
     <table style="border-collapse:collapse; width:98%">
      ...
      <!-- detail -->
       ...
       <table style= "border-collapse:collapse; width:100%; ">
         <tr>
           <th class="th1" style="width:12% ;" nowrap >Code</th>
           <th class="th1" style="width:19% ;" nowrap >Description</th>
           <th class="th1" style="width: 7% ;" nowrap >No of</th>
           <th class="th1" style="width: 7% ;" nowrap >No of</th>
           <th class="th1" style="width:10% ;" nowrap >Unit</th>
           <th class="th1" style="width:10% ;" nowrap >Shipper</th>
           <th class="th1" style="width:10% ;" nowrap >Exclusive</th>
           <th class="th1" style="width:10% ;" nowrap >Vat</th>
           <th class="th1" style="width:100% ;" nowrap >Inclusive</th>
         </tr>
         <tr>
           <th class="th2" style="width:12% ;" nowrap >&nbsp;</th>
           <th class="th2" style="width:19% ;" nowrap >&nbsp;</th>
           <th class="th2" style="width: 7% ;" nowrap >Units</th>
           <th class="th2" style="width: 7% ;" nowrap >Shippers</th>
           <th class="th2" style="width:10% ;" nowrap >Price</th>
           <th class="th2" style="width:10% ;" nowrap >Price</th>
           <th class="th2" style="width:10% ;" nowrap >Total</th>
           <th class="th2" style="width:10% ;" nowrap >&nbsp;</th>
           <th class="th2" style="width:100% ;" nowrap >Total</th>
         </tr>

         <?php $totQ=0; $totU=0; $totLP=0; $totDV=0; $totCP=0; $totNett=0; $totNettU=0; $totVAT=0; $totTot = 0; $weightTot=0;
         $cls = "dc5";
       foreach($mfT as $row) {
         $nettCP=0;
         ?>
         <tr>
           ...
           <?php } else { 
               ...
               $totU+= $row["document_qty"] * $row["items_per_case"] ;?>
           ...
           <?php } else { ?> 	
                 ...
                 <td class="<?php echo $cls; ?>" style="text-align:right"; nowrap><?php echo number_format($row["net_price"] / $row["items_per_case"],2, "."," ")?>&nbsp;</td>
...
<!-- total line -->
         <tr>
           ...
           <td class="dc8" style="text-align:right"; nowrap ><?php echo $totU; ?>&nbsp;</td>
           <td class="dc6" >&nbsp;</td> 
        ...
        <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <img src="<?php echo HOST_SURESERVER_AS_NEWUSER.$PHPFOLDER; ?>images/kwelanga1.gif" style="width:75px; height:30px; float:right;" >
           </td>
         </tr>
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">

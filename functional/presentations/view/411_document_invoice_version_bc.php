    ...
    <body>
     ...
     <table style="border-collapse:collapse; width:98%">
       ...
       <?php } ?>
         ...
         <tr>
           <td class="dc3" width="50%;" style="text-align:left;" nowrap><span style="font-weight:bold;">D/N</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo ltrim($mfT[0]['document_number'],"0"); ?></span></td>

           <?php if (in_array($mfT[0]['status_uid'],array(DST_INVOICED, DST_DELIVERED_POD_OK,DST_DIRTY_POD))) { 
                   if (trim($mfT[0]['invoice_number']) == '' ){ ?>
                     <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Invoice Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo ltrim($mfT[0]['document_number'],"0"); ?></span></td>
           <?php   } else { ?>
                     <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Invoice Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo ltrim(trim($mfT[0]['invoice_number']),"0"); ?></span></td>
           <?php   }
                 } elseif (in_array($mfT[0]['status_uid'],array(DST_PROCESSED))) { 
                   if (trim($mfT[0]['alternate_document_number']) <> '' ){ ?>
                     <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Credit Note Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo ltrim($mfT[0]['alternate_document_number'],"0"); ?></span></td>
           <?php   } else { ?>
                     <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Document Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo ltrim($mfT[0]['document_number'],"0"); ?></span></td>
           <?php   }
                }elseif (in_array($mfT[0]['status_uid'],array(DST_UNACCEPTED,DST_ACCEPTED,14))) { ?>
                     <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Document Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo ltrim($mfT[0]['document_number'],"0"); ?></span></td>
           <?php   }
         ...
         <tr>
         	  <?php
             if($mfT[0]['requested_delivery_date'] <> '0000-00-00') { ?>
         	      <td class="dc3" width="30%;" style="text-align:left;" nowrap ><span style="font-weight:bold;">Requested Delivery Date</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo $mfT[0]['requested_delivery_date']; ?></span></td>
             <?php
...
<!--       <td class="dc6" >&nbsp;&nbsp;</td>  -->         
       ...
       <table style="width:100%;">
        ...
        <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
         ...
         <?php } if (trim($mfT[0]['alt_banking_details']) <> NULL && !in_array($mfT[0]['document_type_uid'],array('4','2')) && ($mfT[0]['bank_details_to_print'] == 1) )  { ?>
           <td class="dc3" style="width:50%"; "text-align:righy"; nowrap >Banking Details&nbsp;&nbsp;<?php echo (str_replace(chr(43),"<br>", $mfT[0]["alt_banking_details"]))?></td>
         <?php } ?>
         </tr>	
         <tr>
           <td class="dc3" >&nbsp;</td>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo '408_document_invoice_version_bc'; ?>
           </td>
         </tr>
       </table>      
...
<script type="text/javascript">
  function emailDoc1() {
      window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfSelf'.trim($document_type). substr($mfT[0]['document_number'],0,8);?>&PSMUID=<?php echo ('');?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo '408_document_invoice_version_bc';?>";
  }
  function emailDoc2() {
  	  window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfCust'.trim($document_type). substr($mfT[0]['document_number'],0,8);?>&PSMUID=<?php echo($mfT[0]['psm_uid']);?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo '408_document_invoice_version_bc';?>";
}  
</script> 
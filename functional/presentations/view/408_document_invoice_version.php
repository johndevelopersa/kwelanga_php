     ...
     <table style="border-collapse:collapse; width:98%">
         <tr>
             ...
             <?php    $document_type = '12'; 
                   } elseif (in_array($mfT[0]['status_uid'],array(DST_INVOICED, DST_DELIVERED_POD_OK,DST_DIRTY_POD,DST_PROCESSED))) { 
                         ...
                         <?php } elseif ($mfT[0]['document_type_uid'] == 31) { ?>
                                    <td class="dc" style="text-align:left;">TAX CREDIT NOTE</td>
                         <?php } elseif ($mfT[0]['document_type_uid'] == 32) { ?>
                                    <td class="dc" style="text-align:left;">TAX CREDIT NOTE</td>
         ...
         <tr>
            <td class="dc3" width="50%;" style="text-align:left;"><?php echo $mfT[0]['status']; ?></td>
               <?php 
                ...
                ?>
                  <td rowspan="2" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
                      <?php echo "<img src=".$logo." style=width:200px; height:100px; float:right; >" ?>
                  </td>
           <?php } ?>
         </tr>
         <tr>
           <td class="dc2" width="50%;" style="text-align:left;"><?php echo $mfT[0]["principal_name"]; ?></td>
           <td width="50%;" >&nbsp;</td>
         </tr>
         <tr>
         ...
         <tr>
           ...
           <?php   } else { ?>
                     <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Invoice Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo substr(trim($mfT[0]['invoice_number']),0,15); ?></span></td>
           <?php   }
         ...
         <?php
             if($mfT[0]['document_type_uid'] == 25) { ?>
                <tr>
                  <td class="dc3" width="50%;" style="text-align:left;" nowrap ><span style="font-weight:bold;">Claim Type</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo $mfT[0]['additional_type']; ?></span></td>
                  <td class="dc3" width="50%;" style="text-align:right;" nowrap ><span style="font-weight:bold ;">Claim Number</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo $mfT[0]['client_document_number']; ?></span></td>
               </tr>
           <?php } ?>   
      <!-- detail -->
...
<!-- total line -->
         <tr>
           ...
           <td class="dc6" >&nbsp;&nbsp;</td>           
           <td class="dc6" >&nbsp;&nbsp;</td>  
           <td class="dc6" style="border-bottom-style:none; text-align:right;" nowrap >ZAR</td>
...
<?php    
    // Start If Customer off invoice discount exists 
         ...
         if($mfT[0]['Current_discount'] > 0 && $mfT[0]['Stored_discount'] == '0.00' ) {
       ...
       <table style="width:100%;">
        ...
        <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
           ...
           <tr>
              <td class="dc3a" style="width:80%"; "text-align:left"; nowrap ><?php echo (str_replace(chr(43),"<br>", $mfT[0]['btcs'])); ?></td>
           </tr>
           <?php } else { ?>
           <tr>
              <td class="dc3" >&nbsp;</td>
        ...
        <tr>
              <td class="dc3" style="width:80%"; "text-align:left"; nowrap >RECEIVED BY : __________________________________________________________</td>
         </tr>
        <tr>
              <td class="dc3" style="width:80%"; "text-align:left"; nowrap >NAME :         _________________________________________________________________</td>
         </tr>  
        <tr>
              <td class="dc3" style="width:80%"; "text-align:left"; nowrap >DATE :       _______________________________  TIME : ____________________________</td>
         </tr>                                                                                                                                            
        <tr>
              <td class="dc3" style="width:80%"; "text-align:left"; nowrap >GRV NO :   _______________________________________________________________</td>
         </tr> 
         <tr>
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <img src="<?php echo $ROOT.$PHPFOLDER; ?>images/logos/309.jpg" style="width:50px; height:30px; float:right;" >
           </td>
         </tr>
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo '408_document_invoice_version'; ?>
           </td>
         </tr>
       </table>      
...
<script type="text/javascript">
  function emailDoc1() {
      window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfSelf'.trim($document_type). substr($mfT[0]['document_number'],0,8);?>&PSMUID=<?php echo ('');?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo '408_document_invoice_version';?>";
  }
  function emailDoc2() {
  	  window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfCust'.trim($document_type). substr($mfT[0]['document_number'],0,8);?>&PSMUID=<?php echo($mfT[0]['psm_uid']);?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo '408_document_invoice_version.php';?>";
}  
</script> 
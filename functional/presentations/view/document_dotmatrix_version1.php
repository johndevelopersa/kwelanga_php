...
<div class="paging" data-page="1">
    ...
    <table style="border-collapse:collapse;width:230px;margin-left:472px;height:36px;overflow:hidden;margin-top: 140px;page-break-before: always">
        <tr>
            ...
            <?php if (in_array($mfT[0]['status_uid'], [DST_IN_PROGRESS])) { ?>
            ...
            } else if (in_array($mfT[0]['status_uid'], [DST_UNACCEPTED, DST_ACCEPTED, 14])) {
                if ($mfT[0]['document_type_uid'] == 2) { ?>
                    <td class="dc" style="text-align:left;">UPLIFT ADVICE</td>
                <?php } else if ($mfT[0]['document_type_uid'] == 6) { ?>
                    <td class="dc" style="text-align:left;">DELIVERY NOTE</td>
                ...
                <?php } else if ($mfT[0]['document_type_uid'] == 13) { ?>
                    <td class="dc" style="text-align:left;">ZERO PRICE INVOICE</td>
                <?php } else if ($mfT[0]['document_type_uid'] == 31) { ?>
                    <td class="dc" style="text-align:left;">MANUAL CREDIT NOTE</td>
                <?php } else if ($mfT[0]['document_type_uid'] == 25) { ?>
                    <td class="dc" style="text-align:left;">CUSTOMER CLAIM</td>
                <?php } else { ?>
            ...
            <?php if (in_array($mfT[0]['status_uid'], [DST_INVOICED, DST_DELIVERED_POD_OK, DST_DIRTY_POD])) {
                ...
                <?php } else { ?>
                    <td class="dc3" style="text-align:right;" nowrap><span style="font-weight:bold;" class="no-print">Invoice Number</span>&nbsp;&nbsp;<span
                                style="font-weight:normal ;"><?php echo substr(trim($mfT[0]['invoice_number']), 0, 8); ?></span>
                    </td>
                <?php }
            } else if (in_array($mfT[0]['status_uid'], [DST_PROCESSED])) {
                if (trim($mfT[0]['alternate_document_number']) <> '') { ?>
                    <td class="dc3" style="text-align:right;" nowrap><span style="font-weight:bold;" class="no-print">Credit Note Number</span>&nbsp;&nbsp;<span
                                style="font-weight:normal ;"><?php echo substr($mfT[0]['alternate_document_number'], 0, 8); ?></span>
                    </td>
                <?php } else { ?>
                    <td class="dc3" style="text-align:right;" nowrap><span style="font-weight:bold;" class="no-print">Document Number</span>&nbsp;&nbsp;<span
                                style="font-weight:normal ;"><?php echo substr($mfT[0]['document_number'], 0, 8); ?></span>
                    </td>
                <?php }
            } else if (in_array($mfT[0]['status_uid'], [DST_UNACCEPTED, DST_ACCEPTED, 14])) { ?>
            ...
            <?php } else if (in_array($mfT[0]['status_uid'], [DST_IN_PROGRESS])) { ?>
                <td class="dc3" style="text-align:right;" nowrap>
                    <span style="font-weight:bold;" class="no-print">Quote Number</span>&nbsp;&nbsp;<span
                            style="font-weight:normal ;"><?php echo substr($mfT[0]['document_number'], 3, 6); ?></span>
                </td>
            <?php } ?>
    ...
    <table style="border-collapse:collapse;;width:450px;margin-left:175px;margin-top:29px;">
        <tr>
            <td width="75%"><?php echo $mfT[0]['SFAccount']; ?></td>
    ...
    <table style="border-collapse:collapse;width:730px;margin-left:2px;height:36px;margin-top:40px;">
        <tr>
            <td style="width: 92px;"><span style="font-weight:bold ;" class="no-print">Customer Reference </span><?php echo $mfT[0]["customer_order_number"] ?></td>
            <td style="width: 256px;">GDS</td>
            <td style="width: 32px;font-size:6pt !important;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;30<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DAYS</td>
            <td style="width: 50px;font-size:6pt !important;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;%</td>
            <td style="width: 95px;"><span style="font-weight:bold ;" class="no-print">Customer VAT No. </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $mfT[0]['vat_number']; ?></td>
            <td style="width: 110px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Z04</td>
            <td style="width: 50px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1400</td>
            <td style="width: 100px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $mfT[0]['document_number']; ?></td>
            <td style="width: 75px;text-align: center" class="page-no">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!-- page no. /-->1</td>
        </tr>
    </table>

    <!-- order details /-->
    <div class="page-details" style="height:430px;overflow:hidden;margin-left:10px;">
        <table style="border-collapse:collapse;margin-top:55px;width:auto;">
            <thead class="no-print">
            <tr>
                <th class="th1" nowrap>Code</th>
                <th class="th1" nowrap>Description</th>
                <th class="th1" nowrap>Ord.<br>Qty</th>
                <th class="th1" nowrap>Inv.<br>Qty</th>
                <th class="th1" nowrap>Fol.<br>Qty</th>
                <th class="th1" nowrap>Unit</th>
                <th class="th1" nowrap>Unit<br>Price</th>
                <th class="th1" nowrap>Disc.</th>
                <th class="th1" nowrap>Excl.<br>Value</th>
                <th class="th1" nowrap>Vat</th>
                <th class="th1" nowrap>Incl.<br>Value</th>
            </tr>
            </thead>
            ...
            foreach ($mfT as $lineNo => $row) :
                ...
                if (in_array($mfT[0]['status_uid'], [DST_UNACCEPTED, DST_ACCEPTED, DST_INPICK, 14])) {
                ...
                $totCP += $row["net_price"];
                if (in_array($mfT[0]['status_uid'], [DST_UNACCEPTED, DST_INPICK, DST_ACCEPTED, 14])) {
                ...
                <tr>
                    ...
                    <td style="width: 47px;text-align: right;vertical-align: top"><?php echo number_format($row["net_price"], 2, ".", " ") ?>&nbsp;</td>
...
<div class="page-footer">
    ...
    <!-- total excl & vat row /-->
    <table style="border-collapse:collapse;;width:120px;margin-left:525px;height:28px;margin-top:85px;">
        <tr>
    ...
    <!-- total invoice row /-->
    <table style="border-collapse:collapse;;width:90px;margin-left:655px;height:28px;margin-top:14px;">
        <tr>
    ...
    <!-- total mass row /-->
    <table style="border-collapse:collapse;width:90px;margin-left:642px;height:28px;margin-top:20px;">
        <tr>
...
<!--table class="no-print"
       style="border-collapse:xcollapse; width:auto;border:1px solid red;width:620px;;margin-left:20px;margin-top:20px;">

    <tr>
        <td class="dc3" width="50%;" style="text-align:left ;" nowrap>&nbsp;&nbsp;<span
                    style="font-weight:normal ;"><?php echo $mfT[0]["customer_order_number"] ?></span></td>
        <?php if (in_array(trim($mfT[0]['document_type_uid']), ['4']) && (trim($mfT[0]['alternate_document_number']) <> '')) { ?>
            <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Source Document Number</span>&nbsp;&nbsp;<span
                        style="font-weight:normal ;"><?php echo substr($mfT[0]['source_document_number'], 0, 8); ?></span>
            </td>
        <?php } else if (trim($mfT[0]['invoice_number']) <> '') { ?>
            <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Sales Order Number</span>&nbsp;&nbsp;<span
                        style="font-weight:normal ;"><?php echo substr($mfT[0]['document_number'], 0, 8); ?></span></td>
        <?php } else { ?>
            <td width="50%;">&nbsp;</td>
            <td width="50%;">&nbsp;</td>
        <?php } ?>
    ...
    <tr>
        <?php if (trim($mfT[0]['crdreason']) <> null) { ?>
            <td class="dc3" width="50%;" style="text-align:left ;" nowrap><span
                        style="font-weight:bold ;">Credit Reason </span>&nbsp;&nbsp;<span style="font-weight:normal;"
                                                                                          nowrap><?php echo $mfT[0]['crdreason'] ?></span>
            </td>
        <?php } else { ?>
            <td width="50%;">&nbsp;</td>
            <td width="50%;">&nbsp;</td>
    ...
    <tr>
        ...
        if ($mfT[0]['due_delivery_date'] <> '0000-00-00') { ?>
            <td class="dc3" width="30%;" style="text-align:left;" nowrap><span
                        style="font-weight:bold;">Expiry Date</span>&nbsp;&nbsp;<span
                        style="font-weight:normal;"><?php echo $mfT[0]['due_delivery_date']; ?></span></td>
            <?php
        } else if ($mfT[0]['delivery_date'] <> '0000-00-00') { ?>
            <td class="dc3" width="30%;" style="text-align:left;" nowrap><span
                        style="font-weight:bold;">Delivery Date</span>&nbsp;&nbsp;<span
                        style="font-weight:normal;"><?php echo $mfT[0]['delivery_date']; ?></span></td>
        <?php } else { ?>
            <td class="dc3" width="30%;" style="text-align:left;" nowrap><span style="font-weight:bold;">&nbsp;</span>
            </td>
        <?php } ?>
    ...
    if ($mfT[0]['areauid'] <> null || $mfT[0]['overrep_code'] <> null) {
        if ($mfT[0]['overrep_code'] <> 000) { ?>
            <tr>
                <td class="dc3" width="50%;" style="text-align:left;" nowrap><span style="font-weight:bold;">Area</span>&nbsp;&nbsp;<span
                            style="font-weight:normal;"><?php echo $mfT[0]['area']; ?></span></td>
                <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold ;">Override Rep</span>&nbsp;&nbsp;<span
                            style="font-weight:normal;"><?php echo $mfT[0]['overrep_name']; ?></span></td>
            </tr>
            <?php
        }
    }
    ?>
    <?php
    if ($mfT[0]['document_type_uid'] == 25) { ?>
        <tr>
            <td class="dc3" width="50%;" style="text-align:left;" nowrap><span
                        style="font-weight:bold;">Claim Type</span>&nbsp;&nbsp;<span
                        style="font-weight:normal;"><?php echo $mfT[0]['additional_type']; ?></span></td>
            <td class="dc3" width="50%;" style="text-align:right;" nowrap><span
                        style="font-weight:bold ;">Claim Number</span>&nbsp;&nbsp;<span
                        style="font-weight:normal;"><?php echo $mfT[0]['client_document_number']; ?></span></td>
        </tr>
    <?php } ?>
...
<table style="width:100%;" class="no-print">
    ...
    <?php if (trim($mfT[0]['tcs']) <> null) { ?>
        <tr>
            <td class="dc3" style="width:80%" ;
            "text-align:left"; nowrap ><?php echo(str_replace(chr(10), "<br>", $mfT[0]['tcs'])); ?></td>
        </tr>
        <tr>
            <td class="dc3a" style="width:80%" ;
            "text-align:left"; nowrap ><?php echo(str_replace(chr(10), "<br>", $mfT[0]['btcs'])); ?></td>
        </tr>
    <?php } else { ?>
        <tr>
            <td class="dc3">&nbsp;</td>
    ...
    <tr>
        <?php if (trim($mfT[0]['banking_details']) <> null && !in_array($mfT[0]['document_type_uid'], ['4', '2']) && ($mfT[0]['bank_details_to_print'] == 1)) { ?>
            <td class="dc3" style="width:50%"
                ; "text-align:left"; nowrap >Banking Details&nbsp;&nbsp;<?php echo(str_replace(chr(43), "<br>", $mfT[0]["banking_details"])) ?></td>
        <?php } else if (trim($mfT[0]['alt_banking_details']) <> null && !in_array($mfT[0]['document_type_uid'], ['4', '2']) && ($mfT[0]['bank_details_to_print'] <> 1)) { ?>
            <td class="dc3" style="width:50%"
                ; "text-align:left"; nowrap >Banking Details&nbsp;&nbsp;<?php echo(str_replace(chr(43), "<br>", $mfT[0]["alt_banking_details"])) ?></td>
        <?php } else { ?>
            <td class="dc3">&nbsp;</td>
        <?php } ?>
    </tr>
    ...
    <tr>
        <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
            <img src="<?php echo $ROOT . $PHPFOLDER; ?>images/kwelanga1.gif"
                 style="width:75px; height:30px; float:right;">
        </td>
    </tr>
    <tr>
        <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">

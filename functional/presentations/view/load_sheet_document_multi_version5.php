    ...
    <body>
       ...
       foreach($loadd as $row) {
       	   if ($newDocument <> $row['document_number']) {
               ...
               $LoadSheetDocsTO->PrinId   = $row['principal_uid'];
       ...
       <table style="border-collapse:collapse; width:100%">
                ...
                foreach($LoadSheet['Documents'] as $to) {                	
                     if($sstore <>  $to['docno'] . $to['store']) 	{ 	
                         ...
                         <tr>
                              <td colspan="1" style="text-align:left;">&nbsp;</td>
                              <td class="dc13" colspan="1" style="text-align:left; border-left-style:solid; border-left-width:1px; border-left-color:black; padding-left: 10px;"><span><?php echo $prinSn . ' - ' . ltrim($to['docno'],"0");?></span>
                              	<span><img alt="<?php echo ltrim($to['PrinId'],'0')  . ' - ' .  ltrim($to['docno'],"0"); ?>" src="<?php echo $ROOT.$PHPFOLDER; ?>barcode/barcode.php?text=<?php echo ltrim($to['PrinId'],'0') . ' - ' . ltrim($to['docno'],"0"); ?>&print=true" /></span>                              	
                              	</td>
                              <td class="dc13" colspan="1" style="text-align:left; border-left-style:none; border-left-width:1px; border-left-color:black; padding-left: 10px;">&nbsp;</td>
              ...
              <tr>
                   <td colspan="9" >&nbsp;</td>
                   <td colspan="1"; style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;"><?php echo 'load_sheet_document_multi_version5'; ?></td>
                   <td colspan="1" >&nbsp;</td>
              </tr>
        </table> 

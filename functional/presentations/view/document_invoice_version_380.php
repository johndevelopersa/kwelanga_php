   ...
   <title>&nbsp;</title>
    ...
    <body>
     ...
     <table style="border-collapse:collapse; width:98%">
         ...
         <tr>
            <td class="dc3" style="text-align:left;">&nbsp;</td>
         </tr>
         <tr>
         ...
         <tr>
           ...
           <?php if (trim($mfT[0]['p_email']) <> NULL) { ?>
             <td class="dc3" width="50%;" style="text-align:right;" nowrap ><span style="font-weight:bold;">Email Address 1 </span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo (substr($mfT[0]["p_email"],0, strpos($mfT[0]["p_email"], chr(43)))); ?></span></td>
             <?php } ?>
         </tr>
         <tr>
           <td class="dc3" width="50%;" style="text-align:left;"><?php echo $mfT[0]['prin_add2'] ?></td>
           <td class="dc3" width="50%;" style="text-align:right;" nowrap ><span style="font-weight:bold;">Email Address 2</span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo trim(substr($mfT[0]["p_email"], strpos($mfT[0]["p_email"], chr(43))+1,30)); ?></span></td>
         </tr>
         <tr>
       ...
       <table style="width:100%;">
        ...
        <tr>
           <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
              <td class="dc2" style="text-align:left;" nowrap >&nbsp;</td>
           <?php } else { ?>
              <td class="dc3" >&nbsp;</td>
           <?php } ?>
        </tr>
        <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
           ...
           <tr>
              <td class="dc3a" style="width:80%"; "text-align:left"; nowrap ><?php echo (str_replace(chr(10),"<br>", $mfT[0]['btcs']) . "    :     " . $mfT[0]['SFAccount']); ?></td>
           </tr>
           <?php } else { ?>
           <tr>
              <td class="dc3" >&nbsp;</td>
         ...
         <?php if ($mfT[0]['status_uid'] >= 76 and $weightTot>0) { ?>
           ...
           <?php } ?>
         <tr>
         <?php  if (trim($mfT[0]['banking_details']) <> NULL && !in_array($mfT[0]['document_type_uid'],array('6','4','2')) && ($mfT[0]['bank_details_to_print'] == 1) )  { ?>
         ...
         <?php } else { ?>
          ...
          <tr>
          <?php if(!in_array($mfT[0]['document_type_uid'],array('6','4','2'))) { ?>
              <td class="dc3" style="width:100%"; "text-align:left"; nowrap >Received in good order&nbsp;&nbsp;</td>          	
          <?php }	else {?>
              <td class="dc3" style="width:100%"; "text-align:left"; nowrap >&nbsp;&nbsp;&nbsp;</td>
          <?php } ?>           
         </tr>
         <tr>
           <td class="dc3" >&nbsp;</td>
         ...
         <tr>
          ...
          <tr>
             <?php if(!in_array($mfT[0]['document_type_uid'],array('6','4','2'))) { ?>
                <td class="dc3" style="width:100%"; "text-align:left"; nowrap >Name___________________________&nbsp;&nbsp; Signed___________________________   Date____________</td>          	
             <?php }	else {?>
                <td class="dc3" style="width:100%"; "text-align:left"; nowrap >&nbsp;&nbsp;&nbsp;</td>
             <?php } ?>
         </tr>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo 'document_invoice_version_380'; ?>
           </td>
         </tr>
       </table>      
...
<script type="text/javascript">
  function emailDoc1() {
      window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfSelf'.trim($document_type). substr($mfT[0]['document_number'],0,8);?>&PSMUID=<?php echo ('');?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo 'document_invoice_version_380.php';?>";
  }
  function emailDoc2() {
  	  window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfCust'.trim($document_type). substr($mfT[0]['document_number'],0,8);?>&PSMUID=<?php echo($mfT[0]['psm_uid']);?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo 'document_invoice_version_380.php';?>";
}  
</script> 
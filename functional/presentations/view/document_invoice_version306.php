     ...
     <table style="border-collapse:collapse; width:98%">
         ...
         <tr>
         	  ...
         	  <?php
                ...
                <td class="dc3" width="80%;" style="text-align:left;" nowrap ><span style="font-weight:bold ;">Job </span>&nbsp;&nbsp;<span style="font-weight:normal;"><?php echo $mfT[0]['delivery_instructions']; ?></span></td>
           <?php }  
...
<!--       <td class="dc6" >&nbsp;&nbsp;</td>  -->         
       ...
       <table style="width:100%;">
        ...
        <?php  if (trim($mfT[0]['tcs']) <> NULL) { ?>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo 'document_invoice_version306'; ?>
           </td>
         </tr>
       </table>      

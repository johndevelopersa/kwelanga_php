          ...
          <tr>
            <td>
             <div id="noprint"><!-- HIDE THIS PRINT AREA : START /--->
               <div id="toolbar">
                 <a href="javascript:window.print();"><img src="C:/inetpub/wwwroot/systems/kwelanga_system/kwelanga_php/images/print-icon.png" border="0" alt="" align="left" > PRINT</a>
      ...
      <tr>
         ...
         <td>&nbsp;</td>         	
               ...
               <?php $document_type = '42'; 
                ...
                <?php $document_type = '4'; 
               } elseif(in_array($mfT[0]['status_uid'],array(DST_ACCEPTED))) { ?>
                   <td class="dc" colspan="6"; width="34%;" style="text-align:left;">SALES ORDER</td>
                <?php $document_type = '27'; 
               } else { ?>               
                   <td class="dc" colspan="6"; width="34%;" style="text-align:left;">SALES ORDER</td>
                <?php $document_type = '27'; } ?>
              <?php 
                 $filename = "images/logos/{$principalId}.gif";
                 $file     = 'C:/inetpub/wwwroot/systems/kwelanga_system/kwelanga_php/'. $filename;
                 if (file_exists('C:/inetpub/wwwroot/systems/kwelanga_system/kwelanga_php/'.$filename) == 1){
         ...
         <tr>
             ...
             <td class="dc3" colspan="4"; style="text-align:right;"><?php echo trim($mfT[0]["prin_ph_add2"]) . ' ' . trim($mfT[0]["prin_ph_add3"]); ?></td> 
         </tr>
         <tr>
             <td>&nbsp;</td>
...
<!-- total line -->
      ...
      <?php  if (trim($mfT[0]['banking_details']) <> NULL && !in_array($mfT[0]['document_type_uid'],array('4','2')))  { ?>
           <table style="border-collapse:collapse; width:100%;">
             ...
             <tr>
                <td colspan="3"; style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;"><?php echo 'document_invoice_carmel_versionA5'; ?></td>
             </tr>
           </table>  
        <?php } ?>
    </body>
...
<script type="text/javascript">
  function emailDocc1() {
      window.location="<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/CreateAndSavePDF.php?DOCMASTID=<?php echo $docmastId;?>&USERID=<?php echo $userId;?>&PRINCIPALID=<?php echo $principalId;?>&OUTPUTTYP=<?php echo 'pdfSelf'.trim($document_type). substr($mfT[0]['document_number'],2,6);?>&PSMUID=<?php echo ('');?>&PRINNAM=<?php echo ($mfT[0]['principal_name']);?>&TEMPLAT=<?php echo 'document_invoice_carmel_versionA5.php';?>";
  }
  function emailDocc2() {

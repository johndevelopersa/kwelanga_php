...
$disPat = $AgedStockDAO->getDispatchDocDetails(mysqli_real_escape_string($dbConn->connection, $docmastId));
   ...
   <title>&nbsp;</title>
    ...
    <body>
     ...
     <table style="border-collapse:collapse; width:98%">
         ...
         <tr>
           <td class="dc2" width="60%;" style="text-align:left;">iRam Reverse Logistics</td>
           <?php 
         ...
         <tr>
           <td class="dc3" width="50%;" style="text-align:left;">20 Zulberg Close</td>
         ...
         <tr>
           <td class="dc3" width="50%;" style="text-align:left;">Bruma Boulevard South Block</td>
         ...
         <tr>
           ...
           <?php   } else { ?>
                     <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Document Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo substr($mfT[0]['document_number'],0,8); ?></span></td>
           <?php   }
                }elseif (in_array($mfT[0]['status_uid'],array(DST_UNACCEPTED,DST_ACCEPTED,47,14))) { ?>
                     <td class="dc3" width="50%;" style="text-align:right;" nowrap><span style="font-weight:bold;">Document Number</span>&nbsp;&nbsp;<span style="font-weight:normal ;"><?php echo substr($mfT[0]['document_number'],0,8); ?></span></td>
           <?php   }
      ...
      <!-- detail -->
       ...
       <table style= "border-collapse:collapse; width:70%; ">
         <tr>
           ...
           <th class="th1" style="width:30% ; text-align:center;" nowrap >Quantity</th>
           <th style="width:5% ;" nowrap >&nbsp;</th>
         </tr>
       ...
       foreach($mfT as $row) { ?>
           <tr>
               ...
               <td class="<?php echo $cls; ?>" style="text-align:center"; nowrap><?php echo $row["document_qty"]?>&nbsp;&nbsp;&nbsp;&nbsp;</td>
               <td>&nbsp;</td>
           </tr>           
           <tr>
           	  <td >&nbsp;</td>
       ...
       <table style= "border-collapse:collapse; width:70%; ">
         <tr>
         	 <th style="width:5% ;" nowrap >&nbsp;</th>
           <th class="th1" style="width:10% ;" nowrap >Uplift No</th>
           <th class="th1" style="width:28% ;" nowrap >Store</th>
           <th class="th1" style="width:25% ;" nowrap >Store Reference</th>
           <th class="th1" style="width:15% ; text-align:center;" nowrap >Value</th>
           <th class="th1" style="width:15% ; text-align:center;" nowrap >Boxes</th>           
           <th style="width:5% ;" nowrap >&nbsp;</th>
         </tr>         	
         <?php  
                $storeUpl = '';                
                foreach($disPat as $brow) {  
                     if($brow['document_number'] <> $storeUpl) {
                	         if($storeUpl <> '') { ?>
                                <tr>
                                    <td >&nbsp;</td>
                                    <td class="<?php echo $cls; ?>" >&nbsp;</td>
                	          ...
                	          $storeUpl = $brow['document_number'] ; ?>
                           <tr>
                               <td>&nbsp;</td>
                               <td class="<?php echo $cls; ?>" nowrap><?php echo ltrim($brow['document_number'],'0') ;?>&nbsp;</td>         
                               <td class="<?php echo $cls; ?>" style= "padding-left:5px" nowrap><?php echo $brow['deliver_name']; ?>&nbsp;</td>         
                               <td class="<?php echo $cls; ?>" style= "padding-left:5px" nowrap><?php echo $brow['store_reference']; ?>&nbsp;</td>                                        
                               <td class="<?php echo $cls; ?>" style ="text-align: left padding-right:10px" nowrap><?php echo number_format($brow['value'],2, "."," "); ?>&nbsp;</td>         
                               <td class="<?php echo $cls; ?>" style= "text-align:center;" nowrap><?php echo $brow['box_number']; ?></td>         
                	         </tr>
                <?php
                     } else { ?>
                        <tr>
       ...
       <table style="width:100%;">
        ...
        <tr>
              <td class="dc3" style="width:80%"; "text-align:left; padding-left:15px;" nowrap >RECEIVED BY : __________________________________________________________</td>
         </tr>
        <tr>
              <td class="dc3" style="width:80%"; "text-align:left; padding-left:15px;" nowrap ><br>NAME :         _________________________________________________________________</td>
         </tr>  
        <tr>
              <td class="dc3" style="width:80%"; "text-align:left; padding-left:15px;" nowrap ><br>DATE :       _______________________________  TIME : ____________________________</td>
         </tr>                                                                                                                                            
        <tr>
              <td class="dc3" style="width:80%"; "text-align:left; padding-left:15px;" nowrap  ><br>GRV NO :   _______________________________________________________________</td>
         </tr> 
         <tr>
         ...
         <tr>
           <td width="100%;" style="text-align:right; color:grey; font-weight:normal; font-size:0.55em;">
             <?php echo 'iram_dispatch_document'; ?>
           </td>
         </tr>
       </table>      

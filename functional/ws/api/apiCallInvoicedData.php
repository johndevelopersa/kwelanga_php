...
// $callresult = "https://kwelangaonlinesolutions.co.za/systems/kwelanga_system/kwelanga_php/functional/ws/api/apiCallInvoicedData.php";

$data = array(
             'username'     => 'PrimaPasta',
             'password'     => 'yF!+KssJr-Ca8yM=NX',
             'requireddata' => 'getInvoiceImports',
             'principalUid' => '450',

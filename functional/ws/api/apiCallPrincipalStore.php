...
// $callresult = "https://kwelangaonlinesolutions.co.za/systems/kwelanga_system/kwelanga_php/functional/ws/api/apiCallPrincipalStore.php";

$data = array(
              'username' => 'PrimaPasta',
              'password' => 'yF!+KssJr-Ca8yM=NX',
              'userEmail' => 'hein@nm.na',
              'requireddata' => 'getCompleteStoreList',
              'principalUid' => '450'
            );

...
// $callresult = "https://kwelangaonlinesolutions.co.za/systems/kwelanga_system/kwelanga_php/functional/ws/api/apiCallCreditNoteData.php";

$data = array(
             'username'     => 'PrimaPasta',
             'password'     => 'yF!+KssJr-Ca8yM=NX',
             'requireddata' => 'getCreditNoteImports',
             'principalUid' => '450',
             'userEmail'    => 'abc@kwelangasolutions.co.za'
             );

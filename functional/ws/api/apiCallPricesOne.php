...
// $callresult = "https://kwelangaonlinesolutions.co.za/systems/kwelanga_system/kwelanga_php/functional/ws/api/apiCallPricesOne.php";

$data = array(
             'username'     => 'APITest',
             'password'     => 'yF!+KssJr-Ca8yM=NX',
             'requireddata' => 'getProductPrice',
             'principalUid' => '271',
             'userEmail'    => 'apiTest@kwelangasolutions.co.za',
             'storeGroup'   => '2283',
             'groupName'    => 'Kwelanga Generic',
             'prodCode'     => 'SQSTS',
             'productDesc'  => 'SQEEZY STRAWBERRY 1X30'
             );

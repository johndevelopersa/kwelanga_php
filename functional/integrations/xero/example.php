...
//[/PayrollAuEmployee:Create]
	...
	public function getConnections($identityApi)
	{
		return $identityApi->getConnections();
...
$invoice_1->setReference('Ref-' . $this->getRandNum())
	->setDueDate(new DateTime('2020-12-10'))
	->setContact($contact)
	->setLineItems($lineitems)
...
$invoice_2->setReference('Ref-' . $this->getRandNum())
	->setDueDate(new DateTime('2020-12-02'))
	->setContact($contact)
	->setLineItems($lineitems)
	->setStatus(XeroAPI\XeroPHP\Models\Accounting\Invoice::STATUS_AUTHORISED)
	->setType(XeroAPI\XeroPHP\Models\Accounting\Invoice::TYPE_ACCREC)
...
//[/Invoices:Create]
		...
		$str = "<pre>"  . $str ."Create Invoice 1 total amount: " . $result->getInvoices()[0]->getTotal() ." and Create Invoice 2 total amount: " . $result->getInvoices()[1]->getTotal() . "<br></pre>";

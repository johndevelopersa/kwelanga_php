          ...
          <center>
              <FORM name='SELECT USER' method=post action=''>
                   <table width="720"; style="border:none">
                        ...
                        <tr class="<?php echo GUICommonUtils::styleEO($class); ?>">
                          <td colspan="5"; style="text-align:center;"><INPUT TYPE="submit" class="submit" name="SEARCHBRANCH" value= "Search">&nbsp;&nbsp
                 ...
                 <FORM name='SELECT USER' method=post action=''>
                   <table width="720"; style="border:none">
                        ...
                        <tr class="<?php echo GUICommonUtils::styleEO($class); ?>">
                          ...
                          <td  class="head1" colspan="1" style="text-align:right; padding: 0px 5px 0px 5px;font-weight: bold;">Delete</td>
                              <input type="hidden" id="STOREUID" name="STOREUID" value="<?php echo $StoreUID;?>">
                          ...
                          <tr class="<?php echo GUICommonUtils::styleEO($cl); ?>">
                             ...
                             <?php
                              ...
                              <tr class="<?php echo GUICommonUtils::styleEO($cl); ?>">
                                    ...
                                    <td class="detN12" colspan="1" style="text-align:right;"><INPUT TYPE="radio" name="SELMOD" onclick="javascript: submit()" value= "<?php echo $row['principal_uid'];?>"></td>
                                   	<td class="detN12" colspan="1" style="text-align:right;"><INPUT TYPE="radio" name="DELMOD" onclick="javascript: submit()" value= "<?php echo $row['store_uid'];?>"></td>
              ...
              <FORM name='SELECT USER' method=post action=''>
                   <table width="720"; style="border:none">
                        ...
                        <tr class="<?php echo GUICommonUtils::styleEO($class); ?>">
                          ...
                          <td  class="head1" colspan="1" style="text-align:right; padding: 0px 5px 0px 5px;font-weight: bold;">Manage</td>
                          <td  class="head1" colspan="1" style="text-align:right; padding: 0px 5px 0px 5px;font-weight: bold;">Delete</td>
                           <td  ><input type="hidden" id="STOREUID" name="STOREUID" value="<?php echo $StoreUID;?>"></td>
                          </tr>
                          <tr class="<?php echo GUICommonUtils::styleEO($cl); ?>">
                                   <td  colspan="5" style="text-align:center;">&nbsp;</td> 
                              </tr>

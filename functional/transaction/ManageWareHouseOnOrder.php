          ...
          if ($postINVOICE !== '') {
              ...
              if (sizeof($mfDDU)>0) {
                    ...
                    <center>
                       <FORM name='Manage Warehouse' method=post action=''>
                          <table width="700"; style="border:none">
                             <tr>
                                 <td class=head1 colspan="5"; style="text-align:center">Manage the Warehouse on an Order</td>
                             </tr>
                             <tr>
                                  <td colspan="5";>&nbsp;</td>
                             </tr>
                             ...
                             <tr class="<?php echo GUICommonUtils::styleEO($class); ?>";>                               
                                  <td colspan="1"; style="text-align:left">Customer</td>
                                  ...
                                  <td colspan="1"; style="text-align:left">Document No</td>                                  
                             ...
                             <tr class="<?php echo GUICommonUtils::styleEO($class); ?>";>                               
                                  <td colspan="1"; style="text-align:left">Existing Warehouse</td>
                                  ...
                                  <td colspan="1"; style="text-align:left">New Warehouse</td>
                                  <td>
                             ...
                             <tr class="<?php echo GUICommonUtils::styleEO($class); ?>";>                               
                                  <td colspan="1"; style="text-align:left">Update Store master</td>
                                  <td colspan="1"; style="text-align:center;"><?php $lableArr = array('No','Yes');
          		                                                $valueArr = array('2','1');
                  ...
                  <?php 
                     ...
                     <script type='text/javascript'>parent.showMsgBoxError('Document Aready invoiced or In Pick. Warehouse canneot be changed')</script> 
                  <?php 
                     unset($postINVOICE);
                     unset($firstform);
                  }
    ...
    <center>
       <FORM name='Select Invoice' method=post action=''>
            <table width="720"; style="border:none">
               <tr>
                 <td class=head1 >Manage the Warehouse on an Order</td>
               </tr>
               <tr>
                 <td>&nbsp</td>
               </tr>	        	

    ...
    if (!isset($_SESSION)) session_start() ;
     ...
     $dbConn = new dbConnect(); $dbConn->dbConnection();
       ...
       if (isset($_POST['finish'])) {
        ...
        $rTO = $postTransactionDAO->updateTrackingNo($ordseq,$waybill1, '');       	
               ...
               <FORM name='displayinv' method=post target=''>
                  <Table width:"80%"; style="border-collapse: collapse">
                    ...
                    <tr class="<?php echo "even"; ?>">
                    	...
                    	<td colspan="3"; style="text-align:center" ><input type="hidden" name="orderSeq" value=<?php echo $mfDDU[0]['order_sequence_no'];?>></td>            	
                    </tr>	
                    <tr class="<?php echo "odd"; ?>">
                    ...
                    <tr class="<?php echo "odd"; ?>">
                      <td class=det2 colspan="2" >Tracking&nbsp;No</td>
                    	<td class=det2 colspan="3" style="text-align:center"><input type="text" name="WAYBILL" autofocus value="<?php echo $mfDDU[0]['delivery_instructions'];?>"><br></td>
                    </tr>   
               </table> 
              <br><br>
             <table> 
              <tr>
                <td colspan="5"></td>
        	      <td><INPUT TYPE="submit" class="submit" name="finish" value= "Update Tracking Number"></td>
              </tr>
             </table>
	        </center>    	
          <?php
...
<center>
	 <FORM name='Select Invoice' method=post action=''>
        <table width:"100%"; style="border:none">
        	<tr>
        		<td class=head1 >Add / Amend a Tracking Number</td>
        		</tr>
        	<tr>
        		 <td>&nbsp</td>
        		</tr>	        	

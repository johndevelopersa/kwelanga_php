...
<?php
      ...
      if (isset($_POST['finishform'])) {
             ...
             if($product=='Select Product') { ?>
                   ...
                   unset($_POST['select']); 
                   unset($_POST['finishform']); 
             } elseif($price < -10000 || $price > 9999999  ) {  ?>
                   ...
                   $PostingOrderNewDetailLineTO->allowDec    = $_POST['allDec'] ;
                  ...
                  // Display Complete Order
                   ...
                   if (sizeof($mfCTX)==0) { ?>
                       ...
                       <center>
                           ...
                           <?php 
                                   $orderQty = $extPrice = 0;
                                   echo $PostingOrderNewDetailLineTO->allowDec; 
                                   echo "<br>KKK";
                                   ...
                                   <?php
                                       ...
                                       $aDecStart = strpos($PostingOrderNewDetailLineTO->product,"^") + 1;   
                                       ...
                                       $aDeci       = substr($PostingOrderNewDetailLineTO->product,$aDecStart,1);
                                   ...
                                   ?>
                                        <tr class="<?php echo GUICommonUtils::styleEO($class); ?>";>
                                           ...
                                           <?php if($aDeci=="Y") {?>
                                                <td style="border:none; text-align:right; color:red;"><?php echo number_format($PostingOrderNewDetailLineTO->quantity,2,'.',' '); ?></td>
                                           <?php	
                                           } else { ?>
                                        ...
                                        <tr class="<?php echo GUICommonUtils::styleEO($class); ?>";>
                      	                ...
                      	                <tr class="<?php echo GUICommonUtils::styleEO($class); ?>";>
                                            ...
                                            <input type="hidden" id="allDec"    name="allDec"  value=<?php echo $aDeci; ?>>
                                  ...
                                  <td>
                                     <select name="Product" id="Product">
                                       ...
                                       <?php foreach($mfPP as $row) { ?>
                                             <option value="<?php echo trim($row['uid']) . "#" . trim($row['product_code']) ."$" . trim($row['product_description']) . "~" . trim($row['vat_rate']) . "^". trim($row['allow_decimal']); ?>"><?php echo $row['product_code'] ." - " . trim($row['product_description']); ?></option>
                                       <?php } ?>
                                     </select>
                                  </td>  
                                  <td style="border:none; text-align:right;">
                                  <input type="hidden" id="documentUid" name="documentUid" value=<?php echo $mfDDU[0]['uid'];?>>                               
                                  <input name='Quantity' id='Quantity' type='number' step="0.01" value=0 size=4  maxlength=4 /></td>

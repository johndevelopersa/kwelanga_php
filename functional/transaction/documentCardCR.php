...
<?php if ($mfT[0]['document_type_uid'] == 8) { ?>
    <h2 style="text-align:center;"><?php echo ((!in_array($mfT[0]["principal_uid"],array($principalVergezocht,$principalGrowingManufacturers)))?"C o p y&nbsp;&nbsp;&nbsp;&nbsp;":""); ?>T A X&nbsp;&nbsp;&nbsp;&nbsp;D E B I T&nbsp;&nbsp; N O T E</h2>
<?php } else { ?>
    <h2 style="text-align:center;"><?php echo ((!in_array($mfT[0]["principal_uid"],array($principalVergezocht,$principalGrowingManufacturers)))?"C o p y&nbsp;&nbsp;&nbsp;&nbsp;":""); ?>T A X&nbsp;&nbsp;&nbsp;&nbsp;C R E D I T&nbsp;&nbsp; N O T E</h2>
<?php } ?>
...
<FIELDSET>	
<?php if ($mfT[0]['document_type_uid'] == 8) { ?>
     <LEGEND style='font-size:9px; color:#999999; padding-left:10px; padding-right:10px;'>D E B I T&nbsp;&nbsp;&nbsp;&nbsp;N O T E &nbsp;&nbsp;&nbsp;&nbsp;f o r&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $principalName; ?>, <?php echo $mfT[0]['depot_name']; ?></LEGEND>
<?php } else { ?>
     <LEGEND style='font-size:9px; color:#999999; padding-left:10px; padding-right:10px;'>C R E D I T&nbsp;&nbsp;&nbsp;&nbsp;N O T E &nbsp;&nbsp;&nbsp;&nbsp;f o r&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $principalName; ?>, <?php echo $mfT[0]['depot_name']; ?></LEGEND>
<?php } ?>
<BR>
...
<TR>
  ...
  <TD colspan="1" style=''><SPAN style='font-weight:normal; font-size:0.5em; color:#999999;'>Source Document Number:</SPAN><BR><SPAN style='font-size:1.2em;'><?php echo $mfT[0]['source_document_number']; ?></SPAN></TD>
...
<TR>		
	<TD nowrap style=''><SPAN style='font-weight:normal; font-size:0.5em; color:#999999;'>Reason:</SPAN><BR><SPAN style='font-size:0.8em;'><?php echo $mfT[0]['description']; ?></SPAN></TD>
	<TD nowrap style=''><SPAN style='font-weight:normal; font-size:0.5em; color:#999999;'>Credit Note Date:</SPAN><BR><SPAN style='font-size:0.8em;'><?php echo $mfT[0]['invoice_date']; ?></SPAN></TD>
</TR>
<TR>
...
<TR>
	...
	<TD nowrap style=''><SPAN style='font-weight:normal; font-size:0.5em; color:#999999;'>Related Client doc No.:</SPAN><BR><SPAN style='font-size:0.8em;'><?php echo $mfT[0]['source_document_number']; ?></SPAN></TD>
</TR>
...
function pdfDoc() {
	var params="?USERID=<?php echo $userId; ?>&OBJECTID=<?php echo EO_DOC_CARD_CR; ?>&DOCMASTID=<?php echo $postDOCMASTID; ?>&KEYFROMLINK=<?php echo $postKEYFROMLINK; ?>";

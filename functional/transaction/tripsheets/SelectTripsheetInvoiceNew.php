...
// *** Deprecated	
                     ...
                     if ($errorTO->type==FLAG_ERRORTO_SUCCESS) {
                        ...
                        <script type='text/javascript'>parent.showMsgBoxInfo('Trip Sheet Successfully Created')
                            ...
                            if(isset($_POST['LOADSHEET']) && in_array($depotId, $nelarray)) { 
                   	            if($userUId == 612) { ?>
                                    window.open('<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/view/load_sheet_document_multi_version5.php?TRIPNO=<?PHP echo $tripSheetNumber; ?>');    
                                <?php 
                                } else { ?>
                            ...
                            if(in_array($depotId, $waitDispatchArray)) { ?>
                                    window.open('<?php echo $ROOT.$PHPFOLDER ?>functional/presentations/view/pdf_tripsheet_loading_summary.php?TRIPNUMBER=<?PHP echo $tripSheetNumber; ?>&DEPID=<?PHP echo $depotId;?>');    
                                <?php
                            } ?>
                        </script> 
                        <?php
         ...
         <center>
             <form name='Invoices' method=post target='' class="submit-once">
                 <table width="90%"; style="border:none">
                     ...
                     <tr class="<?php echo GUICommonUtils::styleEO($cl); ?>">
                         ...
                         <td  class="head1" colspan="1" style="text-align:left; padding-left: 12px;">NDD</td>
                         <td  class="head1" colspan="1" style="text-align:left; padding-left: 18px;">Status</td>
                     ...
                     foreach ($mfDD as $row) { ?>
                          <tr class="<?php echo GUICommonUtils::styleEO($cl); ?>">
                               ...
                               <td class="detN12" style="text-align:center;"><?php if($row['Redeliver'] == DST_RE_DELIVERY) {echo 'Re&nbsp;Deliver';} 
                               	                                                   elseif($row['Redeliver'] == DST_WAITING_DISPATCH) {echo 'Wait&nbsp;Dispatch';}
                               	                                                   else { echo '';} ?></td>
      ...
      <div id="div_MANAGECONTENT" style="background:rgba(25,25,25,0.3);width:100%;height:100vh;top:0;left:0;right:0;bottom:0;position:fixed;display:none;">
          <div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);background:white;padding:20px;border-radius:5px;">
            <div><img src="<?php echo $DHTMLROOT.$PHPFOLDER ?>images/loading.gif" style="margin:auto;display:block;width:50px;height:50px;"></div>

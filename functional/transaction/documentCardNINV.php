...
<FIELDSET>
<LEGEND colspan="2"; style='font-weight:900; font-size:2em; color:black;'>C O P Y&nbsp;&nbsp;&nbsp;&nbsp;I N V O I C E&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $principalName; ?></LEGEND>
<BR>
...
<TR>
	...
	<TD colspan="1" style=''><SPAN style='font-weight:normal; font-size:0.5em; color:#999999;'>Invoice Number:</SPAN><BR><SPAN style='font-weight:bold; font-size:0.9em;'><?php if ($mfT[0]['invoice_number']=="") { echo ltrim($mfT[0]['document_number'],'0'); } else {echo ltrim($mfT[0]['invoice_number'],'0'); } ?></SPAN></TD>
...
<BR>
<STYLE>
th.detail { text-align:center; border:1px solid #999; font-weight:bold; font-size:0.7em; white-space:nowrap; border-collapse:collapse; }
td.detail { padding-left:0.1cm; border-left:solid; border-left-width:0.1; border-left-color:black; font-weight:normal; font-size:0.7em; text-align:right;border-collapse:collapse; }
</STYLE>
<CENTER>
<TABLE style='border-style:solid; border-width:1; border-color:black; border-bottom-style:solid #999>

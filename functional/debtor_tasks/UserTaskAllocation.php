                      ...
                      <table width="900"; style="border:none">
                        ...
                        <tr class="<?php echo GUICommonUtils::styleEO($class); ?>">
                         ...
                         foreach ($aWList as $row) { 
                          	      if($row['Task_Allocated'] == 'A' && $row['dtt_status'] == 'A' && $row['Allow_Task'] == 'Allow' ) {
                                      $check = 'CHECKED';
                                  } elseif($row['Task_Allocated'] == 'A' && $row['dtt_status'] == 'A' && $row['Allow_Task'] == 'Disable' )  {
                                      $check= 'DISABLED';  
                                  } else { 
                                      $check= '';
                                  }
                         ...
                         <tr>
                         	 <td >&nbsp</td>
                           <td class=det3 colspan="10";>** Checkbox disabled means the Task is already allocated to another user</td>
                         </tr>  
                      </table>
                   </form>
                </center>
...
if(!isset($_POST['firstform']) && !isset($_POST['selectDebtorForm']) && !isset($_POST['selectTaskListForm']) && !isset($_POST['saveform'])) {
    ...
    <center>
       <FORM name='AddWarehouseToExtract' method=post action=''>
            <table width="720"; style="border:none">
               <tr class="<?php echo GUICommonUtils::styleEO($class); ?>">
                 <td class=head1 colspan="6"; style="text-align:center";>Allocate user Tasks</td>
               </tr>
               <tr class="<?php echo GUICommonUtils::styleEO($class); ?>">
                 <td width="10%"; style="border:none">&nbsp</td>
                 <td width="10%"; style="border:none">&nbsp</td>

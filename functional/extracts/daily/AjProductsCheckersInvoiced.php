...
class AjProductsCheckersInvoiced {
...
class AjProductsCheckersInvoicedInit extends extractController {

  private $principalUid = 409; //uid of principal extract.
  
  private $chfilename    = 'PAS409SCH[@FSEQ].txt';  //main controller will build full filename with seq. for us.
  private $chcrnFilename = 'CRN409SCH[@FSEQ].txt';  //credit note filename

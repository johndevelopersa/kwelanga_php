...
class SouthernRightFoodstInvoiced {
...
class SouthernRightFoodstInvoicedInit extends extractController {

  private $principalUid = 374; //uid of principal extract.
  private $filename = 'PAS374[@FSEQ].txt';  //main controller will build full filename with seq. for us.
  private $crnFilename = 'CRN374[@FSEQ].txt';  //credit note filename
  ...
  public function generateOutput(){
    ...
    if (sizeof($psms)>0) {
      $sfvals_PA = $this->miscDAO->getPrincipalSpecialFieldValuesMultEntities($this->principalUid, 465, implode(",",$psms), CT_STORE_SHORTCODE, $arrayIndex="entity_uid");

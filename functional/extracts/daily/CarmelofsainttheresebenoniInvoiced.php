...
class CarmelofsainttheresebenoniInvoiced {
...
class CarmelofsainttheresebenoniInvoicedInit extends extractController {

  private $principalUid = 207; //uid of principal extract.
  private $filename = 'PAS207[@FSEQ].csv';  //main controller will build full filename with seq. for us.
  private $crnFilename = 'CRN207[@FSEQ].csv';  //credit note filename
  ...
  public function generateOutput(){
    ...
    if (sizeof($psms)>0) {
      $sfvals_PA = $this->miscDAO->getPrincipalSpecialFieldValuesMultEntities($this->principalUid, 247, implode(",",$psms), CT_STORE_SHORTCODE, $arrayIndex="entity_uid");
    }

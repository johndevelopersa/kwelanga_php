...
class SunrayInvoicedInit extends extractController {


  private $principalUid = 40; //uid of principal extract.
  private $invFilename = 'INV86[@FSEQ]i.XML';  //invoice filename
  private $crnFilename = 'INV86[@FSEQ]c.XML';  //credit & debit note filename

  //SPECIAL FIELD UIDS
  private $spfUId1 = 179; //shipto
  private $spfUId2 = 180; //billto

  //SGX SETTINGS
  private $recipient = '6002657000017';
  private $vendorNo = '6006677000869';
  private $vendorName= 'SUNRAY SEEDS CC';
  private $vendorAddr1= 'POSTNET SUITE 290';
  private $vendorAddr2= 'PRIVATE BAG X16';
  private $vendorAddr3= 'CONSTANIA';
  private $vendorAddr4= '';
  private $vendorCompanyRegNo = '';
  private $vendorVatNo = '4630207977';
  private $prefix = 'SU';
  private $site = 'asfar';

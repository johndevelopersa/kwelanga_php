...
class VitalInvoicedInit extends extractController {


  private $principalUid = 19; //uid of principal extract.
  private $invFilename = 'INV65[@FSEQ]i.XML';  //invoice filename
  private $crnFilename = 'INV65[@FSEQ]c.XML';  //credit & debit note filename

  //special field uids
  private $spfUId1 = 76; //shipto
  private $spfUId2 = 75; //billto

  //SGX SETTINGS
  private $recipient = '6002657000017';
  private $vendorNo = '6006677000651';
  private $vendorName= 'Vital Baby S.A. (Pty) LTD';
  private $vendorAddr1= 'Cnr. 14Th St And 5Th Ave';

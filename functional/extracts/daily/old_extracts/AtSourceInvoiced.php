...
class AtSourceInvoicedInit extends extractController {


  private $principalUid = 87; //uid of principal extract.
  private $invFilename = 'INV15[@FSEQ]i.XML';  //invoice filename
  private $crnFilename = 'INV15[@FSEQ]c.XML';  //credit & debit note filename

  //special field uids
  private $spfUId1 = 192; //shipto
  private $spfUId2 = 191; //billto

  //SGX SETTINGS
  private $recipient = '6002657000017';
  private $vendorNo = '6006677000156';
  private $vendorName= 'AT SOURCE HANDMADE FOODS (PTY) LTD';
  private $vendorAddr1= 'P.O. BOX 702';
  private $vendorAddr2= 'CERES';
  private $vendorAddr3= 'TWEESPRUIT';
  private $vendorAddr4= '';
  private $vendorCompanyRegNo = '';
  private $vendorVatNo = '4470203623';
  private $prefix = 'SH';
  private $site = 'ashar';

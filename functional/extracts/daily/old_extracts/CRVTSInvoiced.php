...
class CRVTSInvoicedInit extends extractController {


  private $principalUid = 69; //uid of principal extract.
  private $invFilename = 'INV108[@FSEQ]i.XML';  //invoice filename
  private $crnFilename = 'INV108[@FSEQ]c.XML';  //credit & debit note filename


  //special field uids
  private $spfUId1 = 188; //shipto
  private $spfUId2 = 187; //billto

  //SGX SETTINGS
  private $recipient = '6002657000017';
  private $vendorNo = '6006677001085';
  private $vendorName= 'CRVTS DISTRIBUTORS';
  private $vendorAddr1= 'P.O. BOX 8833';
  private $vendorAddr2= 'CINDA PARK';
  private $vendorAddr3= '';
  private $vendorAddr4= '';
  private $vendorCompanyRegNo = '';
  private $vendorVatNo = '4640243360';
  private $prefix = 'CV';
  private $site = 'acvar';

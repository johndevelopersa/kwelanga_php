...
class HealthyTeaInvoicedInit extends extractController {


  private $principalUid = 146; //uid of principal extract.
  private $invFilename = 'INV145[@FSEQ]i.XML';  //invoice filename
  private $crnFilename = 'INV145[@FSEQ]c.XML';  //credit & debit note filename


  //special field uids
  private $spfUId1 = 194; //shipto
  private $spfUId2 = 193; //billto

  //SGX SETTINGS
  private $recipient = '6002657000017';
  private $vendorNo = '6006677001452';
  private $vendorName= 'HEALTHY INTEGRATED TEA';
  private $vendorAddr1= 'PO BOX 51865';
  private $vendorAddr2= 'WIERDA PARK';
  private $vendorAddr3= '0149';
  private $vendorAddr4= '';
  private $vendorCompanyRegNo = '';
  private $vendorVatNo = '4250260660';
  private $prefix = 'HT';
  private $site = 'ahtar';

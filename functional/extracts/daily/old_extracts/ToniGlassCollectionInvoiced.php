...
class ToniGlassCollectionInvoiced {
...
class ToniGlassCollectionInvoicedInit extends extractController {

  private $principalUid = 213; //uid of principal extract.
  private $filename = 'PAS213[@FSEQ].csv';  //main controller will build full filename with seq. for us.
  private $crnFilename = 'CRN213[@FSEQ].csv';  //credit note filename
  ...
  public function generateOutput(){
    ...
    if (sizeof($psms)>0) {
      $sfvals_PA = $this->miscDAO->getPrincipalSpecialFieldValuesMultEntities($this->principalUid, 243, implode(",",$psms), CT_STORE_SHORTCODE, $arrayIndex="entity_uid");
    }

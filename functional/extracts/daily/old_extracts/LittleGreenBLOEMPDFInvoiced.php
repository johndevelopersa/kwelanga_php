...
class LittleGreenBLOEMPDFInvoiced {
...
class LittleGreenBLOEMPDFInvoicedInit extends extractController {


  private $principalUid = 260; //uid of principal extract.
  ...
  public function generateOutput(){
    ...
    if (sizeof($psms)>0) {
      $sfvals_PA = $this->miscDAO->getPrincipalSpecialFieldValuesMultEntities($this->principalUid, 309, implode(",",$psms), CT_STORE_SHORTCODE, $arrayIndex="entity_uid");
    }

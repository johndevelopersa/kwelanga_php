...
class ForeBabyInvoicedInit extends extractController {


  private $principalUid = 183; //uid of principal extract.
  private $invFilename = 'INV156[@FSEQ]i.XML';  //invoice filename
  private $crnFilename = 'INV156[@FSEQ]c.XML';  //credit & debit note filename

  //special field uids
  private $spfUId1 = 209; //shipto
  private $spfUId2 = 210; //billto

  //SGX SETTINGS
  private $recipient = '6002657000017'; // is the same as vendorNo as SGX have already used the proper GLN for another principal
  private $vendorNo = '6009801812069';
  private $vendorName= 'Forebaby (Pty) Ltd';

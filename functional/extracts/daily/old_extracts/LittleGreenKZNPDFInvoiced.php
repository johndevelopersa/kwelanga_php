...
class LittleGreenKZNPDFInvoiced {
...
class LittleGreenKZNPDFInvoicedInit extends extractController {


  private $principalUid = 257; //uid of principal extract.
  ...
  public function generateOutput(){
    ...
    foreach($grpDocs as $type => $orders){
      ...
      foreach($orders as $ord){
        ...
        $seqFilename = (($type=='i')?$this->filename.$ord[0]["document_number"].'.pdf' :$this->crnFilename.substr($ord[0]["alternate_document_number"],2,6).'.pdf' );
        $successCount++;

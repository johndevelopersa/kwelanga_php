...
class SixbarRemitInvoicedInit extends extractController {

  private $principalUid = 145; //uid of principal extract.
  private $filename = 'RM145[@FSEQ].csv';  //main controller will build full filename with seq. for us.

...
class CyndaraInvoicedInit extends extractController {


  private $principalUid = 62; //uid of principal extract.
  private $filename = 'PA05[@FSEQ].csv';  //main controller will build full filename with seq. for us.
...
//        $regionArr = (isset($depotTrans[$ord[0]['depot_uid']])) ? $depotTrans[$ord[0]['depot_uid']] : '  ';
        ...
        $rowArr = array();
        $rowArr[] = '"HEADER"';
        $rowArr[] = '"NPU' . str_pad(substr($ord[0]['document_number'],-6), 6, 0, STR_PAD_LEFT) . '"';
        $rowArr[] = '" "';  //space(1);
        $rowArr[] = '"Y"';  //printed

...
class WavesideRemitInvoicedInit extends extractController {

  private $principalUid = 81; //uid of principal extract.
  private $filename = 'RM81[@FSEQ].csv';  //main controller will build full filename with seq. for us.
  ...
  public function generateOutput(){
    ...
    foreach($remitArr as $rm=>$remit){                  
          ...
          if($period == 13){
            ...
            $remitdate = "30/01/2015";
          }
          elseif ($period == 2){
          	
            $remitdate = "21/02/2015";
          }	
          elseif ($period == 3){
          	
            $remitdate = "28/03/2015";
          }	
          elseif ($period == 4){
          	
            $remitdate = "25/04/2015";
          }	
          elseif ($period == 5){
          	
            $remitdate = "23/05/2014";
          }	
          elseif ($period == 6){
          	
            $remitdate = "27/06/2014";
          }	
          elseif ($period == 7){
          	
            $remitdate = "25/07/2014";
          }	
          elseif ($period == 8){
          	
            $remitdate = "29/08/2014";
          }	
          elseif ($period == 9){
          	
            $remitdate = "26/09/2014";
          }	
          elseif ($period == 10){
          	
            $remitdate = "24/10/2014";
          }	
          elseif ($period == 11){
          	
            $remitdate = "28/11/2014";
          }	
          elseif ($period == 12){

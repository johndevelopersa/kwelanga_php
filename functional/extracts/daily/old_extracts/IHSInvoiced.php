...
class IHSInvoicedInit extends extractController {

  private $principalUid = 199; //uid of principal extract.
  private $filename = 'PAS199[@FSEQ].csv';  //main controller will build full filename with seq. for us.
  private $crnFilename = 'CRN199[@FSEQ].csv';  //credit note filename

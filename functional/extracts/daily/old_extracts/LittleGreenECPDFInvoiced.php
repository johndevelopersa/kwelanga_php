...
class LittleGreenECPDFInvoiced {
...
class LittleGreenECPDFInvoicedInit extends extractController {


  private $principalUid = 259; //uid of principal extract.
  ...
  public function generateOutput(){
    ...
    if (sizeof($psms)>0) {
      $sfvals_PA = $this->miscDAO->getPrincipalSpecialFieldValuesMultEntities($this->principalUid, 311, implode(",",$psms), CT_STORE_SHORTCODE, $arrayIndex="entity_uid");
    }

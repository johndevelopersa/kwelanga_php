...
class PharmaPasInvoicedInit extends extractController {

  private $principalUid = 242; //uid of principal extract.
  private $filename = 'PAS242[@FSEQ].csv';  //main controller will build full filename with seq. for us.
  private $crnFilename = 'CRN242[@FSEQ].csv';  //credit note filename
  ...
  public function generateOutput(){
    ...
    if (sizeof($psms)>0) {
      $sfvals_PA = $this->miscDAO->getPrincipalSpecialFieldValuesMultEntities($this->principalUid, 291, implode(",",$psms), CT_STORE_SHORTCODE, $arrayIndex="entity_uid");

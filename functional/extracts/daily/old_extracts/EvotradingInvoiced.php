...
class EvotradingInvoicedInit extends extractController {

  private $principalUid = 233; //uid of principal extract.
  private $filename = 'PAS233[@FSEQ].csv';  //main controller will build full filename with seq. for us.
  private $crnFilename = 'CRN233[@FSEQ].csv';  //credit note filename
  ...
  public function generateOutput(){
    ...
    if (sizeof($psms)>0) {
      $sfvals_PA = $this->miscDAO->getPrincipalSpecialFieldValuesMultEntities($this->principalUid, 286, implode(",",$psms), CT_STORE_SHORTCODE, $arrayIndex="entity_uid");

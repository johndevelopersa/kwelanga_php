...
class SamsTissueInvoicedReversed {
...
class SamsTissueInvoicedReversedInit extends extractController {

  private $principalUid = 304; //uid of principal extract.
  private $filename = 'CRN304[@FSEQ].txt';  //main controller will build full filename with seq. for us.
  private $crnFilename = 'DEB390[@FSEQ].txt';  //credit note filename

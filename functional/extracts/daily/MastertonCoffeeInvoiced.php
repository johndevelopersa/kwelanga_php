...
class MastertonCoffeeInvoicedInit extends extractController {

  private $principalUid = 386; //uid of principal extract.
  private $filename = 'PAS386[@FSEQ].txt';  //main controller will build full filename with seq. for us.
  ...
  public function generateOutput(){
    ...
    echo "PAS - Successfully Completed Extract : ".get_class($this)."<br>";

...
class IFoodInvoicedInit extends extractController {

  private $principalUid = 277; //uid of principal extract.
  private $filename = 'PAS277[@FSEQ].csv';  //main controller will build full filename with seq. for us.
  private $crnFilename = 'CRN277[@FSEQ].csv';  //credit note filename

...
class EurekaMillsInvoicedInit extends extractController {

  private $principalUid = 403; //uid of principal extract.
  private $filename = 'PAS403[@FSEQ].txt';  //main controller will build full filename with seq. for us.
  private $crnFilename = 'CRN403[@FSEQ].txt';  //credit note filename

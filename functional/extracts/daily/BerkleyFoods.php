...
class BerkleyFoodsInit extends extractController {

  private $principalUid = 425; //uid of principal extract.
  private $filename = 'INV425[@FSEQ].txt';  //main controller will build full filename with seq. for us.
  private $crnFilename = 'CRN425[@FSEQ].txt';  //credit note filename

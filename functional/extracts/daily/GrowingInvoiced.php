...
class GrowingInvoicedInit extends extractController {


  private $principalUid = 122; //uid of principal extract.
  private $filename = 'PAS31[@FSEQ].TXT';  //main controller will build full filename with seq. for us.
  ...
  public function generateOutput(){
    ...
    if (sizeof($psms)>0) {
      $sfvals = $this->miscDAO->getPrincipalSpecialFieldValuesMultEntities($this->principalUid, 172, implode(",",$psms), CT_STORE_SHORTCODE, $arrayIndex="entity_uid");
    }

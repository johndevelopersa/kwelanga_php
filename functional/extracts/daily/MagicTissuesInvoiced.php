...
class MagicTissuesInvoicedInit extends extractController {

  private $principalUid = 446; //uid of principal extract.
  private $filename = 'PAS446[@FSEQ].txt';  //main controller will build full filename with seq. for us.
  private $crnFilename = 'CRN446[@FSEQ].txt';  //credit note filename
  ...
  public function generateOutput(){
    ...
    if (sizeof($psms)>0) {
      $sfvals_PA = $this->miscDAO->getPrincipalSpecialFieldValuesMultEntities($this->principalUid, 618, implode(",",$psms), CT_STORE_SHORTCODE, $arrayIndex="entity_uid");
    }

       ...
       <FORM name='Detail Record Adjustments' method=post action=''>
            <table width="720"; style="border:none">
               <tr class="<?php echo GUICommonUtils::styleEO($class); ?>">
                 <td class=head1 colspan="5"; style="text-align:center";>Detail Record Recalculation</td>
               </tr>
               <tr class="<?php echo GUICommonUtils::styleEO($class); ?>">
               ...
               <tr class="<?php echo GUICommonUtils::styleEO($class); ?>">
                 <td colspan="5"; style="text-align:center;"><INPUT TYPE="submit" class="submit" name="firstform" value= "Check Detail Records">

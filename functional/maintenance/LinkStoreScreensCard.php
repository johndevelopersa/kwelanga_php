          ...
          <center>
              <FORM name='SELECT USER' method=post action=''>
                   <table width="720"; style="border:none">
                        ...
                        <tr class="<?php echo GUICommonUtils::styleEO($class); ?>">
                          <td colspan="5"; style="text-align:center;"><INPUT TYPE="submit" class="submit" name="SEARCHBRANCHP" value= "Search Store By Branch">&nbsp;&nbsp
                          	                                          <INPUT TYPE="submit" class="submit" name="SEARCHGLNP" value= "Search Store By GLN">&nbsp;&nbsp
                                          	                          <INPUT TYPE="submit" class="submit" name="SEARCHNAMEP" value= "Search Store By Name">&nbsp;&nbsp

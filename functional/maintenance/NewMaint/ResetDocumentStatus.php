<?php
    ...
    include_once($ROOT.$PHPFOLDER."functional/maintenance/NewMaint/ResetDocumentStatusClass.php");
...
// *******************************************************************************************************************************************
     ...
     if (isset($_POST['finish'])) {
        ...
        if ($rTO->type==FLAG_ERRORTO_SUCCESS) {
             ...
             ?>
             <script type='text/javascript'>parent.showMsgBoxError('Document Status Update Failed - Contact Support')</script> 
       	     <?php
               ...
               <FORM name='displayinv' method=post target=''>
                  <table width:"80%"; style="border-none";>
                    ...
                    <?php if($mfDDU[0]['document_status_uid'] <> DST_DELIVERED_POD_OK) { ?>
                        <tr class="<?php echo GUICommonUtils::styleEO($class);?>">
                          <td colspan="5"; style="text-align:center;"><INPUT TYPE="submit" class="submit" name="reset" value= "Status Cannot be Reset">
...
// ********************************************************************************************************************************	     
     ...
     if (!isset($_POST['select']) && !isset($_POST['finish'])){
     	...
     	$resetDocumentStatus = new resetDocumentStatus();
  		$a = $resetDocumentStatus->firstform();

	 ...
	 <FORM name='Select Invoice' method=post action=''>
        <table width:"720"; style="border:none">        	
           ...
           <tr class="<?php echo GUICommonUtils::styleEO($class);?>">
            ...
            <tr class="<?php echo GUICommonUtils::styleEO($class);?>">
              <td colspan="2" style="color: <?php echo $col;?>; text-align:center";><strong>***Atleast One Document Number Required</td>
           </tr>	 
           <tr class="<?php echo GUICommonUtils::styleEO($class);?>">
              <td colspan="2";>&nbsp</td>
           </tr>    	
           ...
           <tr class="<?php echo GUICommonUtils::styleEO($class);?>">
              <td colspan="2" style="color: <?php echo $col;?>; text-align:center";><strong>***Only One Product Code Required</td>
           </tr>	 
           <tr class="<?php echo GUICommonUtils::styleEO($class);?>">
              <td colspan="2";>&nbsp</td>
           </tr>

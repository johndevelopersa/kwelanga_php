<?php
// https://kwelangaonlinesolutions.co.za/systems/kwelanga_system/kwelanga_php/functional/reports/phpreports/FileUpload/uploadAndProcessPnpSalesFile.php
    ...
    <center>	
        <FORM name='Select Invoice' method=post action='' enctype="multipart/form-data">
            <table width="50%"; style="border-style:none";>        	
               ...
               <tr>
                  <td class=head1 colspan="4"  style="text-align:center;" >Upload and Process PnP Sales file</td>
               </tr>
               ...
               <tr class="<?php echo GUICommonUtils::styleEO($class);?>">
               	  <td>&nbsp</td>
                  <td style="text-align:left";>Select PNP sales file</td>
